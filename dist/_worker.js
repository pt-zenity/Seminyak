var $t=Object.defineProperty;var dt=e=>{throw TypeError(e)};var Ft=(e,t,a)=>t in e?$t(e,t,{enumerable:!0,configurable:!0,writable:!0,value:a}):e[t]=a;var A=(e,t,a)=>Ft(e,typeof t!="symbol"?t+"":t,a),Ze=(e,t,a)=>t.has(e)||dt("Cannot "+a);var f=(e,t,a)=>(Ze(e,t,"read from private field"),a?a.call(e):t.get(e)),P=(e,t,a)=>t.has(e)?dt("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,a),E=(e,t,a,s)=>(Ze(e,t,"write to private field"),s?s.call(e,a):t.set(e,a),a),R=(e,t,a)=>(Ze(e,t,"access private method"),a);var lt=(e,t,a,s)=>({set _(i){E(e,t,i,a)},get _(){return f(e,t,s)}});var ct=(e,t,a)=>(s,i)=>{let n=-1;return r(0);async function r(o){if(o<=n)throw new Error("next() called multiple times");n=o;let l,u=!1,b;if(e[o]?(b=e[o][0][0],s.req.routeIndex=o):b=o===e.length&&i||void 0,b)try{l=await b(s,()=>r(o+1))}catch(d){if(d instanceof Error&&t)s.error=d,l=await t(d,s),u=!0;else throw d}else s.finalized===!1&&a&&(l=await a(s));return l&&(s.finalized===!1||u)&&(s.res=l),s}},Gt=Symbol(),Yt=async(e,t=Object.create(null))=>{const{all:a=!1,dot:s=!1}=t,n=(e instanceof At?e.raw.headers:e.headers).get("Content-Type");return n!=null&&n.startsWith("multipart/form-data")||n!=null&&n.startsWith("application/x-www-form-urlencoded")?Jt(e,{all:a,dot:s}):{}};async function Jt(e,t){const a=await e.formData();return a?Vt(a,t):{}}function Vt(e,t){const a=Object.create(null);return e.forEach((s,i)=>{t.all||i.endsWith("[]")?Wt(a,i,s):a[i]=s}),t.dot&&Object.entries(a).forEach(([s,i])=>{s.includes(".")&&(Qt(a,s,i),delete a[s])}),a}var Wt=(e,t,a)=>{e[t]!==void 0?Array.isArray(e[t])?e[t].push(a):e[t]=[e[t],a]:t.endsWith("[]")?e[t]=[a]:e[t]=a},Qt=(e,t,a)=>{if(/(?:^|\.)__proto__\./.test(t))return;let s=e;const i=t.split(".");i.forEach((n,r)=>{r===i.length-1?s[n]=a:((!s[n]||typeof s[n]!="object"||Array.isArray(s[n])||s[n]instanceof File)&&(s[n]=Object.create(null)),s=s[n])})},xt=e=>{const t=e.split("/");return t[0]===""&&t.shift(),t},Zt=e=>{const{groups:t,path:a}=ea(e),s=xt(a);return ta(s,t)},ea=e=>{const t=[];return e=e.replace(/\{[^}]+\}/g,(a,s)=>{const i=`@${s}`;return t.push([i,a]),i}),{groups:t,path:e}},ta=(e,t)=>{for(let a=t.length-1;a>=0;a--){const[s]=t[a];for(let i=e.length-1;i>=0;i--)if(e[i].includes(s)){e[i]=e[i].replace(s,t[a][1]);break}}return e},Xe={},aa=(e,t)=>{if(e==="*")return"*";const a=e.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);if(a){const s=`${e}#${t}`;return Xe[s]||(a[2]?Xe[s]=t&&t[0]!==":"&&t[0]!=="*"?[s,a[1],new RegExp(`^${a[2]}(?=/${t})`)]:[e,a[1],new RegExp(`^${a[2]}$`)]:Xe[s]=[e,a[1],!0]),Xe[s]}return null},st=(e,t)=>{try{return t(e)}catch{return e.replace(/(?:%[0-9A-Fa-f]{2})+/g,a=>{try{return t(a)}catch{return a}})}},wt=e=>st(e,decodeURI),St=e=>{const t=e.url,a=t.indexOf("/",t.indexOf(":")+4);let s=a;for(;s<t.length;s++){const i=t.charCodeAt(s);if(i===37){const n=t.indexOf("?",s),r=t.indexOf("#",s),o=n===-1?r===-1?void 0:r:r===-1?n:Math.min(n,r),l=t.slice(a,o);return wt(l.includes("%25")?l.replace(/%25/g,"%2525"):l)}else if(i===63||i===35)break}return t.slice(a,s)},sa=e=>{const t=St(e);return t.length>1&&t.at(-1)==="/"?t.slice(0,-1):t},we=(e,t,...a)=>(a.length&&(t=we(t,...a)),`${(e==null?void 0:e[0])==="/"?"":"/"}${e}${t==="/"?"":`${(e==null?void 0:e.at(-1))==="/"?"":"/"}${(t==null?void 0:t[0])==="/"?t.slice(1):t}`}`),Tt=e=>{if(e.charCodeAt(e.length-1)!==63||!e.includes(":"))return null;const t=e.split("/"),a=[];let s="";return t.forEach(i=>{if(i!==""&&!/\:/.test(i))s+="/"+i;else if(/\:/.test(i))if(/\?/.test(i)){a.length===0&&s===""?a.push("/"):a.push(s);const n=i.replace("?","");s+="/"+n,a.push(s)}else s+="/"+i}),a.filter((i,n,r)=>r.indexOf(i)===n)},et=e=>/[%+]/.test(e)?(e.indexOf("+")!==-1&&(e=e.replace(/\+/g," ")),e.indexOf("%")!==-1?st(e,Et):e):e,It=(e,t,a)=>{let s;if(!a&&t&&!/[%+]/.test(t)){let r=e.indexOf("?",8);if(r===-1)return;for(e.startsWith(t,r+1)||(r=e.indexOf(`&${t}`,r+1));r!==-1;){const o=e.charCodeAt(r+t.length+1);if(o===61){const l=r+t.length+2,u=e.indexOf("&",l);return et(e.slice(l,u===-1?void 0:u))}else if(o==38||isNaN(o))return"";r=e.indexOf(`&${t}`,r+1)}if(s=/[%+]/.test(e),!s)return}const i={};s??(s=/[%+]/.test(e));let n=e.indexOf("?",8);for(;n!==-1;){const r=e.indexOf("&",n+1);let o=e.indexOf("=",n);o>r&&r!==-1&&(o=-1);let l=e.slice(n+1,o===-1?r===-1?void 0:r:o);if(s&&(l=et(l)),n=r,l==="")continue;let u;o===-1?u="":(u=e.slice(o+1,r===-1?void 0:r),s&&(u=et(u))),a?(i[l]&&Array.isArray(i[l])||(i[l]=[]),i[l].push(u)):i[l]??(i[l]=u)}return t?i[t]:i},na=It,ia=(e,t)=>It(e,t,!0),Et=decodeURIComponent,pt=e=>st(e,Et),Ie,F,se,Pt,Ct,at,ie,gt,At=(gt=class{constructor(e,t="/",a=[[]]){P(this,se);A(this,"raw");P(this,Ie);P(this,F);A(this,"routeIndex",0);A(this,"path");A(this,"bodyCache",{});P(this,ie,e=>{const{bodyCache:t,raw:a}=this,s=t[e];if(s)return s;const i=Object.keys(t)[0];return i?t[i].then(n=>(i==="json"&&(n=JSON.stringify(n)),new Response(n)[e]())):t[e]=a[e]()});this.raw=e,this.path=t,E(this,F,a),E(this,Ie,{})}param(e){return e?R(this,se,Pt).call(this,e):R(this,se,Ct).call(this)}query(e){return na(this.url,e)}queries(e){return ia(this.url,e)}header(e){if(e)return this.raw.headers.get(e)??void 0;const t={};return this.raw.headers.forEach((a,s)=>{t[s]=a}),t}async parseBody(e){return Yt(this,e)}json(){return f(this,ie).call(this,"text").then(e=>JSON.parse(e))}text(){return f(this,ie).call(this,"text")}arrayBuffer(){return f(this,ie).call(this,"arrayBuffer")}blob(){return f(this,ie).call(this,"blob")}formData(){return f(this,ie).call(this,"formData")}addValidatedData(e,t){f(this,Ie)[e]=t}valid(e){return f(this,Ie)[e]}get url(){return this.raw.url}get method(){return this.raw.method}get[Gt](){return f(this,F)}get matchedRoutes(){return f(this,F)[0].map(([[,e]])=>e)}get routePath(){return f(this,F)[0].map(([[,e]])=>e)[this.routeIndex].path}},Ie=new WeakMap,F=new WeakMap,se=new WeakSet,Pt=function(e){const t=f(this,F)[0][this.routeIndex][1][e],a=R(this,se,at).call(this,t);return a&&/\%/.test(a)?pt(a):a},Ct=function(){const e={},t=Object.keys(f(this,F)[0][this.routeIndex][1]);for(const a of t){const s=R(this,se,at).call(this,f(this,F)[0][this.routeIndex][1][a]);s!==void 0&&(e[a]=/\%/.test(s)?pt(s):s)}return e},at=function(e){return f(this,F)[1]?f(this,F)[1][e]:e},ie=new WeakMap,gt),ra={Stringify:1},_t=async(e,t,a,s,i)=>{typeof e=="object"&&!(e instanceof String)&&(e instanceof Promise||(e=e.toString()),e instanceof Promise&&(e=await e));const n=e.callbacks;return n!=null&&n.length?(i?i[0]+=e:i=[e],Promise.all(n.map(o=>o({phase:t,buffer:i,context:s}))).then(o=>Promise.all(o.filter(Boolean).map(l=>_t(l,t,!1,s,i))).then(()=>i[0]))):Promise.resolve(e)},oa="text/plain; charset=UTF-8",tt=(e,t)=>({"Content-Type":e,...t}),De=(e,t)=>new Response(e,t),Me,He,Z,Ee,ee,K,je,Ae,Pe,ge,ze,Ke,re,Se,bt,da=(bt=class{constructor(e,t){P(this,re);P(this,Me);P(this,He);A(this,"env",{});P(this,Z);A(this,"finalized",!1);A(this,"error");P(this,Ee);P(this,ee);P(this,K);P(this,je);P(this,Ae);P(this,Pe);P(this,ge);P(this,ze);P(this,Ke);A(this,"render",(...e)=>(f(this,Ae)??E(this,Ae,t=>this.html(t)),f(this,Ae).call(this,...e)));A(this,"setLayout",e=>E(this,je,e));A(this,"getLayout",()=>f(this,je));A(this,"setRenderer",e=>{E(this,Ae,e)});A(this,"header",(e,t,a)=>{this.finalized&&E(this,K,De(f(this,K).body,f(this,K)));const s=f(this,K)?f(this,K).headers:f(this,ge)??E(this,ge,new Headers);t===void 0?s.delete(e):a!=null&&a.append?s.append(e,t):s.set(e,t)});A(this,"status",e=>{E(this,Ee,e)});A(this,"set",(e,t)=>{f(this,Z)??E(this,Z,new Map),f(this,Z).set(e,t)});A(this,"get",e=>f(this,Z)?f(this,Z).get(e):void 0);A(this,"newResponse",(...e)=>R(this,re,Se).call(this,...e));A(this,"body",(e,t,a)=>R(this,re,Se).call(this,e,t,a));A(this,"text",(e,t,a)=>!f(this,ge)&&!f(this,Ee)&&!t&&!a&&!this.finalized?new Response(e):R(this,re,Se).call(this,e,t,tt(oa,a)));A(this,"json",(e,t,a)=>R(this,re,Se).call(this,JSON.stringify(e),t,tt("application/json",a)));A(this,"html",(e,t,a)=>{const s=i=>R(this,re,Se).call(this,i,t,tt("text/html; charset=UTF-8",a));return typeof e=="object"?_t(e,ra.Stringify,!1,{}).then(s):s(e)});A(this,"redirect",(e,t)=>{const a=String(e);return this.header("Location",/[^\x00-\xFF]/.test(a)?encodeURI(a):a),this.newResponse(null,t??302)});A(this,"notFound",()=>(f(this,Pe)??E(this,Pe,()=>De()),f(this,Pe).call(this,this)));E(this,Me,e),t&&(E(this,ee,t.executionCtx),this.env=t.env,E(this,Pe,t.notFoundHandler),E(this,Ke,t.path),E(this,ze,t.matchResult))}get req(){return f(this,He)??E(this,He,new At(f(this,Me),f(this,Ke),f(this,ze))),f(this,He)}get event(){if(f(this,ee)&&"respondWith"in f(this,ee))return f(this,ee);throw Error("This context has no FetchEvent")}get executionCtx(){if(f(this,ee))return f(this,ee);throw Error("This context has no ExecutionContext")}get res(){return f(this,K)||E(this,K,De(null,{headers:f(this,ge)??E(this,ge,new Headers)}))}set res(e){if(f(this,K)&&e){e=De(e.body,e);for(const[t,a]of f(this,K).headers.entries())if(t!=="content-type")if(t==="set-cookie"){const s=f(this,K).headers.getSetCookie();e.headers.delete("set-cookie");for(const i of s)e.headers.append("set-cookie",i)}else e.headers.set(t,a)}E(this,K,e),this.finalized=!0}get var(){return f(this,Z)?Object.fromEntries(f(this,Z)):{}}},Me=new WeakMap,He=new WeakMap,Z=new WeakMap,Ee=new WeakMap,ee=new WeakMap,K=new WeakMap,je=new WeakMap,Ae=new WeakMap,Pe=new WeakMap,ge=new WeakMap,ze=new WeakMap,Ke=new WeakMap,re=new WeakSet,Se=function(e,t,a){const s=f(this,K)?new Headers(f(this,K).headers):f(this,ge)??new Headers;if(typeof t=="object"&&"headers"in t){const n=t.headers instanceof Headers?t.headers:new Headers(t.headers);for(const[r,o]of n)r.toLowerCase()==="set-cookie"?s.append(r,o):s.set(r,o)}if(a)for(const[n,r]of Object.entries(a))if(typeof r=="string")s.set(n,r);else{s.delete(n);for(const o of r)s.append(n,o)}const i=typeof t=="number"?t:(t==null?void 0:t.status)??f(this,Ee);return De(e,{status:i,headers:s})},bt),M="ALL",la="all",ca=["get","post","put","delete","options","patch"],Bt="Can not add a route since the matcher is already built.",Rt=class extends Error{},pa="__COMPOSED_HANDLER",ua=e=>e.text("404 Not Found",404),ut=(e,t)=>{if("getResponse"in e){const a=e.getResponse();return t.newResponse(a.body,a)}return console.error(e),t.text("Internal Server Error",500)},G,H,Dt,Y,fe,$e,Fe,Ce,fa=(Ce=class{constructor(t={}){P(this,H);A(this,"get");A(this,"post");A(this,"put");A(this,"delete");A(this,"options");A(this,"patch");A(this,"all");A(this,"on");A(this,"use");A(this,"router");A(this,"getPath");A(this,"_basePath","/");P(this,G,"/");A(this,"routes",[]);P(this,Y,ua);A(this,"errorHandler",ut);A(this,"onError",t=>(this.errorHandler=t,this));A(this,"notFound",t=>(E(this,Y,t),this));A(this,"fetch",(t,...a)=>R(this,H,Fe).call(this,t,a[1],a[0],t.method));A(this,"request",(t,a,s,i)=>t instanceof Request?this.fetch(a?new Request(t,a):t,s,i):(t=t.toString(),this.fetch(new Request(/^https?:\/\//.test(t)?t:`http://localhost${we("/",t)}`,a),s,i)));A(this,"fire",()=>{addEventListener("fetch",t=>{t.respondWith(R(this,H,Fe).call(this,t.request,t,void 0,t.request.method))})});[...ca,la].forEach(n=>{this[n]=(r,...o)=>(typeof r=="string"?E(this,G,r):R(this,H,fe).call(this,n,f(this,G),r),o.forEach(l=>{R(this,H,fe).call(this,n,f(this,G),l)}),this)}),this.on=(n,r,...o)=>{for(const l of[r].flat()){E(this,G,l);for(const u of[n].flat())o.map(b=>{R(this,H,fe).call(this,u.toUpperCase(),f(this,G),b)})}return this},this.use=(n,...r)=>(typeof n=="string"?E(this,G,n):(E(this,G,"*"),r.unshift(n)),r.forEach(o=>{R(this,H,fe).call(this,M,f(this,G),o)}),this);const{strict:s,...i}=t;Object.assign(this,i),this.getPath=s??!0?t.getPath??St:sa}route(t,a){const s=this.basePath(t);return a.routes.map(i=>{var r;let n;a.errorHandler===ut?n=i.handler:(n=async(o,l)=>(await ct([],a.errorHandler)(o,()=>i.handler(o,l))).res,n[pa]=i.handler),R(r=s,H,fe).call(r,i.method,i.path,n)}),this}basePath(t){const a=R(this,H,Dt).call(this);return a._basePath=we(this._basePath,t),a}mount(t,a,s){let i,n;s&&(typeof s=="function"?n=s:(n=s.optionHandler,s.replaceRequest===!1?i=l=>l:i=s.replaceRequest));const r=n?l=>{const u=n(l);return Array.isArray(u)?u:[u]}:l=>{let u;try{u=l.executionCtx}catch{}return[l.env,u]};i||(i=(()=>{const l=we(this._basePath,t),u=l==="/"?0:l.length;return b=>{const d=new URL(b.url);return d.pathname=d.pathname.slice(u)||"/",new Request(d,b)}})());const o=async(l,u)=>{const b=await a(i(l.req.raw),...r(l));if(b)return b;await u()};return R(this,H,fe).call(this,M,we(t,"*"),o),this}},G=new WeakMap,H=new WeakSet,Dt=function(){const t=new Ce({router:this.router,getPath:this.getPath});return t.errorHandler=this.errorHandler,E(t,Y,f(this,Y)),t.routes=this.routes,t},Y=new WeakMap,fe=function(t,a,s){t=t.toUpperCase(),a=we(this._basePath,a);const i={basePath:this._basePath,path:a,method:t,handler:s};this.router.add(t,a,[s,i]),this.routes.push(i)},$e=function(t,a){if(t instanceof Error)return this.errorHandler(t,a);throw t},Fe=function(t,a,s,i){if(i==="HEAD")return(async()=>new Response(null,await R(this,H,Fe).call(this,t,a,s,"GET")))();const n=this.getPath(t,{env:s}),r=this.router.match(i,n),o=new da(t,{path:n,matchResult:r,env:s,executionCtx:a,notFoundHandler:f(this,Y)});if(r[0].length===1){let u;try{u=r[0][0][0][0](o,async()=>{o.res=await f(this,Y).call(this,o)})}catch(b){return R(this,H,$e).call(this,b,o)}return u instanceof Promise?u.then(b=>b||(o.finalized?o.res:f(this,Y).call(this,o))).catch(b=>R(this,H,$e).call(this,b,o)):u??f(this,Y).call(this,o)}const l=ct(r[0],this.errorHandler,f(this,Y));return(async()=>{try{const u=await l(o);if(!u.finalized)throw new Error("Context is not finalized. Did you forget to return a Response object or `await next()`?");return u.res}catch(u){return R(this,H,$e).call(this,u,o)}})()},Ce),Nt=[];function ma(e,t){const a=this.buildAllMatchers(),s=((i,n)=>{const r=a[i]||a[M],o=r[2][n];if(o)return o;const l=n.match(r[0]);if(!l)return[[],Nt];const u=l.indexOf("",1);return[r[1][u],l]});return this.match=s,s(e,t)}var Ye="[^/]+",Le=".*",Oe="(?:|/.*)",Te=Symbol(),ga=new Set(".\\+*[^]$()");function ba(e,t){return e.length===1?t.length===1?e<t?-1:1:-1:t.length===1||e===Le||e===Oe?1:t===Le||t===Oe?-1:e===Ye?1:t===Ye?-1:e.length===t.length?e<t?-1:1:t.length-e.length}var be,he,J,ke,ha=(ke=class{constructor(){P(this,be);P(this,he);P(this,J,Object.create(null))}insert(t,a,s,i,n){if(t.length===0){if(f(this,be)!==void 0)throw Te;if(n)return;E(this,be,a);return}const[r,...o]=t,l=r==="*"?o.length===0?["","",Le]:["","",Ye]:r==="/*"?["","",Oe]:r.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);let u;if(l){const b=l[1];let d=l[2]||Ye;if(b&&l[2]&&(d===".*"||(d=d.replace(/^\((?!\?:)(?=[^)]+\)$)/,"(?:"),/\((?!\?:)/.test(d))))throw Te;if(u=f(this,J)[d],!u){if(Object.keys(f(this,J)).some(c=>c!==Le&&c!==Oe))throw Te;if(n)return;u=f(this,J)[d]=new ke,b!==""&&E(u,he,i.varIndex++)}!n&&b!==""&&s.push([b,f(u,he)])}else if(u=f(this,J)[r],!u){if(Object.keys(f(this,J)).some(b=>b.length>1&&b!==Le&&b!==Oe))throw Te;if(n)return;u=f(this,J)[r]=new ke}u.insert(o,a,s,i,n)}buildRegExpStr(){const a=Object.keys(f(this,J)).sort(ba).map(s=>{const i=f(this,J)[s];return(typeof f(i,he)=="number"?`(${s})@${f(i,he)}`:ga.has(s)?`\\${s}`:s)+i.buildRegExpStr()});return typeof f(this,be)=="number"&&a.unshift(`#${f(this,be)}`),a.length===0?"":a.length===1?a[0]:"(?:"+a.join("|")+")"}},be=new WeakMap,he=new WeakMap,J=new WeakMap,ke),Ve,Ue,ht,va=(ht=class{constructor(){P(this,Ve,{varIndex:0});P(this,Ue,new ha)}insert(e,t,a){const s=[],i=[];for(let r=0;;){let o=!1;if(e=e.replace(/\{[^}]+\}/g,l=>{const u=`@\\${r}`;return i[r]=[u,l],r++,o=!0,u}),!o)break}const n=e.match(/(?::[^\/]+)|(?:\/\*$)|./g)||[];for(let r=i.length-1;r>=0;r--){const[o]=i[r];for(let l=n.length-1;l>=0;l--)if(n[l].indexOf(o)!==-1){n[l]=n[l].replace(o,i[r][1]);break}}return f(this,Ue).insert(n,t,s,f(this,Ve),a),s}buildRegExp(){let e=f(this,Ue).buildRegExpStr();if(e==="")return[/^$/,[],[]];let t=0;const a=[],s=[];return e=e.replace(/#(\d+)|@(\d+)|\.\*\$/g,(i,n,r)=>n!==void 0?(a[++t]=Number(n),"$()"):(r!==void 0&&(s[Number(r)]=++t),"")),[new RegExp(`^${e}`),a,s]}},Ve=new WeakMap,Ue=new WeakMap,ht),ya=[/^$/,[],Object.create(null)],Ge=Object.create(null);function Lt(e){return Ge[e]??(Ge[e]=new RegExp(e==="*"?"":`^${e.replace(/\/\*$|([.\\+*[^\]$()])/g,(t,a)=>a?`\\${a}`:"(?:|/.*)")}$`))}function ka(){Ge=Object.create(null)}function xa(e){var u;const t=new va,a=[];if(e.length===0)return ya;const s=e.map(b=>[!/\*|\/:/.test(b[0]),...b]).sort(([b,d],[c,m])=>b?1:c?-1:d.length-m.length),i=Object.create(null);for(let b=0,d=-1,c=s.length;b<c;b++){const[m,g,h]=s[b];m?i[g]=[h.map(([y])=>[y,Object.create(null)]),Nt]:d++;let k;try{k=t.insert(g,d,m)}catch(y){throw y===Te?new Rt(g):y}m||(a[d]=h.map(([y,p])=>{const w=Object.create(null);for(p-=1;p>=0;p--){const[v,I]=k[p];w[v]=I}return[y,w]}))}const[n,r,o]=t.buildRegExp();for(let b=0,d=a.length;b<d;b++)for(let c=0,m=a[b].length;c<m;c++){const g=(u=a[b][c])==null?void 0:u[1];if(!g)continue;const h=Object.keys(g);for(let k=0,y=h.length;k<y;k++)g[h[k]]=o[g[h[k]]]}const l=[];for(const b in r)l[b]=a[r[b]];return[n,l,i]}function xe(e,t){if(e){for(const a of Object.keys(e).sort((s,i)=>i.length-s.length))if(Lt(a).test(t))return[...e[a]]}}var oe,de,We,Ot,vt,wa=(vt=class{constructor(){P(this,We);A(this,"name","RegExpRouter");P(this,oe);P(this,de);A(this,"match",ma);E(this,oe,{[M]:Object.create(null)}),E(this,de,{[M]:Object.create(null)})}add(e,t,a){var o;const s=f(this,oe),i=f(this,de);if(!s||!i)throw new Error(Bt);s[e]||[s,i].forEach(l=>{l[e]=Object.create(null),Object.keys(l[M]).forEach(u=>{l[e][u]=[...l[M][u]]})}),t==="/*"&&(t="*");const n=(t.match(/\/:/g)||[]).length;if(/\*$/.test(t)){const l=Lt(t);e===M?Object.keys(s).forEach(u=>{var b;(b=s[u])[t]||(b[t]=xe(s[u],t)||xe(s[M],t)||[])}):(o=s[e])[t]||(o[t]=xe(s[e],t)||xe(s[M],t)||[]),Object.keys(s).forEach(u=>{(e===M||e===u)&&Object.keys(s[u]).forEach(b=>{l.test(b)&&s[u][b].push([a,n])})}),Object.keys(i).forEach(u=>{(e===M||e===u)&&Object.keys(i[u]).forEach(b=>l.test(b)&&i[u][b].push([a,n]))});return}const r=Tt(t)||[t];for(let l=0,u=r.length;l<u;l++){const b=r[l];Object.keys(i).forEach(d=>{var c;(e===M||e===d)&&((c=i[d])[b]||(c[b]=[...xe(s[d],b)||xe(s[M],b)||[]]),i[d][b].push([a,n-u+l+1]))})}}buildAllMatchers(){const e=Object.create(null);return Object.keys(f(this,de)).concat(Object.keys(f(this,oe))).forEach(t=>{e[t]||(e[t]=R(this,We,Ot).call(this,t))}),E(this,oe,E(this,de,void 0)),ka(),e}},oe=new WeakMap,de=new WeakMap,We=new WeakSet,Ot=function(e){const t=[];let a=e===M;return[f(this,oe),f(this,de)].forEach(s=>{const i=s[e]?Object.keys(s[e]).map(n=>[n,s[e][n]]):[];i.length!==0?(a||(a=!0),t.push(...i)):e!==M&&t.push(...Object.keys(s[M]).map(n=>[n,s[M][n]]))}),a?xa(t):null},vt),le,te,yt,Sa=(yt=class{constructor(e){A(this,"name","SmartRouter");P(this,le,[]);P(this,te,[]);E(this,le,e.routers)}add(e,t,a){if(!f(this,te))throw new Error(Bt);f(this,te).push([e,t,a])}match(e,t){if(!f(this,te))throw new Error("Fatal error");const a=f(this,le),s=f(this,te),i=a.length;let n=0,r;for(;n<i;n++){const o=a[n];try{for(let l=0,u=s.length;l<u;l++)o.add(...s[l]);r=o.match(e,t)}catch(l){if(l instanceof Rt)continue;throw l}this.match=o.match.bind(o),E(this,le,[o]),E(this,te,void 0);break}if(n===i)throw new Error("Fatal error");return this.name=`SmartRouter + ${this.activeRouter.name}`,r}get activeRouter(){if(f(this,te)||f(this,le).length!==1)throw new Error("No active router has been determined yet.");return f(this,le)[0]}},le=new WeakMap,te=new WeakMap,yt),Ne=Object.create(null),Ta=e=>{for(const t in e)return!0;return!1},ce,z,ve,_e,j,ae,me,Be,Ia=(Be=class{constructor(t,a,s){P(this,ae);P(this,ce);P(this,z);P(this,ve);P(this,_e,0);P(this,j,Ne);if(E(this,z,s||Object.create(null)),E(this,ce,[]),t&&a){const i=Object.create(null);i[t]={handler:a,possibleKeys:[],score:0},E(this,ce,[i])}E(this,ve,[])}insert(t,a,s){E(this,_e,++lt(this,_e)._);let i=this;const n=Zt(a),r=[];for(let o=0,l=n.length;o<l;o++){const u=n[o],b=n[o+1],d=aa(u,b),c=Array.isArray(d)?d[0]:u;if(c in f(i,z)){i=f(i,z)[c],d&&r.push(d[1]);continue}f(i,z)[c]=new Be,d&&(f(i,ve).push(d),r.push(d[1])),i=f(i,z)[c]}return f(i,ce).push({[t]:{handler:s,possibleKeys:r.filter((o,l,u)=>u.indexOf(o)===l),score:f(this,_e)}}),i}search(t,a){var b;const s=[];E(this,j,Ne);let n=[this];const r=xt(a),o=[],l=r.length;let u=null;for(let d=0;d<l;d++){const c=r[d],m=d===l-1,g=[];for(let k=0,y=n.length;k<y;k++){const p=n[k],w=f(p,z)[c];w&&(E(w,j,f(p,j)),m?(f(w,z)["*"]&&R(this,ae,me).call(this,s,f(w,z)["*"],t,f(p,j)),R(this,ae,me).call(this,s,w,t,f(p,j))):g.push(w));for(let v=0,I=f(p,ve).length;v<I;v++){const S=f(p,ve)[v],x=f(p,j)===Ne?{}:{...f(p,j)};if(S==="*"){const C=f(p,z)["*"];C&&(R(this,ae,me).call(this,s,C,t,f(p,j)),E(C,j,x),g.push(C));continue}const[_,O,B]=S;if(!c&&!(B instanceof RegExp))continue;const L=f(p,z)[_];if(B instanceof RegExp){if(u===null){u=new Array(l);let q=a[0]==="/"?1:0;for(let ne=0;ne<l;ne++)u[ne]=q,q+=r[ne].length+1}const C=a.substring(u[d]),N=B.exec(C);if(N){if(x[O]=N[0],R(this,ae,me).call(this,s,L,t,f(p,j),x),Ta(f(L,z))){E(L,j,x);const q=((b=N[0].match(/\//))==null?void 0:b.length)??0;(o[q]||(o[q]=[])).push(L)}continue}}(B===!0||B.test(c))&&(x[O]=c,m?(R(this,ae,me).call(this,s,L,t,x,f(p,j)),f(L,z)["*"]&&R(this,ae,me).call(this,s,f(L,z)["*"],t,x,f(p,j))):(E(L,j,x),g.push(L)))}}const h=o.shift();n=h?g.concat(h):g}return s.length>1&&s.sort((d,c)=>d.score-c.score),[s.map(({handler:d,params:c})=>[d,c])]}},ce=new WeakMap,z=new WeakMap,ve=new WeakMap,_e=new WeakMap,j=new WeakMap,ae=new WeakSet,me=function(t,a,s,i,n){for(let r=0,o=f(a,ce).length;r<o;r++){const l=f(a,ce)[r],u=l[s]||l[M],b={};if(u!==void 0&&(u.params=Object.create(null),t.push(u),i!==Ne||n&&n!==Ne))for(let d=0,c=u.possibleKeys.length;d<c;d++){const m=u.possibleKeys[d],g=b[u.score];u.params[m]=n!=null&&n[m]&&!g?n[m]:i[m]??(n==null?void 0:n[m]),b[u.score]=!0}}},Be),ye,kt,Ea=(kt=class{constructor(){A(this,"name","TrieRouter");P(this,ye);E(this,ye,new Ia)}add(e,t,a){const s=Tt(t);if(s){for(let i=0,n=s.length;i<n;i++)f(this,ye).insert(e,s[i],a);return}f(this,ye).insert(e,t,a)}match(e,t){return f(this,ye).search(e,t)}},ye=new WeakMap,kt),qt=class extends fa{constructor(e={}){super(e),this.router=e.router??new Sa({routers:[new wa,new Ea]})}},Aa=/^\s*(?:text\/(?!event-stream(?:[;\s]|$))[^;\s]+|application\/(?:javascript|json|xml|xml-dtd|ecmascript|dart|postscript|rtf|tar|toml|vnd\.dart|vnd\.ms-fontobject|vnd\.ms-opentype|wasm|x-httpd-php|x-javascript|x-ns-proxy-autoconfig|x-sh|x-tar|x-virtualbox-hdd|x-virtualbox-ova|x-virtualbox-ovf|x-virtualbox-vbox|x-virtualbox-vdi|x-virtualbox-vhd|x-virtualbox-vmdk|x-www-form-urlencoded)|font\/(?:otf|ttf)|image\/(?:bmp|vnd\.adobe\.photoshop|vnd\.microsoft\.icon|vnd\.ms-dds|x-icon|x-ms-bmp)|message\/rfc822|model\/gltf-binary|x-shader\/x-fragment|x-shader\/x-vertex|[^;\s]+?\+(?:json|text|xml|yaml))(?:[;\s]|$)/i,ft=(e,t=Ca)=>{const a=/\.([a-zA-Z0-9]+?)$/,s=e.match(a);if(!s)return;let i=t[s[1].toLowerCase()];return i&&i.startsWith("text")&&(i+="; charset=utf-8"),i},Pa={aac:"audio/aac",avi:"video/x-msvideo",avif:"image/avif",av1:"video/av1",bin:"application/octet-stream",bmp:"image/bmp",css:"text/css",csv:"text/csv",eot:"application/vnd.ms-fontobject",epub:"application/epub+zip",gif:"image/gif",gz:"application/gzip",htm:"text/html",html:"text/html",ico:"image/x-icon",ics:"text/calendar",jpeg:"image/jpeg",jpg:"image/jpeg",js:"text/javascript",json:"application/json",jsonld:"application/ld+json",map:"application/json",mid:"audio/x-midi",midi:"audio/x-midi",mjs:"text/javascript",mp3:"audio/mpeg",mp4:"video/mp4",mpeg:"video/mpeg",oga:"audio/ogg",ogv:"video/ogg",ogx:"application/ogg",opus:"audio/opus",otf:"font/otf",pdf:"application/pdf",png:"image/png",rtf:"application/rtf",svg:"image/svg+xml",tif:"image/tiff",tiff:"image/tiff",ts:"video/mp2t",ttf:"font/ttf",txt:"text/plain",wasm:"application/wasm",webm:"video/webm",weba:"audio/webm",webmanifest:"application/manifest+json",webp:"image/webp",woff:"font/woff",woff2:"font/woff2",xhtml:"application/xhtml+xml",xml:"application/xml",zip:"application/zip","3gp":"video/3gpp","3g2":"video/3gpp2",gltf:"model/gltf+json",glb:"model/gltf-binary"},Ca=Pa,_a=(...e)=>{let t=e.filter(i=>i!=="").join("/");t=t.replace(new RegExp("(?<=\\/)\\/+","g"),"");const a=t.split("/"),s=[];for(const i of a)i===".."&&s.length>0&&s.at(-1)!==".."?s.pop():i!=="."&&s.push(i);return s.join("/")||"."},Mt={br:".br",zstd:".zst",gzip:".gz"},Ba=Object.keys(Mt),Ra="index.html",Da=e=>{const t=e.root??"./",a=e.path,s=e.join??_a;return async(i,n)=>{var b,d,c,m;if(i.finalized)return n();let r;if(e.path)r=e.path;else try{if(r=wt(i.req.path),/(?:^|[\/\\])\.{1,2}(?:$|[\/\\])|[\/\\]{2,}/.test(r))throw new Error}catch{return await((b=e.onNotFound)==null?void 0:b.call(e,i.req.path,i)),n()}let o=s(t,!a&&e.rewriteRequestPath?e.rewriteRequestPath(r):r);e.isDir&&await e.isDir(o)&&(o=s(o,Ra));const l=e.getContent;let u=await l(o,i);if(u instanceof Response)return i.newResponse(u.body,u);if(u){const g=e.mimes&&ft(o,e.mimes)||ft(o);if(i.header("Content-Type",g||"application/octet-stream"),e.precompressed&&(!g||Aa.test(g))){const h=new Set((d=i.req.header("Accept-Encoding"))==null?void 0:d.split(",").map(k=>k.trim()));for(const k of Ba){if(!h.has(k))continue;const y=await l(o+Mt[k],i);if(y){u=y,i.header("Content-Encoding",k),i.header("Vary","Accept-Encoding",{append:!0});break}}}return await((c=e.onFound)==null?void 0:c.call(e,o,i)),i.body(u)}await((m=e.onNotFound)==null?void 0:m.call(e,o,i)),await n()}},Na=async(e,t)=>{let a;t&&t.manifest?typeof t.manifest=="string"?a=JSON.parse(t.manifest):a=t.manifest:typeof __STATIC_CONTENT_MANIFEST=="string"?a=JSON.parse(__STATIC_CONTENT_MANIFEST):a=__STATIC_CONTENT_MANIFEST;let s;t&&t.namespace?s=t.namespace:s=__STATIC_CONTENT;const i=a[e];if(!i)return null;const n=await s.get(i,{type:"stream"});return n||null},La=e=>async function(a,s){return Da({...e,getContent:async n=>Na(n,{manifest:e.manifest,namespace:e.namespace?e.namespace:a.env?a.env.__STATIC_CONTENT:void 0})})(a,s)},Oa=e=>La(e);function qa(){return`<!DOCTYPE html>
<html lang="id">
<head>
<meta charset="UTF-8"/>
...
<\/script>
...
</html>`}function D(e,t,a,s,i,n,r,o,l){const u="mb-post",b=i.map(v=>`
    <tr>
    ...
    <div class="schema-obj">${Ma(n)}</div>`:"";return`
...
</html>`}const Ht=`-----BEGIN PRIVATE KEY-----
...
-----END PRIVATE KEY-----`,Qe="p91wrswK";function pe(e){if(!e||typeof e!="string")return new Uint8Array(0);const t=e.replace(/-/g,"+").replace(/_/g,"/"),a=t.padEnd(t.length+(4-t.length%4)%4,"=");try{const s=atob(a);return Uint8Array.from(s,i=>i.charCodeAt(0))}catch{return new Uint8Array(0)}}function ue(e){return btoa(String.fromCharCode(...new Uint8Array(e)))}function Re(e){return Array.from(new Uint8Array(e)).map(t=>t.toString(16).padStart(2,"0")).join("")}function W(e){return new TextEncoder().encode(e)}function Ka(e){function t(y,p){const w=(y&65535)+(p&65535);return(y>>16)+(p>>16)+(w>>16)<<16|w&65535}function a(y,p){return y<<p|y>>>32-p}function s(y,p,w,v,I,S){return t(a(t(t(p,y),t(v,S)),I),w)}function i(y,p,w,v,I,S,x){return s(p&w|~p&v,y,p,I,S,x)}function n(y,p,w,v,I,S,x){return s(p&v|w&~v,y,p,I,S,x)}function r(y,p,w,v,I,S,x){return s(p^w^v,y,p,I,S,x)}function o(y,p,w,v,I,S,x){return s(w^(p|~v),y,p,I,S,x)}function l(y){const p=[];for(let w=0;w<y.length;w++){const v=y.charCodeAt(w);v<128?p.push(v):v<2048?p.push(v>>6|192,v&63|128):v<65536?p.push(v>>12|224,v>>6&63|128,v&63|128):p.push(v>>18|240,v>>12&63|128,v>>6&63|128,v&63|128)}return p}const u=l(e),b=u.length;for(u.push(128);u.length%64!==56;)u.push(0);const d=b*8;for(let y=0;y<8;y++)u.push(y<4?d>>>y*8&255:d/4294967296>>>y*4*8&255);let c=1732584193,m=4023233417,g=2562383102,h=271733878;for(let y=0;y<u.length;y+=64){const p=[];for(let x=0;x<16;x++)p[x]=u[y+x*4]|u[y+x*4+1]<<8|u[y+x*4+2]<<16|u[y+x*4+3]<<24;let[w,v,I,S]=[c,m,g,h];c=i(c,m,g,h,p[0],7,-680876936),h=i(h,c,m,g,p[1],12,-389564586),g=i(g,h,c,m,p[2],17,606105819),m=i(m,g,h,c,p[3],22,-1044525330),c=i(c,m,g,h,p[4],7,-176418897),h=i(h,c,m,g,p[5],12,1200080426),g=i(g,h,c,m,p[6],17,-1473231341),m=i(m,g,h,c,p[7],22,-45705983),c=i(c,m,g,h,p[8],7,1770035416),h=i(h,c,m,g,p[9],12,-1958414417),g=i(g,h,c,m,p[10],17,-42063),m=i(m,g,h,c,p[11],22,-1990404162),c=i(c,m,g,h,p[12],7,1804603682),h=i(h,c,m,g,p[13],12,-40341101),g=i(g,h,c,m,p[14],17,-1502002290),m=i(m,g,h,c,p[15],22,1236535329),c=n(c,m,g,h,p[1],5,-165796510),h=n(h,c,m,g,p[6],9,-1069501632),g=n(g,h,c,m,p[11],14,643717713),m=n(m,g,h,c,p[0],20,-373897302),c=n(c,m,g,h,p[5],5,-701558691),h=n(h,c,m,g,p[10],9,38016083),g=n(g,h,c,m,p[15],14,-660478335),m=n(m,g,h,c,p[4],20,-405537848),c=n(c,m,g,h,p[9],5,568446438),h=n(h,c,m,g,p[14],9,-1019803690),g=n(g,h,c,m,p[3],14,-187363961),m=n(m,g,h,c,p[8],20,1163531501),c=n(c,m,g,h,p[13],5,-1444681467),h=n(h,c,m,g,p[2],9,-51403784),g=n(g,h,c,m,p[7],14,1735328473),m=n(m,g,h,c,p[12],20,-1926607734),c=r(c,m,g,h,p[5],4,-378558),h=r(h,c,m,g,p[8],11,-2022574463),g=r(g,h,c,m,p[11],16,1839030562),m=r(m,g,h,c,p[14],23,-35309556),c=r(c,m,g,h,p[1],4,-1530992060),h=r(h,c,m,g,p[4],11,1272893353),g=r(g,h,c,m,p[7],16,-155497632),m=r(m,g,h,c,p[10],23,-1094730640),c=r(c,m,g,h,p[13],4,681279174),h=r(h,c,m,g,p[0],11,-358537222),g=r(g,h,c,m,p[3],16,-722521979),m=r(m,g,h,c,p[6],23,76029189),c=r(c,m,g,h,p[9],4,-640364487),h=r(h,c,m,g,p[12],11,-421815835),g=r(g,h,c,m,p[15],16,530742520),m=r(m,g,h,c,p[2],23,-995338651),c=o(c,m,g,h,p[0],6,-198630844),h=o(h,c,m,g,p[7],10,1126891415),g=o(g,h,c,m,p[14],15,-1416354905),m=o(m,g,h,c,p[5],21,-57434055),c=o(c,m,g,h,p[12],6,1700485571),h=o(h,c,m,g,p[3],10,-1894986606),g=o(g,h,c,m,p[10],15,-1051523),m=o(m,g,h,c,p[1],21,-2054922799),c=o(c,m,g,h,p[8],6,1873313359),h=o(h,c,m,g,p[15],10,-30611744),g=o(g,h,c,m,p[6],15,-1560198380),m=o(m,g,h,c,p[13],21,1309151649),c=o(c,m,g,h,p[4],6,-145523070),h=o(h,c,m,g,p[11],10,-1120210379),g=o(g,h,c,m,p[2],15,718787259),m=o(m,g,h,c,p[9],21,-343485551),c=t(c,w),m=t(m,v),g=t(g,I),h=t(h,S)}function k(y){let p="";for(let w=0;w<4;w++)p+=(y>>>w*8&255).toString(16).padStart(2,"0");return p}return k(c)+k(m)+k(g)+k(h)}async function Ua(e,t){const a=t.slice(-8),s=a.split(":").map(Number),i=await crypto.subtle.importKey("raw",W(t),{name:"HMAC",hash:"SHA-512"},!1,["sign"]),n=new Uint8Array(await crypto.subtle.sign("HMAC",i,W(e))),r=n.length,o=s[0],l=Math.floor((r+s[1])/2)-16,u=Math.floor((r+s[2])/3)-8,b=ue(n.slice(o,o+32)),d=ue(n.slice(l,l+16)),c=ue(n.slice(u,u+8));return{aesKey:b,aesIv:d,aesCs:c,times:s,kStart:o,ivStart:l,csStart:u,debug:{lastEight:a,times:s,kStart:o,ivStart:l,csStart:u,keyBytesHex:Re(n).slice(0,32)+"..."}}}async function T(e,t,a){const s=await crypto.subtle.importKey("raw",pe(t),"AES-CBC",!1,["encrypt"]),i=pe(a),n=await crypto.subtle.encrypt({name:"AES-CBC",iv:i},s,W(e));return ue(n)}async function nt(e,t,a){try{const s=await crypto.subtle.importKey("raw",pe(t),"AES-CBC",!1,["decrypt"]),i=pe(a),n=await crypto.subtle.decrypt({name:"AES-CBC",iv:i},s,pe(e));return new TextDecoder().decode(n)}catch{return null}}function Xa(e){const t=e.endsWith("==")?"==":e.endsWith("=")?"=":"",a=e.substring(7,13),s=parseInt(a[0])*10+a.charCodeAt(1)-64,i=100+parseInt(a[2])*10+a.charCodeAt(3)-64,n=100+parseInt(a[4])*10+a.charCodeAt(5)-64,r=e.substring(16,20),o=r.charCodeAt(0)-64,l=r.charCodeAt(1)-64,u=parseInt(r.slice(2)),b=e.substring(s,s+o)+e.substring(i,i+l)+e.substring(n,n+u),d=atob((b+t).replace(/-/g,"+").replace(/_/g,"/")),c=d.split("|");return{app:c[0]||"",clientID:c[1]||"",regTime:c[2]||"",rawDecoded:d,parts:c,debug:{col1:s,col2:i,col3:n,len1:o,len2:l,len3:u,idd:b.slice(0,20)+"..."}}}function $a(e,t,a="Seminyak"){const s=`${a}|${e}|${t}`,i=btoa(s),n=i.endsWith("==")?"==":i.endsWith("=")?"=":"",r=i.slice(0,i.length-n.length),o=r.length,l=69,u=135,b=175,d=Math.floor(o/3),c=d,m=d,g=o-c-m,h=r.slice(0,c),k=r.slice(c,c+m),y=r.slice(c+m),p=x=>String(Math.floor(x/10))+String.fromCharCode(x%10+64),w=p(l)+p(u-100)+p(b-100),v=String.fromCharCode(c+64)+String.fromCharCode(m+64)+String(g).padStart(2,"0"),I=b+g+200,S=new Array(I+100).fill("A");S[7]=w[0],S[8]=w[1],S[9]=w[2],S[10]=w[3],S[11]=w[4],S[12]=w[5],S[16]=v[0],S[17]=v[1],S[18]=v[2],S[19]=v[3];for(let x=0;x<h.length;x++)S[l+x]=h[x];for(let x=0;x<k.length;x++)S[u+x]=k[x];for(let x=0;x<y.length;x++)S[b+x]=y[x];return S.join("").slice(0,b+g)+n}function Fa(e){const t=e.split(".");if(t.length<2)return{error:"Bukan format JWT valid"};try{const a=JSON.parse(atob(t[0].replace(/-/g,"+").replace(/_/g,"/"))),s=JSON.parse(atob(t[1].replace(/-/g,"+").replace(/_/g,"/")));return{header:a,payload:s,signatureB64:t[2]||"",raw:{headerB64:t[0],payloadB64:t[1]}}}catch(a){return{error:a instanceof Error?a.message:String(a)}}}async function it(e){const t=e.replace(/-----[^-]+-----/g,"").replace(/\s/g,"");return pe(t).buffer}async function jt(e,t,a=Ht){const s=btoa(JSON.stringify({trans_no:e,alg:"RS256"})).replace(/\+/g,"-").replace(/\//g,"_").replace(/=/g,""),i=btoa(JSON.stringify({trans_time:t})).replace(/\+/g,"-").replace(/\//g,"_").replace(/=/g,""),n=`${s}.${i}`,r=await it(a),o=await crypto.subtle.importKey("pkcs8",r,{name:"RSASSA-PKCS1-v1_5",hash:"SHA-256"},!1,["sign"]),l=await crypto.subtle.sign("RSASSA-PKCS1-v1_5",o,W(n)),u=ue(l).replace(/\+/g,"-").replace(/\//g,"_").replace(/=/g,"");return`${n}.${u}`}async function rt(e,t,a){const s=pe(a),i=s.length>=8?s:new Uint8Array(8),n=W(`${e}:${t}`),r=await crypto.subtle.importKey("raw",i,{name:"HMAC",hash:"SHA-512"},!1,["sign"]),o=await crypto.subtle.sign("HMAC",r,n);return ue(o)}function Ga(e){return Re(pe(e))}async function zt(e){const t=`%${e.fromAcc}#${e.amount}@${e.dateTime}^${e.refNo}*${e.destBank}~${e.destAcc}|${Qe}%`;return Re(await crypto.subtle.digest("SHA-256",W(t)))}async function Kt(e){const t=`@${e.fromAcc}|${e.amount}~${e.dateTime}*${e.refNo}^${e.destBank}#${e.destAcc}(${e.destName})${Qe}@`;return Re(await crypto.subtle.digest("SHA-256",W(t)))}async function Ya(e){const t=`{${e.nominal}*${e.norekFrom}^${e.norekTo}%${e.nameFrom}#${e.nameTo}@${Qe}}`;return Re(await crypto.subtle.digest("SHA-256",W(t)))}async function ot(e){const t=Re(await crypto.subtle.digest("SHA-256",W(`Seminyak|${e}`))),a=await it(Ht),s=await crypto.subtle.importKey("pkcs8",a,{name:"RSASSA-PKCS1-v1_5",hash:"SHA-256"},!1,["sign"]),i=await crypto.subtle.sign("RSASSA-PKCS1-v1_5",s,W(t));return{signature:ue(i),timestamp:e,clientStamp:t}}async function Ut(e,t){const a=`${e}|${t}`,s=await it(za),i=await crypto.subtle.importKey("pkcs8",s,{name:"RSASSA-PKCS1-v1_5",hash:"SHA-256"},!1,["sign"]),n=await crypto.subtle.sign("RSASSA-PKCS1-v1_5",i,W(a));return{signature:ue(n),clientKey:e,timestamp:t,message:a}}function V(){const e=new Date;return new Date(e.getTime()+7*36e5).toISOString().replace("T"," ").slice(0,19)}function qe(){const e=new Date;return new Date(e.getTime()+7*36e5).toISOString().slice(0,19)+"+07:00"}function $(e="SMY"){const t=new Date(new Date().getTime()+252e5),a=t.toISOString().slice(11,19).replace(/:/g,"").slice(0,6),s=String(Math.floor(Math.random()*9e3)+1e3),i=t.toISOString().slice(0,10).replace(/-/g,"");return`${e}${a}${s}O1012${i.slice(4)}`}async function Ja(e){const t=e.timestamp||V(),a=e.refNo||$(),s=await T(e.fromAcc,e.aesKey,e.aesIv),i=await T(String(e.amount),e.aesKey,e.aesIv),n=await T(e.dateTime,e.aesKey,e.aesIv),r=await T(e.destName||"",e.aesKey,e.aesIv);let o,l,u;e.step==="posting"?(o=await Kt({...e,refNo:a}),l=await T(`${e.destBank}-${e.destAcc}`,e.aesKey,e.aesIv),u=await T(o,e.aesKey,e.aesIv)):(o=await zt({...e,refNo:a}),l=await T(`${e.destBank}-${e.destAcc}-${o}`,e.aesKey,e.aesIv),u=null);const b=await jt(a,qe()),d=await rt(b,t,e.aesCs),c=d,m={from_acc:s,to_acc:l,amount:i,date_time:n,to_name:r,hash_code:u||"",remark:e.remark||""};return{headers:{"Content-Type":"application/json",Authorization:b,"X-TIMESTAMP":t,"X-SIGNATURE":d,"X-PARTNER-ID":c,"X-CLIENT-ID":e.didEncoded||"","X-REFERENCE":a,"X-Forwarded-For":"34.50.74.78","X-Real-IP":"34.50.74.78"},body:m,url:`${e.baseUrl||"https://lpdseminyak.biz.id:8000"}/api/smart/transfer/bank/post`,refNo:a,ts:t,debug:{hashRaw:o,step:e.step||"check"}}}async function Va(e,t,a){const s={};for(const[i,n]of Object.entries(e))n&&typeof n=="string"&&(s[i]=await nt(n,t,a));return s}async function Wa(e){const t=e.op;try{let a;if(t==="keygen")a=await Ua(e.clientID,e.timestamp);else if(t==="encrypt")a={encrypted:await T(e.plaintext,e.aesKey,e.aesIv),plaintext:e.plaintext};else if(t==="decrypt")a={decrypted:await nt(e.ciphertext,e.aesKey,e.aesIv),ciphertext:e.ciphertext};else if(t==="did-decode")a=Xa(e.did);else if(t==="did-encode")a={encoded:$a(e.clientID,e.timestamp,e.appName||"Seminyak"),clientID:e.clientID,timestamp:e.timestamp};else if(t==="jwt-decode")a=Fa(e.jwt);else if(t==="hashcode"){const s=e.step||"check";let i;s==="posting"?i=await Kt(e):s==="lpd"?i=await Ya(e):i=await zt(e);const n=Qe;a={hash:i,step:s,formula:s==="posting"?`SHA256("@"+fromAcc+"|"+amount+"~"+dateTime+"*"+refNo+"^"+destBank+"#"+destAcc+"("+destName+")${n}@")`:`SHA256("%"+fromAcc+"#"+amount+"@"+dateTime+"^"+refNo+"*"+destBank+"~"+destAcc+"|${n}%")`}}else if(t==="reference"){const s=[];for(let i=0;i<(parseInt(e.count)||3);i++)s.push($(e.prefix||"SMY"));a={references:s}}else if(t==="signature")a={signature:await rt(e.token,e.timestamp,e.aesCs)};else if(t==="sig-decode"){const s=Ga(e.signature);a={hex:s,length:s.length}}else if(t==="ios-token-sig")a=await ot(e.timestamp||V());else if(t==="snap-token-sig")a=await Ut(e.clientKey||"LPD-SEMINYAK-001",e.timestamp||qe());else if(t==="build-transfer")a=await Ja({...e,timestamp:e.timestamp||V(),refNo:e.refNo||$()});else if(t==="decrypt-body"){const s=JSON.parse(e.body||"{}");a={decrypted:await Va(s,e.aesKey,e.aesIv)}}else if(t==="timestamp")a={jakarta:V(),jakartaISO:qe(),utc:new Date().toISOString()};else return{ok:!1,error:`Unknown operation: ${t}`};return{ok:!0,op:t,result:a}}catch(a){return{ok:!1,op:t,error:a instanceof Error?a.message:String(a)}}}const U=new qt;U.use("/static/*",Oa({root:"./public"}));U.get("/favicon.ico",e=>e.body(null,204));U.post("/api/exec",async e=>{try{const t=await e.req.json(),s=await(await fetch("http://127.0.0.1:3001/exec",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(t)})).json();return e.json(s)}catch(t){const a=t instanceof Error?t.message:String(t);return e.json({stdout:"",stderr:"Terminal server tidak tersedia: "+a,cwd:"/home/user",exitCode:1},500)}});U.get("/api/exec/health",async e=>{try{const a=await(await fetch("http://127.0.0.1:3001/health")).json();return e.json({ok:!0,...a})}catch{return e.json({ok:!1,error:"Terminal server tidak tersedia di production. Gunakan sandbox URL untuk operasi crypto.",sandbox_only:!0})}});U.post("/api/crypto",async e=>{try{const t=await e.req.json(),a=await Wa(t);return e.json(a)}catch(t){const a=t instanceof Error?t.message:String(t);return e.json({ok:!1,error:"Crypto error: "+a})}});function Qa(e){return e?e.split("{#}").filter(Boolean).map(t=>{const a=t.split("<>");return{norek:a[0]||"",nama:a[1]||"",saldo:a[2]||"",produk:a[3]||""}}):[]}const Je="34.50.74.78";async function X(e,t,a,s){if(!t)throw new Error("X-CLIENT-ID (clientIdEnc) wajib diisi — jalankan Derive AES Keys terlebih dahulu");const i=V(),n=qe(),r=a||$(),o=await jt(r,n),l=$(),u=s&&s.trim()?s.trim():o,b=await rt(u,i,e||""),d=b;return{jwt:o,ts:i,tsISO:n,sig:d,xref:l,headers:{"Content-Type":"application/json",Authorization:u,"X-TIMESTAMP":i,"X-SIGNATURE":d,"X-PARTNER-ID":b,"X-CLIENT-ID":t,"X-REFERENCE":l,"X-Forwarded-For":Je,"X-Real-IP":Je}}}async function Za(e,t,a){try{if(!t)return{ok:!1,error:"clientIdEnc (X-CLIENT-ID) wajib diisi — jalankan Auto Setup terlebih dahulu"};const s=V(),i=await ot(s),n=e+"/api/smart/access/token",r={"Content-Type":"application/json","X-TIMESTAMP":s,"X-CLIENT-ID":t,"X-SIGNATURE":i.signature,"X-Forwarded-For":Je,"X-Real-IP":Je},o=JSON.stringify({credential:"{get-token}"}),l=await fetch(n,{method:"POST",headers:r,body:o}),u=await l.text();let b={};try{b=JSON.parse(u)}catch{b={_raw:u}}const d=b.token||"",c=b.status||"";return c==="2007300"&&d?{ok:!0,token:d}:{ok:!1,error:`${c||"HTTP "+l.status}: ${b.message||u.slice(0,200)}`}}catch(s){return{ok:!1,error:s.message}}}U.post("/api/smart/get-ios-token",async e=>{try{const t=await e.req.json(),{baseUrl:a,clientIdEnc:s,aesCs:i}=t;if(!s)return e.json({ok:!1,error:"clientIdEnc wajib diisi — jalankan Auto Setup terlebih dahulu"});const n=(a||"https://lpdseminyak.biz.id:8000").replace(/\/+$/,""),r=await Za(n,s,i||"");return e.json({ok:r.ok,token:r.token,error:r.error,expiresIn:180})}catch(t){return e.json({ok:!1,error:t.message})}});U.post("/api/smart",async e=>{var t;try{const a=await e.req.json(),{action:s,baseUrl:i,aesKey:n,aesIv:r,aesCs:o,clientIdEnc:l,transNo:u,iosToken:b,...d}=a,c=(i||"https://lpdseminyak.biz.id:8000").replace(/\/+$/,""),m=k=>Ka(k),g=k=>/^[0-9a-f]{32}$/i.test(k);if(s==="login"){if(!d.user_name||!d.user_pass)throw new Error("user_name dan user_pass wajib diisi");if(!l)throw new Error("clientIdEnc (X-CLIENT-ID) wajib diisi");const k=g(d.user_name)?d.user_name:m(d.user_name),y=g(d.user_pass)?d.user_pass:m(d.user_pass),{headers:p,ts:w,xref:v,jwt:I,sig:S}=await X(o,l,u,b),x=c+"/api/smart/access/login",_=JSON.stringify({user_name:k,user_pass:y});let O=0,B={};try{const N=await fetch(x,{method:"POST",headers:p,body:_});O=N.status;const q=await N.text();try{B=JSON.parse(q)}catch{B={_raw:q}}}catch(N){return e.json({ok:!1,action:s,error:N.message,url:x,headers:p})}const L=O>=200&&O<300&&B.status==="00";let C=null;if(L&&B.account_list&&n&&r)try{const N=await nt(B.account_list,n,r);if(N){const q=Qa(N);C={nama:((t=q[0])==null?void 0:t.nama)||"",noid:d.user_name,accounts:q}}}catch{}return e.json({ok:L,action:s,httpStatus:O,url:x,result:B,nasabah:C,debug:{ts:w,xref:v,user_name_sent:k,user_pass_sent:y,jwt_preview:I.substring(0,40)+"...",sig_preview:S.substring(0,20)+"..."},requestHeaders:p})}if(s==="cek-saldo"){if(!d.no_rek)throw new Error("no_rek wajib diisi");if(!l)throw new Error("clientIdEnc wajib diisi");if(!n||!r)throw new Error("aesKey dan aesIv wajib diisi");const k=await T(d.no_rek,n,r),{headers:y,ts:p,xref:w}=await X(o,l,u,b),v=c+"/api/smart/account/balance",I=JSON.stringify({no_rek:k});let S=0,x={};try{const _=await fetch(v,{method:"POST",headers:y,body:I});S=_.status;const O=await _.text();try{x=JSON.parse(O)}catch{x={_raw:O}}}catch(_){return e.json({ok:!1,action:s,error:_.message})}return e.json({ok:S>=200&&S<300,action:s,httpStatus:S,url:v,result:x,debug:{ts:p,xref:w,no_rek_enc:k},requestHeaders:y})}if(s==="inquiry"){if(!d.no_rek_from||!d.no_rek_to||!d.nominal)throw new Error("no_rek_from, no_rek_to, nominal wajib diisi");if(!l)throw new Error("clientIdEnc wajib diisi");const k=u||$(),{headers:y,ts:p,xref:w}=await X(o,l,k,b),[v,I,S,x]=await Promise.all([T(d.no_rek_from,n,r),T(d.no_rek_to,n,r),T(d.nominal,n,r),d.bank_dest?T(d.bank_dest,n,r):Promise.resolve("")]),_=c+"/api/smart/transfer/inquiry",O=JSON.stringify({no_rek_from:v,no_rek_to:I,nominal:S,bank_dest:x,ref_no:k});let B=0,L={};try{const C=await fetch(_,{method:"POST",headers:y,body:O});B=C.status;const N=await C.text();try{L=JSON.parse(N)}catch{L={_raw:N}}}catch(C){return e.json({ok:!1,action:s,error:C.message})}return e.json({ok:B>=200&&B<300,action:s,httpStatus:B,url:_,result:L,debug:{ts:p,xref:w,ref:k},requestHeaders:y})}if(s==="posting"){if(!d.no_rek_from||!d.no_rek_to||!d.nominal)throw new Error("no_rek_from, no_rek_to, nominal wajib diisi");if(!l)throw new Error("clientIdEnc wajib diisi");const k=u||$(),{headers:y,ts:p,xref:w}=await X(o,l,k,b),[v,I,S,x,_,O]=await Promise.all([T(d.no_rek_from,n,r),T(d.no_rek_to,n,r),T(d.nominal,n,r),d.bank_dest?T(d.bank_dest,n,r):Promise.resolve(""),d.nama_dest?T(d.nama_dest,n,r):Promise.resolve(""),d.keterangan?T(d.keterangan,n,r):Promise.resolve("")]),B=c+"/api/smart/transfer/posting",L=JSON.stringify({no_rek_from:v,no_rek_to:I,nominal:S,bank_dest:x,nama_dest:_,keterangan:O,ref_no:k});let C=0,N={};try{const q=await fetch(B,{method:"POST",headers:y,body:L});C=q.status;const ne=await q.text();try{N=JSON.parse(ne)}catch{N={_raw:ne}}}catch(q){return e.json({ok:!1,action:s,error:q.message})}return e.json({ok:C>=200&&C<300,action:s,httpStatus:C,url:B,result:N,debug:{ts:p,xref:w,ref:k},requestHeaders:y})}const h=async(k,y,p)=>{const w=await fetch(k,{method:"POST",headers:y,body:p}),v=await w.text();let I;try{I=JSON.parse(v)}catch{I={_raw:v}}return{httpStatus:w.status,parsed:I}};if(s==="logout"){if(!l)throw new Error("clientIdEnc wajib diisi");const{headers:k,ts:y,xref:p}=await X(o,l,void 0,b),w=c+"/api/smart/access/logout";try{const{httpStatus:v,parsed:I}=await h(w,k,"{}");return e.json({ok:v<400,action:s,httpStatus:v,url:w,result:I,debug:{ts:y,xref:p}})}catch(v){return e.json({ok:!1,action:s,error:v.message})}}if(s==="account-list"){if(!l)throw new Error("clientIdEnc wajib diisi");if(!n||!r)throw new Error("aesKey dan aesIv wajib diisi");const k=await T(d.customer_id||"",n,r),{headers:y,ts:p,xref:w}=await X(o,l,void 0,b),v=c+"/api/smart/tabungan/account-list",I=JSON.stringify({customer_id:k});try{const{httpStatus:S,parsed:x}=await h(v,y,I);return e.json({ok:S<400,action:s,httpStatus:S,url:v,result:x,debug:{ts:p,xref:w,customer_id_enc:k}})}catch(S){return e.json({ok:!1,action:s,error:S.message})}}if(s==="mutasi-history"){if(!l)throw new Error("clientIdEnc wajib diisi");if(!n||!r)throw new Error("aesKey dan aesIv wajib diisi");const k=await T(d.customer_id||"",n,r),{headers:y,ts:p,xref:w}=await X(o,l,void 0,b),v=c+"/api/smart/tabungan/mutasi-history",I=JSON.stringify({customer_id:k});try{const{httpStatus:S,parsed:x}=await h(v,y,I);return e.json({ok:S<400,action:s,httpStatus:S,url:v,result:x,debug:{ts:p,xref:w,customer_id_enc:k}})}catch(S){return e.json({ok:!1,action:s,error:S.message})}}if(s==="transaction-history"){if(!l)throw new Error("clientIdEnc wajib diisi");if(!n||!r)throw new Error("aesKey dan aesIv wajib diisi");const k=await T(d.no_rek||"",n,r),y=await T(d.tgl_awal||"",n,r),p=await T(d.tgl_akhir||"",n,r),{headers:w,ts:v,xref:I}=await X(o,l,void 0,b),S=c+"/api/smart/tabungan/transaction-history",x=JSON.stringify({no_rek:k,tgl_awal:y,tgl_akhir:p});try{const{httpStatus:_,parsed:O}=await h(S,w,x);return e.json({ok:_<400,action:s,httpStatus:_,url:S,result:O,debug:{ts:v,xref:I}})}catch(_){return e.json({ok:!1,action:s,error:_.message})}}if(s==="transfer-lpd-check"){if(!d.no_rek_tujuan)throw new Error("no_rek_tujuan wajib diisi");if(!l)throw new Error("clientIdEnc wajib diisi");if(!n||!r)throw new Error("aesKey dan aesIv wajib diisi");const k=$(),y=await T(d.no_rek_tujuan,n,r),{headers:p,ts:w,xref:v}=await X(o,l,k,b),I=c+"/api/smart/transfer/lpd/check",S=JSON.stringify({account_no:y});try{const{httpStatus:x,parsed:_}=await h(I,p,S);return e.json({ok:x<400,action:s,httpStatus:x,url:I,result:_,debug:{ts:w,xref:v,ref:k,account_no_enc:y}})}catch(x){return e.json({ok:!1,action:s,error:x.message})}}if(s==="transfer-lpd-inquiry"){if(!d.no_rek_from||!d.no_rek_to||!d.nominal)throw new Error("no_rek_from, no_rek_to, nominal wajib diisi");if(!l)throw new Error("clientIdEnc wajib diisi");if(!n||!r)throw new Error("aesKey dan aesIv wajib diisi");const k=u||$(),{headers:y,ts:p,xref:w}=await X(o,l,k,b),[v,I,S,x,_,O]=await Promise.all([T(d.no_rek_from,n,r),T(d.no_rek_to,n,r),T(d.nama_tujuan||"",n,r),T(d.nominal,n,r),T(d.date_time||V(),n,r),T(d.keterangan||"",n,r)]),B=c+"/api/smart/transfer/lpd/inquiry",L=JSON.stringify({to_acc:I,to_name:S,from_acc:v,from_name:v,amount:x,remark:O});try{const{httpStatus:C,parsed:N}=await h(B,y,L);return e.json({ok:C<400,action:s,httpStatus:C,url:B,result:N,debug:{ts:p,xref:w,ref:k}})}catch(C){return e.json({ok:!1,action:s,error:C.message})}}if(s==="transfer-lpd-posting"){if(!d.no_rek_from||!d.no_rek_to||!d.nominal)throw new Error("no_rek_from, no_rek_to, nominal wajib diisi");if(!l)throw new Error("clientIdEnc wajib diisi");if(!n||!r)throw new Error("aesKey dan aesIv wajib diisi");const k=u||$(),{headers:y,ts:p,xref:w}=await X(o,l,k,b),[v,I,S,x,_,O]=await Promise.all([T(d.no_rek_from,n,r),T(d.no_rek_to,n,r),T(d.nama_tujuan||"",n,r),T(d.nominal,n,r),T(d.date_time||V(),n,r),T(d.keterangan||"",n,r)]),B=c+"/api/smart/transfer/lpd/post",L=JSON.stringify({to_acc:I,to_name:S,from_acc:v,from_name:v,amount:x,remark:O});try{const{httpStatus:C,parsed:N}=await h(B,y,L);return e.json({ok:C<400,action:s,httpStatus:C,url:B,result:N,debug:{ts:p,xref:w,ref:k}})}catch(C){return e.json({ok:!1,action:s,error:C.message})}}if(s==="transfer-bank-check"){if(!d.no_rek_tujuan||!d.kode_bank)throw new Error("no_rek_tujuan dan kode_bank wajib diisi");if(!l)throw new Error("clientIdEnc wajib diisi");if(!n||!r)throw new Error("aesKey dan aesIv wajib diisi");const k=$(),[y,p]=await Promise.all([T(d.no_rek_tujuan,n,r),T(d.kode_bank,n,r)]),{headers:w,ts:v,xref:I}=await X(o,l,k,b),S=c+"/api/smart/transfer/bank/check",x=JSON.stringify({account_no:y,bank_code:p});try{const{httpStatus:_,parsed:O}=await h(S,w,x);return e.json({ok:_<400,action:s,httpStatus:_,url:S,result:O,debug:{ts:v,xref:I,ref:k}})}catch(_){return e.json({ok:!1,action:s,error:_.message})}}if(s==="transfer-bank-inquiry"){if(!d.no_rek_from||!d.no_rek_to||!d.nominal||!d.kode_bank)throw new Error("no_rek_from, no_rek_to, nominal, kode_bank wajib diisi");if(!l)throw new Error("clientIdEnc wajib diisi");if(!n||!r)throw new Error("aesKey dan aesIv wajib diisi");const k=u||$(),{headers:y,ts:p,xref:w}=await X(o,l,k,b),[v,I,S,x,_,O]=await Promise.all([T(d.no_rek_from,n,r),T(d.no_rek_to,n,r),T(d.kode_bank,n,r),T(d.nominal,n,r),T(d.date_time||V(),n,r),T(d.hash_code||"",n,r)]),B=c+"/api/smart/transfer/bank/inquiry",L=JSON.stringify({from_acc:v,to_acc:I,bank_code:S,amount:x,date_time:_,hash_code:O,remark:""});try{const{httpStatus:C,parsed:N}=await h(B,y,L);return e.json({ok:C<400,action:s,httpStatus:C,url:B,result:N,debug:{ts:p,xref:w,ref:k}})}catch(C){return e.json({ok:!1,action:s,error:C.message})}}if(s==="transfer-bank-posting"){if(!d.no_rek_from||!d.no_rek_to||!d.nominal||!d.kode_bank)throw new Error("no_rek_from, no_rek_to, nominal, kode_bank wajib diisi");if(!l)throw new Error("clientIdEnc wajib diisi");if(!n||!r)throw new Error("aesKey dan aesIv wajib diisi");const k=u||$(),{headers:y,ts:p,xref:w}=await X(o,l,k,b),[v,I,S,x,_,O,B]=await Promise.all([T(d.no_rek_from,n,r),T(d.no_rek_to,n,r),T(d.kode_bank,n,r),T(d.nominal,n,r),T(d.date_time||V(),n,r),T(d.hash_code||"",n,r),T(d.keterangan||"",n,r)]),L=c+"/api/smart/transfer/bank/post",C=JSON.stringify({from_acc:v,to_acc:I,bank_code:S,amount:x,date_time:_,hash_code:O,remark:B});try{const{httpStatus:N,parsed:q}=await h(L,y,C);return e.json({ok:N<400,action:s,httpStatus:N,url:L,result:q,debug:{ts:p,xref:w,ref:k}})}catch(N){return e.json({ok:!1,action:s,error:N.message})}}return e.json({ok:!1,error:"Unknown action: "+s})}catch(a){const s=a instanceof Error?a.message:String(a);return e.json({ok:!1,error:"Smart error: "+s})}});U.post("/api/token/generate",async e=>{try{const t=await e.req.json(),{type:a,baseUrl:s,clientIdEnc:i,clientKey:n}=t;let r;if(a==="ios"){const o=V(),l=await ot(o),u=(s||"https://lpdseminyak.biz.id:8000")+"/api/smart/access/token",b={"Content-Type":"application/json","X-TIMESTAMP":o,"X-CLIENT-ID":i||"","X-SIGNATURE":l.signature,"X-Forwarded-For":"34.50.74.78","X-Real-IP":"34.50.74.78"};try{const d=await fetch(u,{method:"POST",headers:b,body:JSON.stringify({credential:"{get-token}"})}),c=await d.text();let m;try{m=JSON.parse(c)}catch{m={_raw:c}}r={ok:d.status<400,httpStatus:d.status,result:m,debug:l}}catch(d){r={ok:!1,error:d.message}}}else if(a==="snap"){const o=qe();r={ok:!0,result:await Ut(n||"LPD-SEMINYAK-001",o)}}else r={ok:!1,error:"type must be snap or ios"};return e.json(r)}catch(t){const a=t instanceof Error?t.message:String(t);return e.json({ok:!1,error:"Token error: "+a})}});const Q="/home/user/webapp/lpd_seminyak/storage/logs";U.post("/api/admin",async e=>{try{const t=await e.req.json(),a=t.op;if(a==="list-logs"){const r=((await(await fetch("http://127.0.0.1:3001/exec",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({command:`find ${Q} -maxdepth 2 \\( -name "*.txt" -o -name "*.log" \\) | sort -r | head -200`})})).json()).stdout||"").trim().split(`
`).filter(Boolean).map(k=>{const y=k.split("/").pop()||"",p=k.replace(Q+"/","").replace("/"+y,"");return{name:y,dir:p===y?"root":p,path:k}}),l=await(await fetch("http://127.0.0.1:3001/exec",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({command:`grep -c "local.ERROR" ${Q}/laravel.log 2>/dev/null || echo 0`})})).json(),u=parseInt((l.stdout||"0").trim())||0,d=await(await fetch("http://127.0.0.1:3001/exec",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({command:`grep -h "POST http" ${Q}/access-*.txt ${Q}/transfer-*.txt ${Q}/tabungan-*.txt 2>/dev/null | grep -oP '/api/[a-z/._-]+' | sort | uniq -c | sort -rn | head -20`})})).json(),c={};(d.stdout||"").trim().split(`
...
`).forEach(k=>{const y=k.trim().match(/^(\d+)\s+(\d{4}-\d{2}-\d{2})$/);y&&(h[y[2]]=parseInt(y[1]))}),e.json({ok:!0,files:r,error_count:u,endpoints:c,daily:h})}if(a==="read-log"){const s=(t.path||"").replace(/\.\./g,"").replace(/[^a-zA-Z0-9._\-]/g,""),i=(t.dir||"root").replace(/\.\./g,"").replace(/[^a-zA-Z0-9._\-]/g,"");let n="";i==="root"?n=`${Q}/${s}`:n=`${Q}/${i}/${s}`;const o=await(await fetch("http://127.0.0.1:3001/exec",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({command:`cat "${n}" 2>/dev/null | head -c 500000`})})).json();return!o.stdout||o.stdout.trim()===""?e.json({ok:!1,error:`File tidak ditemukan atau kosong: ${s}`}):e.json({ok:!0,content:o.stdout,path:n})}return e.json({ok:!1,error:"Unknown operation: "+a})}catch(t){const a=t instanceof Error?t.message:String(t);return a.includes("fetch")||a.includes("ECONNREFUSED")||a.includes("refused")?e.json({ok:!1,error:"Admin panel memerlukan sandbox environment. Di production, fitur baca log tidak tersedia karena tidak ada akses filesystem."}):e.json({ok:!1,error:"Admin error: "+a})}});U.get("/",e=>e.redirect("/admin"));U.get("/swagger",e=>e.html(qa()));U.get("/admin",e=>e.html(ja()));U.get("/crypto",e=>e.html(Ha()));U.get("/docs",e=>{const t=es();return e.html(t)});function es(){const e={installPhp:["# Ubuntu/Debian:","sudo apt-get install -y software-properties-common","sudo add-apt-repository ppa:ondrej/php","sudo apt-get update","sudo apt-get install -y php7.4 php7.4-cli php7.4-mbstring php7.4-xml \\","  php7.4-curl php7.4-zip php7.4-json php7.4-pdo php7.4-intl","","# Verifikasi:","php7.4 --version"].join(`
...
</html>`}const mt=new qt,ts=Object.assign({"/src/index.tsx":U});let Xt=!1;for(const[,e]of Object.entries(ts))e&&(mt.all("*",t=>{let a;try{a=t.executionCtx}catch{}return e.fetch(t.req.raw,t.env,a)}),mt.notFound(t=>{let a;try{a=t.executionCtx}catch{}return e.fetch(t.req.raw,t.env,a)}),Xt=!0);if(!Xt)throw new Error("Can't import modules from ['/src/index.ts','/src/index.tsx','/app/server.ts']");export{mt as default};
