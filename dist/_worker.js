var $t=Object.defineProperty;var it=e=>{throw TypeError(e)};var Ft=(e,t,a)=>t in e?$t(e,t,{enumerable:!0,configurable:!0,writable:!0,value:a}):e[t]=a;var A=(e,t,a)=>Ft(e,typeof t!="symbol"?t+"":t,a),Qe=(e,t,a)=>t.has(e)||it("Cannot "+a);var g=(e,t,a)=>(Qe(e,t,"read from private field"),a?a.call(e):t.get(e)),P=(e,t,a)=>t.has(e)?it("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,a),E=(e,t,a,n)=>(Qe(e,t,"write to private field"),n?n.call(e,a):t.set(e,a),a),_=(e,t,a)=>(Qe(e,t,"access private method"),a);var rt=(e,t,a,n)=>({set _(s){E(e,t,s,a)},get _(){return g(e,t,n)}});var ot=(e,t,a)=>(n,s)=>{let i=-1;return d(0);async function d(o){if(o<=i)throw new Error("next() called multiple times");i=o;let u,r=!1,b;if(e[o]?(b=e[o][0][0],n.req.routeIndex=o):b=o===e.length&&s||void 0,b)try{u=await b(n,()=>d(o+1))}catch(y){if(y instanceof Error&&t)n.error=y,u=await t(y,n),r=!0;else throw y}else n.finalized===!1&&a&&(u=await a(n));return u&&(n.finalized===!1||r)&&(n.res=u),n}},Gt=Symbol(),Yt=async(e,t=Object.create(null))=>{const{all:a=!1,dot:n=!1}=t,i=(e instanceof Tt?e.raw.headers:e.headers).get("Content-Type");return i!=null&&i.startsWith("multipart/form-data")||i!=null&&i.startsWith("application/x-www-form-urlencoded")?Jt(e,{all:a,dot:n}):{}};async function Jt(e,t){const a=await e.formData();return a?Vt(a,t):{}}function Vt(e,t){const a=Object.create(null);return e.forEach((n,s)=>{t.all||s.endsWith("[]")?Wt(a,s,n):a[s]=n}),t.dot&&Object.entries(a).forEach(([n,s])=>{n.includes(".")&&(Qt(a,n,s),delete a[n])}),a}var Wt=(e,t,a)=>{e[t]!==void 0?Array.isArray(e[t])?e[t].push(a):e[t]=[e[t],a]:t.endsWith("[]")?e[t]=[a]:e[t]=a},Qt=(e,t,a)=>{if(/(?:^|\.)__proto__\./.test(t))return;let n=e;const s=t.split(".");s.forEach((i,d)=>{d===s.length-1?n[i]=a:((!n[i]||typeof n[i]!="object"||Array.isArray(n[i])||n[i]instanceof File)&&(n[i]=Object.create(null)),n=n[i])})},yt=e=>{const t=e.split("/");return t[0]===""&&t.shift(),t},Zt=e=>{const{groups:t,path:a}=ea(e),n=yt(a);return ta(n,t)},ea=e=>{const t=[];return e=e.replace(/\{[^}]+\}/g,(a,n)=>{const s=`@${n}`;return t.push([s,a]),s}),{groups:t,path:e}},ta=(e,t)=>{for(let a=t.length-1;a>=0;a--){const[n]=t[a];for(let s=e.length-1;s>=0;s--)if(e[s].includes(n)){e[s]=e[s].replace(n,t[a][1]);break}}return e},Xe={},aa=(e,t)=>{if(e==="*")return"*";const a=e.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);if(a){const n=`${e}#${t}`;return Xe[n]||(a[2]?Xe[n]=t&&t[0]!==":"&&t[0]!=="*"?[n,a[1],new RegExp(`^${a[2]}(?=/${t})`)]:[e,a[1],new RegExp(`^${a[2]}$`)]:Xe[n]=[e,a[1],!0]),Xe[n]}return null},at=(e,t)=>{try{return t(e)}catch{return e.replace(/(?:%[0-9A-Fa-f]{2})+/g,a=>{try{return t(a)}catch{return a}})}},kt=e=>at(e,decodeURI),xt=e=>{const t=e.url,a=t.indexOf("/",t.indexOf(":")+4);let n=a;for(;n<t.length;n++){const s=t.charCodeAt(n);if(s===37){const i=t.indexOf("?",n),d=t.indexOf("#",n),o=i===-1?d===-1?void 0:d:d===-1?i:Math.min(i,d),u=t.slice(a,o);return kt(u.includes("%25")?u.replace(/%25/g,"%2525"):u)}else if(s===63||s===35)break}return t.slice(a,n)},sa=e=>{const t=xt(e);return t.length>1&&t.at(-1)==="/"?t.slice(0,-1):t},xe=(e,t,...a)=>(a.length&&(t=xe(t,...a)),`${(e==null?void 0:e[0])==="/"?"":"/"}${e}${t==="/"?"":`${(e==null?void 0:e.at(-1))==="/"?"":"/"}${(t==null?void 0:t[0])==="/"?t.slice(1):t}`}`),wt=e=>{if(e.charCodeAt(e.length-1)!==63||!e.includes(":"))return null;const t=e.split("/"),a=[];let n="";return t.forEach(s=>{if(s!==""&&!/\:/.test(s))n+="/"+s;else if(/\:/.test(s))if(/\?/.test(s)){a.length===0&&n===""?a.push("/"):a.push(n);const i=s.replace("?","");n+="/"+i,a.push(n)}else n+="/"+s}),a.filter((s,i,d)=>d.indexOf(s)===i)},Ze=e=>/[%+]/.test(e)?(e.indexOf("+")!==-1&&(e=e.replace(/\+/g," ")),e.indexOf("%")!==-1?at(e,It):e):e,St=(e,t,a)=>{let n;if(!a&&t&&!/[%+]/.test(t)){let d=e.indexOf("?",8);if(d===-1)return;for(e.startsWith(t,d+1)||(d=e.indexOf(`&${t}`,d+1));d!==-1;){const o=e.charCodeAt(d+t.length+1);if(o===61){const u=d+t.length+2,r=e.indexOf("&",u);return Ze(e.slice(u,r===-1?void 0:r))}else if(o==38||isNaN(o))return"";d=e.indexOf(`&${t}`,d+1)}if(n=/[%+]/.test(e),!n)return}const s={};n??(n=/[%+]/.test(e));let i=e.indexOf("?",8);for(;i!==-1;){const d=e.indexOf("&",i+1);let o=e.indexOf("=",i);o>d&&d!==-1&&(o=-1);let u=e.slice(i+1,o===-1?d===-1?void 0:d:o);if(n&&(u=Ze(u)),i=d,u==="")continue;let r;o===-1?r="":(r=e.slice(o+1,d===-1?void 0:d),n&&(r=Ze(r))),a?(s[u]&&Array.isArray(s[u])||(s[u]=[]),s[u].push(r)):s[u]??(s[u]=r)}return t?s[t]:s},na=St,ia=(e,t)=>St(e,t,!0),It=decodeURIComponent,dt=e=>at(e,It),Ie,X,te,Et,At,tt,ae,ft,Tt=(ft=class{constructor(e,t="/",a=[[]]){P(this,te);A(this,"raw");P(this,Ie);P(this,X);A(this,"routeIndex",0);A(this,"path");A(this,"bodyCache",{});P(this,ae,e=>{const{bodyCache:t,raw:a}=this,n=t[e];if(n)return n;const s=Object.keys(t)[0];return s?t[s].then(i=>(s==="json"&&(i=JSON.stringify(i)),new Response(i)[e]())):t[e]=a[e]()});this.raw=e,this.path=t,E(this,X,a),E(this,Ie,{})}param(e){return e?_(this,te,Et).call(this,e):_(this,te,At).call(this)}query(e){return na(this.url,e)}queries(e){return ia(this.url,e)}header(e){if(e)return this.raw.headers.get(e)??void 0;const t={};return this.raw.headers.forEach((a,n)=>{t[n]=a}),t}async parseBody(e){return Yt(this,e)}json(){return g(this,ae).call(this,"text").then(e=>JSON.parse(e))}text(){return g(this,ae).call(this,"text")}arrayBuffer(){return g(this,ae).call(this,"arrayBuffer")}blob(){return g(this,ae).call(this,"blob")}formData(){return g(this,ae).call(this,"formData")}addValidatedData(e,t){g(this,Ie)[e]=t}valid(e){return g(this,Ie)[e]}get url(){return this.raw.url}get method(){return this.raw.method}get[Gt](){return g(this,X)}get matchedRoutes(){return g(this,X)[0].map(([[,e]])=>e)}get routePath(){return g(this,X)[0].map(([[,e]])=>e)[this.routeIndex].path}},Ie=new WeakMap,X=new WeakMap,te=new WeakSet,Et=function(e){const t=g(this,X)[0][this.routeIndex][1][e],a=_(this,te,tt).call(this,t);return a&&/\%/.test(a)?dt(a):a},At=function(){const e={},t=Object.keys(g(this,X)[0][this.routeIndex][1]);for(const a of t){const n=_(this,te,tt).call(this,g(this,X)[0][this.routeIndex][1][a]);n!==void 0&&(e[a]=/\%/.test(n)?dt(n):n)}return e},tt=function(e){return g(this,X)[1]?g(this,X)[1][e]:e},ae=new WeakMap,ft),ra={Stringify:1},Pt=async(e,t,a,n,s)=>{typeof e=="object"&&!(e instanceof String)&&(e instanceof Promise||(e=e.toString()),e instanceof Promise&&(e=await e));const i=e.callbacks;return i!=null&&i.length?(s?s[0]+=e:s=[e],Promise.all(i.map(o=>o({phase:t,buffer:s,context:n}))).then(o=>Promise.all(o.filter(Boolean).map(u=>Pt(u,t,!1,n,s))).then(()=>s[0]))):Promise.resolve(e)},oa="text/plain; charset=UTF-8",et=(e,t)=>({"Content-Type":e,...t}),De=(e,t)=>new Response(e,t),Me,He,W,Te,Q,H,je,Ee,Ae,ue,ze,Ke,se,we,mt,da=(mt=class{constructor(e,t){P(this,se);P(this,Me);P(this,He);A(this,"env",{});P(this,W);A(this,"finalized",!1);A(this,"error");P(this,Te);P(this,Q);P(this,H);P(this,je);P(this,Ee);P(this,Ae);P(this,ue);P(this,ze);P(this,Ke);A(this,"render",(...e)=>(g(this,Ee)??E(this,Ee,t=>this.html(t)),g(this,Ee).call(this,...e)));A(this,"setLayout",e=>E(this,je,e));A(this,"getLayout",()=>g(this,je));A(this,"setRenderer",e=>{E(this,Ee,e)});A(this,"header",(e,t,a)=>{this.finalized&&E(this,H,De(g(this,H).body,g(this,H)));const n=g(this,H)?g(this,H).headers:g(this,ue)??E(this,ue,new Headers);t===void 0?n.delete(e):a!=null&&a.append?n.append(e,t):n.set(e,t)});A(this,"status",e=>{E(this,Te,e)});A(this,"set",(e,t)=>{g(this,W)??E(this,W,new Map),g(this,W).set(e,t)});A(this,"get",e=>g(this,W)?g(this,W).get(e):void 0);A(this,"newResponse",(...e)=>_(this,se,we).call(this,...e));A(this,"body",(e,t,a)=>_(this,se,we).call(this,e,t,a));A(this,"text",(e,t,a)=>!g(this,ue)&&!g(this,Te)&&!t&&!a&&!this.finalized?new Response(e):_(this,se,we).call(this,e,t,et(oa,a)));A(this,"json",(e,t,a)=>_(this,se,we).call(this,JSON.stringify(e),t,et("application/json",a)));A(this,"html",(e,t,a)=>{const n=s=>_(this,se,we).call(this,s,t,et("text/html; charset=UTF-8",a));return typeof e=="object"?Pt(e,ra.Stringify,!1,{}).then(n):n(e)});A(this,"redirect",(e,t)=>{const a=String(e);return this.header("Location",/[^\x00-\xFF]/.test(a)?encodeURI(a):a),this.newResponse(null,t??302)});A(this,"notFound",()=>(g(this,Ae)??E(this,Ae,()=>De()),g(this,Ae).call(this,this)));E(this,Me,e),t&&(E(this,Q,t.executionCtx),this.env=t.env,E(this,Ae,t.notFoundHandler),E(this,Ke,t.path),E(this,ze,t.matchResult))}get req(){return g(this,He)??E(this,He,new Tt(g(this,Me),g(this,Ke),g(this,ze))),g(this,He)}get event(){if(g(this,Q)&&"respondWith"in g(this,Q))return g(this,Q);throw Error("This context has no FetchEvent")}get executionCtx(){if(g(this,Q))return g(this,Q);throw Error("This context has no ExecutionContext")}get res(){return g(this,H)||E(this,H,De(null,{headers:g(this,ue)??E(this,ue,new Headers)}))}set res(e){if(g(this,H)&&e){e=De(e.body,e);for(const[t,a]of g(this,H).headers.entries())if(t!=="content-type")if(t==="set-cookie"){const n=g(this,H).headers.getSetCookie();e.headers.delete("set-cookie");for(const s of n)e.headers.append("set-cookie",s)}else e.headers.set(t,a)}E(this,H,e),this.finalized=!0}get var(){return g(this,W)?Object.fromEntries(g(this,W)):{}}},Me=new WeakMap,He=new WeakMap,W=new WeakMap,Te=new WeakMap,Q=new WeakMap,H=new WeakMap,je=new WeakMap,Ee=new WeakMap,Ae=new WeakMap,ue=new WeakMap,ze=new WeakMap,Ke=new WeakMap,se=new WeakSet,we=function(e,t,a){const n=g(this,H)?new Headers(g(this,H).headers):g(this,ue)??new Headers;if(typeof t=="object"&&"headers"in t){const i=t.headers instanceof Headers?t.headers:new Headers(t.headers);for(const[d,o]of i)d.toLowerCase()==="set-cookie"?n.append(d,o):n.set(d,o)}if(a)for(const[i,d]of Object.entries(a))if(typeof d=="string")n.set(i,d);else{n.delete(i);for(const o of d)n.append(i,o)}const s=typeof t=="number"?t:(t==null?void 0:t.status)??g(this,Te);return De(e,{status:s,headers:n})},mt),L="ALL",la="all",ca=["get","post","put","delete","options","patch"],Ct="Can not add a route since the matcher is already built.",_t=class extends Error{},pa="__COMPOSED_HANDLER",ua=e=>e.text("404 Not Found",404),lt=(e,t)=>{if("getResponse"in e){const a=e.getResponse();return t.newResponse(a.body,a)}return console.error(e),t.text("Internal Server Error",500)},$,O,Bt,F,ce,$e,Fe,Pe,fa=(Pe=class{constructor(t={}){P(this,O);A(this,"get");A(this,"post");A(this,"put");A(this,"delete");A(this,"options");A(this,"patch");A(this,"all");A(this,"on");A(this,"use");A(this,"router");A(this,"getPath");A(this,"_basePath","/");P(this,$,"/");A(this,"routes",[]);P(this,F,ua);A(this,"errorHandler",lt);A(this,"onError",t=>(this.errorHandler=t,this));A(this,"notFound",t=>(E(this,F,t),this));A(this,"fetch",(t,...a)=>_(this,O,Fe).call(this,t,a[1],a[0],t.method));A(this,"request",(t,a,n,s)=>t instanceof Request?this.fetch(a?new Request(t,a):t,n,s):(t=t.toString(),this.fetch(new Request(/^https?:\/\//.test(t)?t:`http://localhost${xe("/",t)}`,a),n,s)));A(this,"fire",()=>{addEventListener("fetch",t=>{t.respondWith(_(this,O,Fe).call(this,t.request,t,void 0,t.request.method))})});[...ca,la].forEach(i=>{this[i]=(d,...o)=>(typeof d=="string"?E(this,$,d):_(this,O,ce).call(this,i,g(this,$),d),o.forEach(u=>{_(this,O,ce).call(this,i,g(this,$),u)}),this)}),this.on=(i,d,...o)=>{for(const u of[d].flat()){E(this,$,u);for(const r of[i].flat())o.map(b=>{_(this,O,ce).call(this,r.toUpperCase(),g(this,$),b)})}return this},this.use=(i,...d)=>(typeof i=="string"?E(this,$,i):(E(this,$,"*"),d.unshift(i)),d.forEach(o=>{_(this,O,ce).call(this,L,g(this,$),o)}),this);const{strict:n,...s}=t;Object.assign(this,s),this.getPath=n??!0?t.getPath??xt:sa}route(t,a){const n=this.basePath(t);return a.routes.map(s=>{var d;let i;a.errorHandler===lt?i=s.handler:(i=async(o,u)=>(await ot([],a.errorHandler)(o,()=>s.handler(o,u))).res,i[pa]=s.handler),_(d=n,O,ce).call(d,s.method,s.path,i)}),this}basePath(t){const a=_(this,O,Bt).call(this);return a._basePath=xe(this._basePath,t),a}mount(t,a,n){let s,i;n&&(typeof n=="function"?i=n:(i=n.optionHandler,n.replaceRequest===!1?s=u=>u:s=n.replaceRequest));const d=i?u=>{const r=i(u);return Array.isArray(r)?r:[r]}:u=>{let r;try{r=u.executionCtx}catch{}return[u.env,r]};s||(s=(()=>{const u=xe(this._basePath,t),r=u==="/"?0:u.length;return b=>{const y=new URL(b.url);return y.pathname=y.pathname.slice(r)||"/",new Request(y,b)}})());const o=async(u,r)=>{const b=await a(s(u.req.raw),...d(u));if(b)return b;await r()};return _(this,O,ce).call(this,L,xe(t,"*"),o),this}},$=new WeakMap,O=new WeakSet,Bt=function(){const t=new Pe({router:this.router,getPath:this.getPath});return t.errorHandler=this.errorHandler,E(t,F,g(this,F)),t.routes=this.routes,t},F=new WeakMap,ce=function(t,a,n){t=t.toUpperCase(),a=xe(this._basePath,a);const s={basePath:this._basePath,path:a,method:t,handler:n};this.router.add(t,a,[n,s]),this.routes.push(s)},$e=function(t,a){if(t instanceof Error)return this.errorHandler(t,a);throw t},Fe=function(t,a,n,s){if(s==="HEAD")return(async()=>new Response(null,await _(this,O,Fe).call(this,t,a,n,"GET")))();const i=this.getPath(t,{env:n}),d=this.router.match(s,i),o=new da(t,{path:i,matchResult:d,env:n,executionCtx:a,notFoundHandler:g(this,F)});if(d[0].length===1){let r;try{r=d[0][0][0][0](o,async()=>{o.res=await g(this,F).call(this,o)})}catch(b){return _(this,O,$e).call(this,b,o)}return r instanceof Promise?r.then(b=>b||(o.finalized?o.res:g(this,F).call(this,o))).catch(b=>_(this,O,$e).call(this,b,o)):r??g(this,F).call(this,o)}const u=ot(d[0],this.errorHandler,g(this,F));return(async()=>{try{const r=await u(o);if(!r.finalized)throw new Error("Context is not finalized. Did you forget to return a Response object or `await next()`?");return r.res}catch(r){return _(this,O,$e).call(this,r,o)}})()},Pe),Rt=[];function ma(e,t){const a=this.buildAllMatchers(),n=((s,i)=>{const d=a[s]||a[L],o=d[2][i];if(o)return o;const u=i.match(d[0]);if(!u)return[[],Rt];const r=u.indexOf("",1);return[d[1][r],u]});return this.match=n,n(e,t)}var Ye="[^/]+",Le=".*",Oe="(?:|/.*)",Se=Symbol(),ga=new Set(".\\+*[^]$()");function ba(e,t){return e.length===1?t.length===1?e<t?-1:1:-1:t.length===1||e===Le||e===Oe?1:t===Le||t===Oe?-1:e===Ye?1:t===Ye?-1:e.length===t.length?e<t?-1:1:t.length-e.length}var fe,me,G,he,ha=(he=class{constructor(){P(this,fe);P(this,me);P(this,G,Object.create(null))}insert(t,a,n,s,i){if(t.length===0){if(g(this,fe)!==void 0)throw Se;if(i)return;E(this,fe,a);return}const[d,...o]=t,u=d==="*"?o.length===0?["","",Le]:["","",Ye]:d==="/*"?["","",Oe]:d.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);let r;if(u){const b=u[1];let y=u[2]||Ye;if(b&&u[2]&&(y===".*"||(y=y.replace(/^\((?!\?:)(?=[^)]+\)$)/,"(?:"),/\((?!\?:)/.test(y))))throw Se;if(r=g(this,G)[y],!r){if(Object.keys(g(this,G)).some(p=>p!==Le&&p!==Oe))throw Se;if(i)return;r=g(this,G)[y]=new he,b!==""&&E(r,me,s.varIndex++)}!i&&b!==""&&n.push([b,g(r,me)])}else if(r=g(this,G)[d],!r){if(Object.keys(g(this,G)).some(b=>b.length>1&&b!==Le&&b!==Oe))throw Se;if(i)return;r=g(this,G)[d]=new he}r.insert(o,a,n,s,i)}buildRegExpStr(){const a=Object.keys(g(this,G)).sort(ba).map(n=>{const s=g(this,G)[n];return(typeof g(s,me)=="number"?`(${n})@${g(s,me)}`:ga.has(n)?`\\${n}`:n)+s.buildRegExpStr()});return typeof g(this,fe)=="number"&&a.unshift(`#${g(this,fe)}`),a.length===0?"":a.length===1?a[0]:"(?:"+a.join("|")+")"}},fe=new WeakMap,me=new WeakMap,G=new WeakMap,he),Je,Ue,gt,va=(gt=class{constructor(){P(this,Je,{varIndex:0});P(this,Ue,new ha)}insert(e,t,a){const n=[],s=[];for(let d=0;;){let o=!1;if(e=e.replace(/\{[^}]+\}/g,u=>{const r=`@\\${d}`;return s[d]=[r,u],d++,o=!0,r}),!o)break}const i=e.match(/(?::[^\/]+)|(?:\/\*$)|./g)||[];for(let d=s.length-1;d>=0;d--){const[o]=s[d];for(let u=i.length-1;u>=0;u--)if(i[u].indexOf(o)!==-1){i[u]=i[u].replace(o,s[d][1]);break}}return g(this,Ue).insert(i,t,n,g(this,Je),a),n}buildRegExp(){let e=g(this,Ue).buildRegExpStr();if(e==="")return[/^$/,[],[]];let t=0;const a=[],n=[];return e=e.replace(/#(\d+)|@(\d+)|\.\*\$/g,(s,i,d)=>i!==void 0?(a[++t]=Number(i),"$()"):(d!==void 0&&(n[Number(d)]=++t),"")),[new RegExp(`^${e}`),a,n]}},Je=new WeakMap,Ue=new WeakMap,gt),ya=[/^$/,[],Object.create(null)],Ge=Object.create(null);function Dt(e){return Ge[e]??(Ge[e]=new RegExp(e==="*"?"":`^${e.replace(/\/\*$|([.\\+*[^\]$()])/g,(t,a)=>a?`\\${a}`:"(?:|/.*)")}$`))}function ka(){Ge=Object.create(null)}function xa(e){var r;const t=new va,a=[];if(e.length===0)return ya;const n=e.map(b=>[!/\*|\/:/.test(b[0]),...b]).sort(([b,y],[p,m])=>b?1:p?-1:y.length-m.length),s=Object.create(null);for(let b=0,y=-1,p=n.length;b<p;b++){const[m,l,f]=n[b];m?s[l]=[f.map(([v])=>[v,Object.create(null)]),Rt]:y++;let x;try{x=t.insert(l,y,m)}catch(v){throw v===Se?new _t(l):v}m||(a[y]=f.map(([v,c])=>{const k=Object.create(null);for(c-=1;c>=0;c--){const[h,T]=x[c];k[h]=T}return[v,k]}))}const[i,d,o]=t.buildRegExp();for(let b=0,y=a.length;b<y;b++)for(let p=0,m=a[b].length;p<m;p++){const l=(r=a[b][p])==null?void 0:r[1];if(!l)continue;const f=Object.keys(l);for(let x=0,v=f.length;x<v;x++)l[f[x]]=o[l[f[x]]]}const u=[];for(const b in d)u[b]=a[d[b]];return[i,u,s]}function ke(e,t){if(e){for(const a of Object.keys(e).sort((n,s)=>s.length-n.length))if(Dt(a).test(t))return[...e[a]]}}var ne,ie,Ve,Nt,bt,wa=(bt=class{constructor(){P(this,Ve);A(this,"name","RegExpRouter");P(this,ne);P(this,ie);A(this,"match",ma);E(this,ne,{[L]:Object.create(null)}),E(this,ie,{[L]:Object.create(null)})}add(e,t,a){var o;const n=g(this,ne),s=g(this,ie);if(!n||!s)throw new Error(Ct);n[e]||[n,s].forEach(u=>{u[e]=Object.create(null),Object.keys(u[L]).forEach(r=>{u[e][r]=[...u[L][r]]})}),t==="/*"&&(t="*");const i=(t.match(/\/:/g)||[]).length;if(/\*$/.test(t)){const u=Dt(t);e===L?Object.keys(n).forEach(r=>{var b;(b=n[r])[t]||(b[t]=ke(n[r],t)||ke(n[L],t)||[])}):(o=n[e])[t]||(o[t]=ke(n[e],t)||ke(n[L],t)||[]),Object.keys(n).forEach(r=>{(e===L||e===r)&&Object.keys(n[r]).forEach(b=>{u.test(b)&&n[r][b].push([a,i])})}),Object.keys(s).forEach(r=>{(e===L||e===r)&&Object.keys(s[r]).forEach(b=>u.test(b)&&s[r][b].push([a,i]))});return}const d=wt(t)||[t];for(let u=0,r=d.length;u<r;u++){const b=d[u];Object.keys(s).forEach(y=>{var p;(e===L||e===y)&&((p=s[y])[b]||(p[b]=[...ke(n[y],b)||ke(n[L],b)||[]]),s[y][b].push([a,i-r+u+1]))})}}buildAllMatchers(){const e=Object.create(null);return Object.keys(g(this,ie)).concat(Object.keys(g(this,ne))).forEach(t=>{e[t]||(e[t]=_(this,Ve,Nt).call(this,t))}),E(this,ne,E(this,ie,void 0)),ka(),e}},ne=new WeakMap,ie=new WeakMap,Ve=new WeakSet,Nt=function(e){const t=[];let a=e===L;return[g(this,ne),g(this,ie)].forEach(n=>{const s=n[e]?Object.keys(n[e]).map(i=>[i,n[e][i]]):[];s.length!==0?(a||(a=!0),t.push(...s)):e!==L&&t.push(...Object.keys(n[L]).map(i=>[i,n[L][i]]))}),a?xa(t):null},bt),re,Z,ht,Sa=(ht=class{constructor(e){A(this,"name","SmartRouter");P(this,re,[]);P(this,Z,[]);E(this,re,e.routers)}add(e,t,a){if(!g(this,Z))throw new Error(Ct);g(this,Z).push([e,t,a])}match(e,t){if(!g(this,Z))throw new Error("Fatal error");const a=g(this,re),n=g(this,Z),s=a.length;let i=0,d;for(;i<s;i++){const o=a[i];try{for(let u=0,r=n.length;u<r;u++)o.add(...n[u]);d=o.match(e,t)}catch(u){if(u instanceof _t)continue;throw u}this.match=o.match.bind(o),E(this,re,[o]),E(this,Z,void 0);break}if(i===s)throw new Error("Fatal error");return this.name=`SmartRouter + ${this.activeRouter.name}`,d}get activeRouter(){if(g(this,Z)||g(this,re).length!==1)throw new Error("No active router has been determined yet.");return g(this,re)[0]}},re=new WeakMap,Z=new WeakMap,ht),Ne=Object.create(null),Ia=e=>{for(const t in e)return!0;return!1},oe,M,ge,Ce,q,ee,pe,_e,Ta=(_e=class{constructor(t,a,n){P(this,ee);P(this,oe);P(this,M);P(this,ge);P(this,Ce,0);P(this,q,Ne);if(E(this,M,n||Object.create(null)),E(this,oe,[]),t&&a){const s=Object.create(null);s[t]={handler:a,possibleKeys:[],score:0},E(this,oe,[s])}E(this,ge,[])}insert(t,a,n){E(this,Ce,++rt(this,Ce)._);let s=this;const i=Zt(a),d=[];for(let o=0,u=i.length;o<u;o++){const r=i[o],b=i[o+1],y=aa(r,b),p=Array.isArray(y)?y[0]:r;if(p in g(s,M)){s=g(s,M)[p],y&&d.push(y[1]);continue}g(s,M)[p]=new _e,y&&(g(s,ge).push(y),d.push(y[1])),s=g(s,M)[p]}return g(s,oe).push({[t]:{handler:n,possibleKeys:d.filter((o,u,r)=>r.indexOf(o)===u),score:g(this,Ce)}}),s}search(t,a){var b;const n=[];E(this,q,Ne);let i=[this];const d=yt(a),o=[],u=d.length;let r=null;for(let y=0;y<u;y++){const p=d[y],m=y===u-1,l=[];for(let x=0,v=i.length;x<v;x++){const c=i[x],k=g(c,M)[p];k&&(E(k,q,g(c,q)),m?(g(k,M)["*"]&&_(this,ee,pe).call(this,n,g(k,M)["*"],t,g(c,q)),_(this,ee,pe).call(this,n,k,t,g(c,q))):l.push(k));for(let h=0,T=g(c,ge).length;h<T;h++){const S=g(c,ge)[h],w=g(c,q)===Ne?{}:{...g(c,q)};if(S==="*"){const K=g(c,M)["*"];K&&(_(this,ee,pe).call(this,n,K,t,g(c,q)),E(K,q,w),l.push(K));continue}const[D,N,C]=S;if(!p&&!(C instanceof RegExp))continue;const R=g(c,M)[D];if(C instanceof RegExp){if(r===null){r=new Array(u);let ye=a[0]==="/"?1:0;for(let Re=0;Re<u;Re++)r[Re]=ye,ye+=d[Re].length+1}const K=a.substring(r[y]),ve=C.exec(K);if(ve){if(w[N]=ve[0],_(this,ee,pe).call(this,n,R,t,g(c,q),w),Ia(g(R,M))){E(R,q,w);const ye=((b=ve[0].match(/\//))==null?void 0:b.length)??0;(o[ye]||(o[ye]=[])).push(R)}continue}}(C===!0||C.test(p))&&(w[N]=p,m?(_(this,ee,pe).call(this,n,R,t,w,g(c,q)),g(R,M)["*"]&&_(this,ee,pe).call(this,n,g(R,M)["*"],t,w,g(c,q))):(E(R,q,w),l.push(R)))}}const f=o.shift();i=f?l.concat(f):l}return n.length>1&&n.sort((y,p)=>y.score-p.score),[n.map(({handler:y,params:p})=>[y,p])]}},oe=new WeakMap,M=new WeakMap,ge=new WeakMap,Ce=new WeakMap,q=new WeakMap,ee=new WeakSet,pe=function(t,a,n,s,i){for(let d=0,o=g(a,oe).length;d<o;d++){const u=g(a,oe)[d],r=u[n]||u[L],b={};if(r!==void 0&&(r.params=Object.create(null),t.push(r),s!==Ne||i&&i!==Ne))for(let y=0,p=r.possibleKeys.length;y<p;y++){const m=r.possibleKeys[y],l=b[r.score];r.params[m]=i!=null&&i[m]&&!l?i[m]:s[m]??(i==null?void 0:i[m]),b[r.score]=!0}}},_e),be,vt,Ea=(vt=class{constructor(){A(this,"name","TrieRouter");P(this,be);E(this,be,new Ta)}add(e,t,a){const n=wt(t);if(n){for(let s=0,i=n.length;s<i;s++)g(this,be).insert(e,n[s],a);return}g(this,be).insert(e,t,a)}match(e,t){return g(this,be).search(e,t)}},be=new WeakMap,vt),Lt=class extends fa{constructor(e={}){super(e),this.router=e.router??new Sa({routers:[new wa,new Ea]})}},Aa=/^\s*(?:text\/(?!event-stream(?:[;\s]|$))[^;\s]+|application\/(?:javascript|json|xml|xml-dtd|ecmascript|dart|postscript|rtf|tar|toml|vnd\.dart|vnd\.ms-fontobject|vnd\.ms-opentype|wasm|x-httpd-php|x-javascript|x-ns-proxy-autoconfig|x-sh|x-tar|x-virtualbox-hdd|x-virtualbox-ova|x-virtualbox-ovf|x-virtualbox-vbox|x-virtualbox-vdi|x-virtualbox-vhd|x-virtualbox-vmdk|x-www-form-urlencoded)|font\/(?:otf|ttf)|image\/(?:bmp|vnd\.adobe\.photoshop|vnd\.microsoft\.icon|vnd\.ms-dds|x-icon|x-ms-bmp)|message\/rfc822|model\/gltf-binary|x-shader\/x-fragment|x-shader\/x-vertex|[^;\s]+?\+(?:json|text|xml|yaml))(?:[;\s]|$)/i,ct=(e,t=Ca)=>{const a=/\.([a-zA-Z0-9]+?)$/,n=e.match(a);if(!n)return;let s=t[n[1].toLowerCase()];return s&&s.startsWith("text")&&(s+="; charset=utf-8"),s},Pa={aac:"audio/aac",avi:"video/x-msvideo",avif:"image/avif",av1:"video/av1",bin:"application/octet-stream",bmp:"image/bmp",css:"text/css",csv:"text/csv",eot:"application/vnd.ms-fontobject",epub:"application/epub+zip",gif:"image/gif",gz:"application/gzip",htm:"text/html",html:"text/html",ico:"image/x-icon",ics:"text/calendar",jpeg:"image/jpeg",jpg:"image/jpeg",js:"text/javascript",json:"application/json",jsonld:"application/ld+json",map:"application/json",mid:"audio/x-midi",midi:"audio/x-midi",mjs:"text/javascript",mp3:"audio/mpeg",mp4:"video/mp4",mpeg:"video/mpeg",oga:"audio/ogg",ogv:"video/ogg",ogx:"application/ogg",opus:"audio/opus",otf:"font/otf",pdf:"application/pdf",png:"image/png",rtf:"application/rtf",svg:"image/svg+xml",tif:"image/tiff",tiff:"image/tiff",ts:"video/mp2t",ttf:"font/ttf",txt:"text/plain",wasm:"application/wasm",webm:"video/webm",weba:"audio/webm",webmanifest:"application/manifest+json",webp:"image/webp",woff:"font/woff",woff2:"font/woff2",xhtml:"application/xhtml+xml",xml:"application/xml",zip:"application/zip","3gp":"video/3gpp","3g2":"video/3gpp2",gltf:"model/gltf+json",glb:"model/gltf-binary"},Ca=Pa,_a=(...e)=>{let t=e.filter(s=>s!=="").join("/");t=t.replace(new RegExp("(?<=\\/)\\/+","g"),"");const a=t.split("/"),n=[];for(const s of a)s===".."&&n.length>0&&n.at(-1)!==".."?n.pop():s!=="."&&n.push(s);return n.join("/")||"."},Ot={br:".br",zstd:".zst",gzip:".gz"},Ba=Object.keys(Ot),Ra="index.html",Da=e=>{const t=e.root??"./",a=e.path,n=e.join??_a;return async(s,i)=>{var b,y,p,m;if(s.finalized)return i();let d;if(e.path)d=e.path;else try{if(d=kt(s.req.path),/(?:^|[\/\\])\.{1,2}(?:$|[\/\\])|[\/\\]{2,}/.test(d))throw new Error}catch{return await((b=e.onNotFound)==null?void 0:b.call(e,s.req.path,s)),i()}let o=n(t,!a&&e.rewriteRequestPath?e.rewriteRequestPath(d):d);e.isDir&&await e.isDir(o)&&(o=n(o,Ra));const u=e.getContent;let r=await u(o,s);if(r instanceof Response)return s.newResponse(r.body,r);if(r){const l=e.mimes&&ct(o,e.mimes)||ct(o);if(s.header("Content-Type",l||"application/octet-stream"),e.precompressed&&(!l||Aa.test(l))){const f=new Set((y=s.req.header("Accept-Encoding"))==null?void 0:y.split(",").map(x=>x.trim()));for(const x of Ba){if(!f.has(x))continue;const v=await u(o+Ot[x],s);if(v){r=v,s.header("Content-Encoding",x),s.header("Vary","Accept-Encoding",{append:!0});break}}}return await((p=e.onFound)==null?void 0:p.call(e,o,s)),s.body(r)}await((m=e.onNotFound)==null?void 0:m.call(e,o,s)),await i()}},Na=async(e,t)=>{let a;t&&t.manifest?typeof t.manifest=="string"?a=JSON.parse(t.manifest):a=t.manifest:typeof __STATIC_CONTENT_MANIFEST=="string"?a=JSON.parse(__STATIC_CONTENT_MANIFEST):a=__STATIC_CONTENT_MANIFEST;let n;t&&t.namespace?n=t.namespace:n=__STATIC_CONTENT;const s=a[e];if(!s)return null;const i=await n.get(s,{type:"stream"});return i||null},La=e=>async function(a,n){return Da({...e,getContent:async i=>Na(i,{manifest:e.manifest,namespace:e.namespace?e.namespace:a.env?a.env.__STATIC_CONTENT:void 0})})(a,n)},Oa=e=>La(e);function qa(){return`<!DOCTYPE html>
<html lang="id">
<head>
<meta charset="UTF-8"/>
...
<\/script>
...
</html>`}function B(e,t,a,n,s,i,d,o,u){const r="mb-post",b=s.map(h=>`
    <tr>
    ...
    </tr>`).join(""),y=s.filter(h=>h.in==="header"),p=s.filter(h=>h.in==="query"),m=s.filter(h=>h.in==="body"),l=y.length?`
    ...
    ${d?`<button onclick="copyExample('${e}')" style="font-size:11px;background:#f1f5f9;border:1px solid #e2e8f0;padding:3px 8px;border-radius:4px;cursor:pointer;margin-bottom:6px;color:#475569"><i class="fas fa-copy" style="margin-right:4px"></i>Isi Contoh</button>`:""}
    <textarea id="try-body-${e}" class="try-input try-textarea" data-example="${d.replace(/"/g,"&quot;")}"
      placeholder='${JSON.stringify(Object.fromEntries(m.map(h=>[h.name,h.type])),null,2)}'>${d}</textarea>`:"",v=o.map(h=>`<span class="mw-badge"><i class="fas fa-shield-alt"></i>${h}</span>`).join(""),c=u?`<div class="info-box ib-blue" style="margin-top:12px"><i class="fas fa-info-circle"></i><span>${u}</span></div>`:"",k=i?`
...
<div class="ep-card" id="ep-${e}">
  <div class="ep-header" onclick="epToggle('${e}')">
    <span class="method-badge ${r}">${t}</span>
...
</html>`}const qt=`-----BEGIN PRIVATE KEY-----
...
-----END PRIVATE KEY-----`,We="p91wrswK";function de(e){if(!e||typeof e!="string")return new Uint8Array(0);const t=e.replace(/-/g,"+").replace(/_/g,"/"),a=t.padEnd(t.length+(4-t.length%4)%4,"=");try{const n=atob(a);return Uint8Array.from(n,s=>s.charCodeAt(0))}catch{return new Uint8Array(0)}}function le(e){return btoa(String.fromCharCode(...new Uint8Array(e)))}function Be(e){return Array.from(new Uint8Array(e)).map(t=>t.toString(16).padStart(2,"0")).join("")}function Y(e){return new TextEncoder().encode(e)}function Ka(e){function t(v,c){const k=(v&65535)+(c&65535);return(v>>16)+(c>>16)+(k>>16)<<16|k&65535}function a(v,c){return v<<c|v>>>32-c}function n(v,c,k,h,T,S){return t(a(t(t(c,v),t(h,S)),T),k)}function s(v,c,k,h,T,S,w){return n(c&k|~c&h,v,c,T,S,w)}function i(v,c,k,h,T,S,w){return n(c&h|k&~h,v,c,T,S,w)}function d(v,c,k,h,T,S,w){return n(c^k^h,v,c,T,S,w)}function o(v,c,k,h,T,S,w){return n(k^(c|~h),v,c,T,S,w)}function u(v){const c=[];for(let k=0;k<v.length;k++){const h=v.charCodeAt(k);h<128?c.push(h):h<2048?c.push(h>>6|192,h&63|128):h<65536?c.push(h>>12|224,h>>6&63|128,h&63|128):c.push(h>>18|240,h>>12&63|128,h>>6&63|128,h&63|128)}return c}const r=u(e),b=r.length;for(r.push(128);r.length%64!==56;)r.push(0);const y=b*8;for(let v=0;v<8;v++)r.push(v<4?y>>>v*8&255:y/4294967296>>>v*4*8&255);let p=1732584193,m=4023233417,l=2562383102,f=271733878;for(let v=0;v<r.length;v+=64){const c=[];for(let w=0;w<16;w++)c[w]=r[v+w*4]|r[v+w*4+1]<<8|r[v+w*4+2]<<16|r[v+w*4+3]<<24;let[k,h,T,S]=[p,m,l,f];p=s(p,m,l,f,c[0],7,-680876936),f=s(f,p,m,l,c[1],12,-389564586),l=s(l,f,p,m,c[2],17,606105819),m=s(m,l,f,p,c[3],22,-1044525330),p=s(p,m,l,f,c[4],7,-176418897),f=s(f,p,m,l,c[5],12,1200080426),l=s(l,f,p,m,c[6],17,-1473231341),m=s(m,l,f,p,c[7],22,-45705983),p=s(p,m,l,f,c[8],7,1770035416),f=s(f,p,m,l,c[9],12,-1958414417),l=s(l,f,p,m,c[10],17,-42063),m=s(m,l,f,p,c[11],22,-1990404162),p=s(p,m,l,f,c[12],7,1804603682),f=s(f,p,m,l,c[13],12,-40341101),l=s(l,f,p,m,c[14],17,-1502002290),m=s(m,l,f,p,c[15],22,1236535329),p=i(p,m,l,f,c[1],5,-165796510),f=i(f,p,m,l,c[6],9,-1069501632),l=i(l,f,p,m,c[11],14,643717713),m=i(m,l,f,p,c[0],20,-373897302),p=i(p,m,l,f,c[5],5,-701558691),f=i(f,p,m,l,c[10],9,38016083),l=i(l,f,p,m,c[15],14,-660478335),m=i(m,l,f,p,c[4],20,-405537848),p=i(p,m,l,f,c[9],5,568446438),f=i(f,p,m,l,c[14],9,-1019803690),l=i(l,f,p,m,c[3],14,-187363961),m=i(m,l,f,p,c[8],20,1163531501),p=i(p,m,l,f,c[13],5,-1444681467),f=i(f,p,m,l,c[2],9,-51403784),l=i(l,f,p,m,c[7],14,1735328473),m=i(m,l,f,p,c[12],20,-1926607734),p=d(p,m,l,f,c[5],4,-378558),f=d(f,p,m,l,c[8],11,-2022574463),l=d(l,f,p,m,c[11],16,1839030562),m=d(m,l,f,p,c[14],23,-35309556),p=d(p,m,l,f,c[1],4,-1530992060),f=d(f,p,m,l,c[4],11,1272893353),l=d(l,f,p,m,c[7],16,-155497632),m=d(m,l,f,p,c[10],23,-1094730640),p=d(p,m,l,f,c[13],4,681279174),f=d(f,p,m,l,c[0],11,-358537222),l=d(l,f,p,m,c[3],16,-722521979),m=d(m,l,f,p,c[6],23,76029189),p=d(p,m,l,f,c[9],4,-640364487),f=d(f,p,m,l,c[12],11,-421815835),l=d(l,f,p,m,c[15],16,530742520),m=d(m,l,f,p,c[2],23,-995338651),p=o(p,m,l,f,c[0],6,-198630844),f=o(f,p,m,l,c[7],10,1126891415),l=o(l,f,p,m,c[14],15,-1416354905),m=o(m,l,f,p,c[5],21,-57434055),p=o(p,m,l,f,c[12],6,1700485571),f=o(f,p,m,l,c[3],10,-1894986606),l=o(l,f,p,m,c[10],15,-1051523),m=o(m,l,f,p,c[1],21,-2054922799),p=o(p,m,l,f,c[8],6,1873313359),f=o(f,p,m,l,c[15],10,-30611744),l=o(l,f,p,m,c[6],15,-1560198380),m=o(m,l,f,p,c[13],21,1309151649),p=o(p,m,l,f,c[4],6,-145523070),f=o(f,p,m,l,c[11],10,-1120210379),l=o(l,f,p,m,c[2],15,718787259),m=o(m,l,f,p,c[9],21,-343485551),p=t(p,k),m=t(m,h),l=t(l,T),f=t(f,S)}function x(v){let c="";for(let k=0;k<4;k++)c+=(v>>>k*8&255).toString(16).padStart(2,"0");return c}return x(p)+x(m)+x(l)+x(f)}async function Ua(e,t){const a=t.slice(-8),n=a.split(":").map(Number),s=await crypto.subtle.importKey("raw",Y(t),{name:"HMAC",hash:"SHA-512"},!1,["sign"]),i=new Uint8Array(await crypto.subtle.sign("HMAC",s,Y(e))),d=i.length,o=n[0],u=Math.floor((d+n[1])/2)-16,r=Math.floor((d+n[2])/3)-8,b=le(i.slice(o,o+32)),y=le(i.slice(u,u+16)),p=le(i.slice(r,r+8));return{aesKey:b,aesIv:y,aesCs:p,times:n,kStart:o,ivStart:u,csStart:r,debug:{lastEight:a,times:n,kStart:o,ivStart:u,csStart:r,keyBytesHex:Be(i).slice(0,32)+"..."}}}async function I(e,t,a){const n=await crypto.subtle.importKey("raw",de(t),"AES-CBC",!1,["encrypt"]),s=de(a),i=await crypto.subtle.encrypt({name:"AES-CBC",iv:s},n,Y(e));return le(i)}async function Mt(e,t,a){try{const n=await crypto.subtle.importKey("raw",de(t),"AES-CBC",!1,["decrypt"]),s=de(a),i=await crypto.subtle.decrypt({name:"AES-CBC",iv:s},n,de(e));return new TextDecoder().decode(i)}catch{return null}}function Xa(e){const t=e.endsWith("==")?"==":e.endsWith("=")?"=":"",a=e.substring(7,13),n=parseInt(a[0])*10+a.charCodeAt(1)-64,s=100+parseInt(a[2])*10+a.charCodeAt(3)-64,i=100+parseInt(a[4])*10+a.charCodeAt(5)-64,d=e.substring(16,20),o=d.charCodeAt(0)-64,u=d.charCodeAt(1)-64,r=parseInt(d.slice(2)),b=e.substring(n,n+o)+e.substring(s,s+u)+e.substring(i,i+r),y=atob((b+t).replace(/-/g,"+").replace(/_/g,"/")),p=y.split("|");return{app:p[0]||"",clientID:p[1]||"",regTime:p[2]||"",rawDecoded:y,parts:p,debug:{col1:n,col2:s,col3:i,len1:o,len2:u,len3:r,idd:b.slice(0,20)+"..."}}}function $a(e,t,a="Seminyak"){const n=`${a}|${e}|${t}`,s=btoa(n),i=s.endsWith("==")?"==":s.endsWith("=")?"=":"",d=s.slice(0,s.length-i.length),o=d.length,u=20,r=104,b=172,y=Math.floor(o/3),p=y,m=y,l=o-p-m,f=d.slice(0,p),x=d.slice(p,p+m),v=d.slice(p+m),c=w=>String(Math.floor(w/10))+String.fromCharCode(w%10+64),k=c(u)+c(r-100)+c(b-100),h=String.fromCharCode(p+64)+String.fromCharCode(m+64)+String(l).padStart(2,"0"),T=Math.max(b+l,200),S=new Array(T+50).fill("A");S[7]=k[0],S[8]=k[1],S[9]=k[2],S[10]=k[3],S[11]=k[4],S[12]=k[5],S[16]=h[0],S[17]=h[1],S[18]=h[2],S[19]=h[3];for(let w=0;w<f.length;w++)S[u+w]=f[w];for(let w=0;w<x.length;w++)S[r+w]=x[w];for(let w=0;w<v.length;w++)S[b+w]=v[w];return S.join("").slice(0,b+l)+i}function Fa(e){const t=e.split(".");if(t.length<2)return{error:"Bukan format JWT valid"};try{const a=JSON.parse(atob(t[0].replace(/-/g,"+").replace(/_/g,"/"))),n=JSON.parse(atob(t[1].replace(/-/g,"+").replace(/_/g,"/")));return{header:a,payload:n,signatureB64:t[2]||"",raw:{headerB64:t[0],payloadB64:t[1]}}}catch(a){return{error:a instanceof Error?a.message:String(a)}}}async function st(e){const t=e.replace(/-----[^-]+-----/g,"").replace(/\s/g,"");return de(t).buffer}async function Ht(e,t,a=qt){const n=btoa(JSON.stringify({trans_no:e,alg:"RS256"})).replace(/\+/g,"-").replace(/\//g,"_").replace(/=/g,""),s=btoa(JSON.stringify({trans_time:t})).replace(/\+/g,"-").replace(/\//g,"_").replace(/=/g,""),i=`${n}.${s}`,d=await st(a),o=await crypto.subtle.importKey("pkcs8",d,{name:"RSASSA-PKCS1-v1_5",hash:"SHA-256"},!1,["sign"]),u=await crypto.subtle.sign("RSASSA-PKCS1-v1_5",o,Y(i)),r=le(u).replace(/\+/g,"-").replace(/\//g,"_").replace(/=/g,"");return`${i}.${r}`}async function nt(e,t,a){const n=de(a),s=n.length>=8?n:new Uint8Array(8),i=Y(`${e}:${t}`),d=await crypto.subtle.importKey("raw",s,{name:"HMAC",hash:"SHA-512"},!1,["sign"]),o=await crypto.subtle.sign("HMAC",d,i);return le(o)}function Ga(e){return Be(de(e))}async function jt(e){const t=`%${e.fromAcc}#${e.amount}@${e.dateTime}^${e.refNo}*${e.destBank}~${e.destAcc}|${We}%`;return Be(await crypto.subtle.digest("SHA-256",Y(t)))}async function zt(e){const t=`@${e.fromAcc}|${e.amount}~${e.dateTime}*${e.refNo}^${e.destBank}#${e.destAcc}(${e.destName})${We}@`;return Be(await crypto.subtle.digest("SHA-256",Y(t)))}async function Ya(e){const t=`{${e.nominal}*${e.norekFrom}^${e.norekTo}%${e.nameFrom}#${e.nameTo}@${We}}`;return Be(await crypto.subtle.digest("SHA-256",Y(t)))}async function Kt(e){const t=Be(await crypto.subtle.digest("SHA-256",Y(`Seminyak|${e}`))),a=await st(qt),n=await crypto.subtle.importKey("pkcs8",a,{name:"RSASSA-PKCS1-v1_5",hash:"SHA-256"},!1,["sign"]),s=await crypto.subtle.sign("RSASSA-PKCS1-v1_5",n,Y(t));return{signature:le(s),timestamp:e,clientStamp:t}}async function Ut(e,t){const a=`${e}|${t}`,n=await st(za),s=await crypto.subtle.importKey("pkcs8",n,{name:"RSASSA-PKCS1-v1_5",hash:"SHA-256"},!1,["sign"]),i=await crypto.subtle.sign("RSASSA-PKCS1-v1_5",s,Y(a));return{signature:le(i),clientKey:e,timestamp:t,message:a}}function J(){const e=new Date;return new Date(e.getTime()+7*36e5).toISOString().replace("T"," ").slice(0,19)}function qe(){const e=new Date;return new Date(e.getTime()+7*36e5).toISOString().slice(0,19)+"+07:00"}function U(e="SMY"){const t=new Date(new Date().getTime()+252e5),a=t.toISOString().slice(11,19).replace(/:/g,"").slice(0,6),n=String(Math.floor(Math.random()*9e3)+1e3),s=t.toISOString().slice(0,10).replace(/-/g,"");return`${e}${a}${n}O1012${s.slice(4)}`}async function Ja(e){const t=e.timestamp||J(),a=e.refNo||U(),n=await I(e.fromAcc,e.aesKey,e.aesIv),s=await I(String(e.amount),e.aesKey,e.aesIv),i=await I(e.dateTime,e.aesKey,e.aesIv),d=await I(e.destName||"",e.aesKey,e.aesIv);let o,u,r;e.step==="posting"?(o=await zt({...e,refNo:a}),u=await I(`${e.destBank}-${e.destAcc}`,e.aesKey,e.aesIv),r=await I(o,e.aesKey,e.aesIv)):(o=await jt({...e,refNo:a}),u=await I(`${e.destBank}-${e.destAcc}-${o}`,e.aesKey,e.aesIv),r=null);const b=await Ht(a,qe()),y=await nt(b,t,e.aesCs),p=y,m={from_acc:n,to_acc:u,amount:s,date_time:i,to_name:d,hash_code:r||"",remark:e.remark||""};return{headers:{"Content-Type":"application/json",Authorization:b,"X-TIMESTAMP":t,"X-SIGNATURE":y,"X-PARTNER-ID":p,"X-CLIENT-ID":e.didEncoded||"","X-REFERENCE":a,"X-Forwarded-For":"34.50.74.78","X-Real-IP":"34.50.74.78"},body:m,url:`${e.baseUrl||"https://lpdseminyak.biz.id:8000"}/api/smart/transfer/bank/post`,refNo:a,ts:t,debug:{hashRaw:o,step:e.step||"check"}}}async function Va(e,t,a){const n={};for(const[s,i]of Object.entries(e))i&&typeof i=="string"&&(n[s]=await Mt(i,t,a));return n}async function Wa(e){const t=e.op;try{let a;if(t==="keygen")a=await Ua(e.clientID,e.timestamp);else if(t==="encrypt")a={encrypted:await I(e.plaintext,e.aesKey,e.aesIv),plaintext:e.plaintext};else if(t==="decrypt")a={decrypted:await Mt(e.ciphertext,e.aesKey,e.aesIv),ciphertext:e.ciphertext};else if(t==="did-decode")a=Xa(e.did);else if(t==="did-encode")a={encoded:$a(e.clientID,e.timestamp,e.appName||"Seminyak"),clientID:e.clientID,timestamp:e.timestamp};else if(t==="jwt-decode")a=Fa(e.jwt);else if(t==="hashcode"){const n=e.step||"check";let s;n==="posting"?s=await zt(e):n==="lpd"?s=await Ya(e):s=await jt(e);const i=We;a={hash:s,step:n,formula:n==="posting"?`SHA256("@"+fromAcc+"|"+amount+"~"+dateTime+"*"+refNo+"^"+destBank+"#"+destAcc+"("+destName+")${i}@")`:`SHA256("%"+fromAcc+"#"+amount+"@"+dateTime+"^"+refNo+"*"+destBank+"~"+destAcc+"|${i}%")`}}else if(t==="reference"){const n=[];for(let s=0;s<(parseInt(e.count)||3);s++)n.push(U(e.prefix||"SMY"));a={references:n}}else if(t==="signature")a={signature:await nt(e.token,e.timestamp,e.aesCs)};else if(t==="sig-decode"){const n=Ga(e.signature);a={hex:n,length:n.length}}else if(t==="ios-token-sig")a=await Kt(e.timestamp||J());else if(t==="snap-token-sig")a=await Ut(e.clientKey||"LPD-SEMINYAK-001",e.timestamp||qe());else if(t==="build-transfer")a=await Ja({...e,timestamp:e.timestamp||J(),refNo:e.refNo||U()});else if(t==="decrypt-body"){const n=JSON.parse(e.body||"{}");a={decrypted:await Va(n,e.aesKey,e.aesIv)}}else if(t==="timestamp")a={jakarta:J(),jakartaISO:qe(),utc:new Date().toISOString()};else return{ok:!1,error:`Unknown operation: ${t}`};return{ok:!0,op:t,result:a}}catch(a){return{ok:!1,op:t,error:a instanceof Error?a.message:String(a)}}}const z=new Lt;z.use("/static/*",Oa({root:"./public"}));z.get("/favicon.ico",e=>e.body(null,204));z.post("/api/exec",async e=>{try{const t=await e.req.json(),n=await(await fetch("http://127.0.0.1:3001/exec",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(t)})).json();return e.json(n)}catch(t){const a=t instanceof Error?t.message:String(t);return e.json({stdout:"",stderr:"Terminal server tidak tersedia: "+a,cwd:"/home/user",exitCode:1},500)}});z.get("/api/exec/health",async e=>{try{const a=await(await fetch("http://127.0.0.1:3001/health")).json();return e.json({ok:!0,...a})}catch{return e.json({ok:!1,error:"Terminal server tidak tersedia di production. Gunakan sandbox URL untuk operasi crypto.",sandbox_only:!0})}});z.post("/api/crypto",async e=>{try{const t=await e.req.json(),a=await Wa(t);return e.json(a)}catch(t){const a=t instanceof Error?t.message:String(t);return e.json({ok:!1,error:"Crypto error: "+a})}});const pt="34.50.74.78";async function j(e,t,a){if(!t)throw new Error("X-CLIENT-ID (clientIdEnc) wajib diisi — jalankan Derive AES Keys terlebih dahulu");const n=J(),s=qe(),i=a||U(),d=await Ht(i,s),o=await nt(d,n,e||""),u=U();return{jwt:d,ts:n,tsISO:s,sig:o,xref:u,headers:{"Content-Type":"application/json",Authorization:d,"X-TIMESTAMP":n,"X-SIGNATURE":o,"X-PARTNER-ID":o,"X-CLIENT-ID":t,"X-REFERENCE":u,"X-Forwarded-For":pt,"X-Real-IP":pt}}}z.post("/api/smart",async e=>{try{const t=await e.req.json(),{action:a,baseUrl:n,aesKey:s,aesIv:i,aesCs:d,clientIdEnc:o,transNo:u,...r}=t,b=(n||"https://lpdseminyak.biz.id:8000").replace(/\/+$/,""),y=l=>Ka(l),p=l=>/^[0-9a-f]{32}$/i.test(l);if(a==="login"){if(!r.user_name||!r.user_pass)throw new Error("user_name dan user_pass wajib diisi");if(!o)throw new Error("clientIdEnc (X-CLIENT-ID) wajib diisi");const l=p(r.user_name)?r.user_name:y(r.user_name),f=p(r.user_pass)?r.user_pass:y(r.user_pass),{headers:x,ts:v,xref:c,jwt:k,sig:h}=await j(d,o,u),T=b+"/api/smart/access/login",S=JSON.stringify({user_name:l,user_pass:f});let w=0,D={};try{const N=await fetch(T,{method:"POST",headers:x,body:S});w=N.status;const C=await N.text();try{D=JSON.parse(C)}catch{D={_raw:C}}}catch(N){return e.json({ok:!1,action:a,error:N.message,url:T,headers:x})}return e.json({ok:w>=200&&w<300,action:a,httpStatus:w,url:T,result:D,debug:{ts:v,xref:c,user_name_sent:l,user_pass_sent:f,jwt_preview:k.substring(0,40)+"...",sig_preview:h.substring(0,20)+"..."},requestHeaders:x,requestBody:{user_name:l,user_pass:f}})}if(a==="cek-saldo"){if(!r.no_rek)throw new Error("no_rek wajib diisi");if(!o)throw new Error("clientIdEnc wajib diisi");if(!s||!i)throw new Error("aesKey dan aesIv wajib diisi");const l=await I(r.no_rek,s,i),{headers:f,ts:x,xref:v}=await j(d,o,u),c=b+"/api/smart/account/balance",k=JSON.stringify({no_rek:l});let h=0,T={};try{const S=await fetch(c,{method:"POST",headers:f,body:k});h=S.status;const w=await S.text();try{T=JSON.parse(w)}catch{T={_raw:w}}}catch(S){return e.json({ok:!1,action:a,error:S.message})}return e.json({ok:h>=200&&h<300,action:a,httpStatus:h,url:c,result:T,debug:{ts:x,xref:v,no_rek_enc:l},requestHeaders:f})}if(a==="inquiry"){if(!r.no_rek_from||!r.no_rek_to||!r.nominal)throw new Error("no_rek_from, no_rek_to, nominal wajib diisi");if(!o)throw new Error("clientIdEnc wajib diisi");const l=u||U(),{headers:f,ts:x,xref:v}=await j(d,o,l),[c,k,h,T]=await Promise.all([I(r.no_rek_from,s,i),I(r.no_rek_to,s,i),I(r.nominal,s,i),r.bank_dest?I(r.bank_dest,s,i):Promise.resolve("")]),S=b+"/api/smart/transfer/inquiry",w=JSON.stringify({no_rek_from:c,no_rek_to:k,nominal:h,bank_dest:T,ref_no:l});let D=0,N={};try{const C=await fetch(S,{method:"POST",headers:f,body:w});D=C.status;const R=await C.text();try{N=JSON.parse(R)}catch{N={_raw:R}}}catch(C){return e.json({ok:!1,action:a,error:C.message})}return e.json({ok:D>=200&&D<300,action:a,httpStatus:D,url:S,result:N,debug:{ts:x,xref:v,ref:l},requestHeaders:f})}if(a==="posting"){if(!r.no_rek_from||!r.no_rek_to||!r.nominal)throw new Error("no_rek_from, no_rek_to, nominal wajib diisi");if(!o)throw new Error("clientIdEnc wajib diisi");const l=u||U(),{headers:f,ts:x,xref:v}=await j(d,o,l),[c,k,h,T,S,w]=await Promise.all([I(r.no_rek_from,s,i),I(r.no_rek_to,s,i),I(r.nominal,s,i),r.bank_dest?I(r.bank_dest,s,i):Promise.resolve(""),r.nama_dest?I(r.nama_dest,s,i):Promise.resolve(""),r.keterangan?I(r.keterangan,s,i):Promise.resolve("")]),D=b+"/api/smart/transfer/posting",N=JSON.stringify({no_rek_from:c,no_rek_to:k,nominal:h,bank_dest:T,nama_dest:S,keterangan:w,ref_no:l});let C=0,R={};try{const K=await fetch(D,{method:"POST",headers:f,body:N});C=K.status;const ve=await K.text();try{R=JSON.parse(ve)}catch{R={_raw:ve}}}catch(K){return e.json({ok:!1,action:a,error:K.message})}return e.json({ok:C>=200&&C<300,action:a,httpStatus:C,url:D,result:R,debug:{ts:x,xref:v,ref:l},requestHeaders:f})}const m=async(l,f,x)=>{const v=await fetch(l,{method:"POST",headers:f,body:x}),c=await v.text();let k;try{k=JSON.parse(c)}catch{k={_raw:c}}return{httpStatus:v.status,parsed:k}};if(a==="logout"){if(!o)throw new Error("clientIdEnc wajib diisi");const{headers:l,ts:f,xref:x}=await j(d,o),v=b+"/api/smart/access/logout";try{const{httpStatus:c,parsed:k}=await m(v,l,"{}");return e.json({ok:c<400,action:a,httpStatus:c,url:v,result:k,debug:{ts:f,xref:x}})}catch(c){return e.json({ok:!1,action:a,error:c.message})}}if(a==="account-list"){if(!o)throw new Error("clientIdEnc wajib diisi");if(!s||!i)throw new Error("aesKey dan aesIv wajib diisi");const l=await I(r.customer_id||"",s,i),{headers:f,ts:x,xref:v}=await j(d,o),c=b+"/api/smart/tabungan/account-list",k=JSON.stringify({customer_id:l});try{const{httpStatus:h,parsed:T}=await m(c,f,k);return e.json({ok:h<400,action:a,httpStatus:h,url:c,result:T,debug:{ts:x,xref:v,customer_id_enc:l}})}catch(h){return e.json({ok:!1,action:a,error:h.message})}}if(a==="mutasi-history"){if(!o)throw new Error("clientIdEnc wajib diisi");if(!s||!i)throw new Error("aesKey dan aesIv wajib diisi");const l=await I(r.customer_id||"",s,i),{headers:f,ts:x,xref:v}=await j(d,o),c=b+"/api/smart/tabungan/mutasi-history",k=JSON.stringify({customer_id:l});try{const{httpStatus:h,parsed:T}=await m(c,f,k);return e.json({ok:h<400,action:a,httpStatus:h,url:c,result:T,debug:{ts:x,xref:v,customer_id_enc:l}})}catch(h){return e.json({ok:!1,action:a,error:h.message})}}if(a==="transaction-history"){if(!o)throw new Error("clientIdEnc wajib diisi");if(!s||!i)throw new Error("aesKey dan aesIv wajib diisi");const l=await I(r.no_rek||"",s,i),f=await I(r.tgl_awal||"",s,i),x=await I(r.tgl_akhir||"",s,i),{headers:v,ts:c,xref:k}=await j(d,o),h=b+"/api/smart/tabungan/transaction-history",T=JSON.stringify({no_rek:l,tgl_awal:f,tgl_akhir:x});try{const{httpStatus:S,parsed:w}=await m(h,v,T);return e.json({ok:S<400,action:a,httpStatus:S,url:h,result:w,debug:{ts:c,xref:k}})}catch(S){return e.json({ok:!1,action:a,error:S.message})}}if(a==="transfer-lpd-check"){if(!r.no_rek_tujuan)throw new Error("no_rek_tujuan wajib diisi");if(!o)throw new Error("clientIdEnc wajib diisi");if(!s||!i)throw new Error("aesKey dan aesIv wajib diisi");const l=U(),f=await I(r.no_rek_tujuan,s,i),{headers:x,ts:v,xref:c}=await j(d,o,l),k=b+"/api/smart/transfer/lpd/check",h=JSON.stringify({account_no:f});try{const{httpStatus:T,parsed:S}=await m(k,x,h);return e.json({ok:T<400,action:a,httpStatus:T,url:k,result:S,debug:{ts:v,xref:c,ref:l,account_no_enc:f}})}catch(T){return e.json({ok:!1,action:a,error:T.message})}}if(a==="transfer-lpd-inquiry"){if(!r.no_rek_from||!r.no_rek_to||!r.nominal)throw new Error("no_rek_from, no_rek_to, nominal wajib diisi");if(!o)throw new Error("clientIdEnc wajib diisi");if(!s||!i)throw new Error("aesKey dan aesIv wajib diisi");const l=u||U(),{headers:f,ts:x,xref:v}=await j(d,o,l),[c,k,h,T,S,w]=await Promise.all([I(r.no_rek_from,s,i),I(r.no_rek_to,s,i),I(r.nama_tujuan||"",s,i),I(r.nominal,s,i),I(r.date_time||J(),s,i),I(r.keterangan||"",s,i)]),D=b+"/api/smart/transfer/lpd/inquiry",N=JSON.stringify({to_acc:k,to_name:h,from_acc:c,from_name:c,amount:T,remark:w});try{const{httpStatus:C,parsed:R}=await m(D,f,N);return e.json({ok:C<400,action:a,httpStatus:C,url:D,result:R,debug:{ts:x,xref:v,ref:l}})}catch(C){return e.json({ok:!1,action:a,error:C.message})}}if(a==="transfer-lpd-posting"){if(!r.no_rek_from||!r.no_rek_to||!r.nominal)throw new Error("no_rek_from, no_rek_to, nominal wajib diisi");if(!o)throw new Error("clientIdEnc wajib diisi");if(!s||!i)throw new Error("aesKey dan aesIv wajib diisi");const l=u||U(),{headers:f,ts:x,xref:v}=await j(d,o,l),[c,k,h,T,S,w]=await Promise.all([I(r.no_rek_from,s,i),I(r.no_rek_to,s,i),I(r.nama_tujuan||"",s,i),I(r.nominal,s,i),I(r.date_time||J(),s,i),I(r.keterangan||"",s,i)]),D=b+"/api/smart/transfer/lpd/post",N=JSON.stringify({to_acc:k,to_name:h,from_acc:c,from_name:c,amount:T,remark:w});try{const{httpStatus:C,parsed:R}=await m(D,f,N);return e.json({ok:C<400,action:a,httpStatus:C,url:D,result:R,debug:{ts:x,xref:v,ref:l}})}catch(C){return e.json({ok:!1,action:a,error:C.message})}}if(a==="transfer-bank-check"){if(!r.no_rek_tujuan||!r.kode_bank)throw new Error("no_rek_tujuan dan kode_bank wajib diisi");if(!o)throw new Error("clientIdEnc wajib diisi");if(!s||!i)throw new Error("aesKey dan aesIv wajib diisi");const l=U(),[f,x]=await Promise.all([I(r.no_rek_tujuan,s,i),I(r.kode_bank,s,i)]),{headers:v,ts:c,xref:k}=await j(d,o,l),h=b+"/api/smart/transfer/bank/check",T=JSON.stringify({account_no:f,bank_code:x});try{const{httpStatus:S,parsed:w}=await m(h,v,T);return e.json({ok:S<400,action:a,httpStatus:S,url:h,result:w,debug:{ts:c,xref:k,ref:l}})}catch(S){return e.json({ok:!1,action:a,error:S.message})}}if(a==="transfer-bank-inquiry"){if(!r.no_rek_from||!r.no_rek_to||!r.nominal||!r.kode_bank)throw new Error("no_rek_from, no_rek_to, nominal, kode_bank wajib diisi");if(!o)throw new Error("clientIdEnc wajib diisi");if(!s||!i)throw new Error("aesKey dan aesIv wajib diisi");const l=u||U(),{headers:f,ts:x,xref:v}=await j(d,o,l),[c,k,h,T,S,w]=await Promise.all([I(r.no_rek_from,s,i),I(r.no_rek_to,s,i),I(r.kode_bank,s,i),I(r.nominal,s,i),I(r.date_time||J(),s,i),I(r.hash_code||"",s,i)]),D=b+"/api/smart/transfer/bank/inquiry",N=JSON.stringify({from_acc:c,to_acc:k,bank_code:h,amount:T,date_time:S,hash_code:w,remark:""});try{const{httpStatus:C,parsed:R}=await m(D,f,N);return e.json({ok:C<400,action:a,httpStatus:C,url:D,result:R,debug:{ts:x,xref:v,ref:l}})}catch(C){return e.json({ok:!1,action:a,error:C.message})}}if(a==="transfer-bank-posting"){if(!r.no_rek_from||!r.no_rek_to||!r.nominal||!r.kode_bank)throw new Error("no_rek_from, no_rek_to, nominal, kode_bank wajib diisi");if(!o)throw new Error("clientIdEnc wajib diisi");if(!s||!i)throw new Error("aesKey dan aesIv wajib diisi");const l=u||U(),{headers:f,ts:x,xref:v}=await j(d,o,l),[c,k,h,T,S,w,D]=await Promise.all([I(r.no_rek_from,s,i),I(r.no_rek_to,s,i),I(r.kode_bank,s,i),I(r.nominal,s,i),I(r.date_time||J(),s,i),I(r.hash_code||"",s,i),I(r.keterangan||"",s,i)]),N=b+"/api/smart/transfer/bank/post",C=JSON.stringify({from_acc:c,to_acc:k,bank_code:h,amount:T,date_time:S,hash_code:w,remark:D});try{const{httpStatus:R,parsed:K}=await m(N,f,C);return e.json({ok:R<400,action:a,httpStatus:R,url:N,result:K,debug:{ts:x,xref:v,ref:l}})}catch(R){return e.json({ok:!1,action:a,error:R.message})}}return e.json({ok:!1,error:"Unknown action: "+a})}catch(t){const a=t instanceof Error?t.message:String(t);return e.json({ok:!1,error:"Smart error: "+a})}});z.post("/api/token/generate",async e=>{try{const t=await e.req.json(),{type:a,baseUrl:n,clientIdEnc:s,clientKey:i}=t;let d;if(a==="ios"){const o=J(),u=await Kt(o),r=(n||"https://lpdseminyak.biz.id:8000")+"/api/smart/access/token",b={"Content-Type":"application/json","X-TIMESTAMP":o,"X-CLIENT-ID":s||"","X-SIGNATURE":u.signature,"X-Forwarded-For":"34.50.74.78","X-Real-IP":"34.50.74.78"};try{const y=await fetch(r,{method:"POST",headers:b,body:"{}"}),p=await y.text();let m;try{m=JSON.parse(p)}catch{m={_raw:p}}d={ok:y.status<400,httpStatus:y.status,result:m,debug:u}}catch(y){d={ok:!1,error:y.message}}}else if(a==="snap"){const o=qe();d={ok:!0,result:await Ut(i||"LPD-SEMINYAK-001",o)}}else d={ok:!1,error:"type must be snap or ios"};return e.json(d)}catch(t){const a=t instanceof Error?t.message:String(t);return e.json({ok:!1,error:"Token error: "+a})}});const V="/home/user/webapp/lpd_seminyak/storage/logs";z.post("/api/admin",async e=>{try{const t=await e.req.json(),a=t.op;if(a==="list-logs"){const d=((await(await fetch("http://127.0.0.1:3001/exec",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({command:`find ${V} -maxdepth 2 \\( -name "*.txt" -o -name "*.log" \\) | sort -r | head -200`})})).json()).stdout||"").trim().split(`
`).filter(Boolean).map(x=>{const v=x.split("/").pop()||"",c=x.replace(V+"/","").replace("/"+v,"");return{name:v,dir:c===v?"root":c,path:x}}),u=await(await fetch("http://127.0.0.1:3001/exec",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({command:`grep -c "local.ERROR" ${V}/laravel.log 2>/dev/null || echo 0`})})).json(),r=parseInt((u.stdout||"0").trim())||0,y=await(await fetch("http://127.0.0.1:3001/exec",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({command:`grep -h "POST http" ${V}/access-*.txt ${V}/transfer-*.txt ${V}/tabungan-*.txt 2>/dev/null | grep -oP '/api/[a-z/._-]+' | sort | uniq -c | sort -rn | head -20`})})).json(),p={};(y.stdout||"").trim().split(`
`).forEach(x=>{const v=x.trim().match(/^(\d+)\s+(.+)$/);v&&(p[v[2]]=parseInt(v[1]))});const l=await(await fetch("http://127.0.0.1:3001/exec",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({command:`grep -h "REQUEST" ${V}/access-*.txt 2>/dev/null | grep -oP '\\d{4}-\\d{2}-\\d{2}' | sort | uniq -c | tail -30`})})).json(),f={};return(l.stdout||"").trim().split(`
`).forEach(x=>{const v=x.trim().match(/^(\d+)\s+(\d{4}-\d{2}-\d{2})$/);v&&(f[v[2]]=parseInt(v[1]))}),e.json({ok:!0,files:d,error_count:r,endpoints:p,daily:f})}if(a==="read-log"){const n=(t.path||"").replace(/\.\./g,"").replace(/[^a-zA-Z0-9._\-]/g,""),s=(t.dir||"root").replace(/\.\./g,"").replace(/[^a-zA-Z0-9._\-]/g,"");let i="";s==="root"?i=`${V}/${n}`:i=`${V}/${s}/${n}`;const o=await(await fetch("http://127.0.0.1:3001/exec",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({command:`cat "${i}" 2>/dev/null | head -c 500000`})})).json();return!o.stdout||o.stdout.trim()===""?e.json({ok:!1,error:`File tidak ditemukan atau kosong: ${n}`}):e.json({ok:!0,content:o.stdout,path:i})}return e.json({ok:!1,error:"Unknown operation: "+a})}catch(t){const a=t instanceof Error?t.message:String(t);return a.includes("fetch")||a.includes("ECONNREFUSED")||a.includes("refused")?e.json({ok:!1,error:"Admin panel memerlukan sandbox environment. Di production, fitur baca log tidak tersedia karena tidak ada akses filesystem."}):e.json({ok:!1,error:"Admin error: "+a})}});z.get("/",e=>e.redirect("/admin"));z.get("/swagger",e=>e.html(qa()));z.get("/admin",e=>e.html(ja()));z.get("/crypto",e=>e.html(Ha()));z.get("/docs",e=>{const t=Qa();return e.html(t)});function Qa(){const e={installPhp:["# Ubuntu/Debian:","sudo apt-get install -y software-properties-common","sudo add-apt-repository ppa:ondrej/php","sudo apt-get update","sudo apt-get install -y php7.4 php7.4-cli php7.4-mbstring php7.4-xml \\","  php7.4-curl php7.4-zip php7.4-json php7.4-pdo php7.4-intl","","# Verifikasi:","php7.4 --version"].join(`
...
</html>`}const ut=new Lt,Za=Object.assign({"/src/index.tsx":z});let Xt=!1;for(const[,e]of Object.entries(Za))e&&(ut.all("*",t=>{let a;try{a=t.executionCtx}catch{}return e.fetch(t.req.raw,t.env,a)}),ut.notFound(t=>{let a;try{a=t.executionCtx}catch{}return e.fetch(t.req.raw,t.env,a)}),Xt=!0);if(!Xt)throw new Error("Can't import modules from ['/src/index.ts','/src/index.tsx','/app/server.ts']");export{ut as default};
