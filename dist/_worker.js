var Yt=Object.defineProperty;var ct=e=>{throw TypeError(e)};var Jt=(e,t,s)=>t in e?Yt(e,t,{enumerable:!0,configurable:!0,writable:!0,value:s}):e[t]=s;var A=(e,t,s)=>Jt(e,typeof t!="symbol"?t+"":t,s),tt=(e,t,s)=>t.has(e)||ct("Cannot "+s);var m=(e,t,s)=>(tt(e,t,"read from private field"),s?s.call(e):t.get(e)),C=(e,t,s)=>t.has(e)?ct("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,s),E=(e,t,s,a)=>(tt(e,t,"write to private field"),a?a.call(e,s):t.set(e,s),s),R=(e,t,s)=>(tt(e,t,"access private method"),s);var pt=(e,t,s,a)=>({set _(i){E(e,t,i,s)},get _(){return m(e,t,a)}});var ut=(e,t,s)=>(a,i)=>{let n=-1;return r(0);async function r(o){if(o<=n)throw new Error("next() called multiple times");n=o;let d,u=!1,b;if(e[o]?(b=e[o][0][0],a.req.routeIndex=o):b=o===e.length&&i||void 0,b)try{d=await b(a,()=>r(o+1))}catch(l){if(l instanceof Error&&t)a.error=l,d=await t(l,a),u=!0;else throw l}else a.finalized===!1&&s&&(d=await s(a));return d&&(a.finalized===!1||u)&&(a.res=d),a}},Vt=Symbol(),Wt=async(e,t=Object.create(null))=>{const{all:s=!1,dot:a=!1}=t,n=(e instanceof Ct?e.raw.headers:e.headers).get("Content-Type");return n!=null&&n.startsWith("multipart/form-data")||n!=null&&n.startsWith("application/x-www-form-urlencoded")?Qt(e,{all:s,dot:a}):{}};async function Qt(e,t){const s=await e.formData();return s?Zt(s,t):{}}function Zt(e,t){const s=Object.create(null);return e.forEach((a,i)=>{t.all||i.endsWith("[]")?ea(s,i,a):s[i]=a}),t.dot&&Object.entries(s).forEach(([a,i])=>{a.includes(".")&&(ta(s,a,i),delete s[a])}),s}var ea=(e,t,s)=>{e[t]!==void 0?Array.isArray(e[t])?e[t].push(s):e[t]=[e[t],s]:t.endsWith("[]")?e[t]=[s]:e[t]=s},ta=(e,t,s)=>{if(/(?:^|\.)__proto__\./.test(t))return;let a=e;const i=t.split(".");i.forEach((n,r)=>{r===i.length-1?a[n]=s:((!a[n]||typeof a[n]!="object"||Array.isArray(a[n])||a[n]instanceof File)&&(a[n]=Object.create(null)),a=a[n])})},St=e=>{const t=e.split("/");return t[0]===""&&t.shift(),t},aa=e=>{const{groups:t,path:s}=sa(e),a=St(s);return na(a,t)},sa=e=>{const t=[];return e=e.replace(/\{[^}]+\}/g,(s,a)=>{const i=`@${a}`;return t.push([i,s]),i}),{groups:t,path:e}},na=(e,t)=>{for(let s=t.length-1;s>=0;s--){const[a]=t[s];for(let i=e.length-1;i>=0;i--)if(e[i].includes(a)){e[i]=e[i].replace(a,t[s][1]);break}}return e},Fe={},ia=(e,t)=>{if(e==="*")return"*";const s=e.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);if(s){const a=`${e}#${t}`;return Fe[a]||(s[2]?Fe[a]=t&&t[0]!==":"&&t[0]!=="*"?[a,s[1],new RegExp(`^${s[2]}(?=/${t})`)]:[e,s[1],new RegExp(`^${s[2]}$`)]:Fe[a]=[e,s[1],!0]),Fe[a]}return null},rt=(e,t)=>{try{return t(e)}catch{return e.replace(/(?:%[0-9A-Fa-f]{2})+/g,s=>{try{return t(s)}catch{return s}})}},Tt=e=>rt(e,decodeURI),It=e=>{const t=e.url,s=t.indexOf("/",t.indexOf(":")+4);let a=s;for(;a<t.length;a++){const i=t.charCodeAt(a);if(i===37){const n=t.indexOf("?",a),r=t.indexOf("#",a),o=n===-1?r===-1?void 0:r:r===-1?n:Math.min(n,r),d=t.slice(s,o);return Tt(d.includes("%25")?d.replace(/%25/g,"%2525"):d)}else if(i===63||i===35)break}return t.slice(s,a)},ra=e=>{const t=It(e);return t.length>1&&t.at(-1)==="/"?t.slice(0,-1):t},Se=(e,t,...s)=>(s.length&&(t=Se(t,...s)),`${(e==null?void 0:e[0])==="/"?"":"/"}${e}${t==="/"?"":`${(e==null?void 0:e.at(-1))==="/"?"":"/"}${(t==null?void 0:t[0])==="/"?t.slice(1):t}`}`),Et=e=>{if(e.charCodeAt(e.length-1)!==63||!e.includes(":"))return null;const t=e.split("/"),s=[];let a="";return t.forEach(i=>{if(i!==""&&!/\:/.test(i))a+="/"+i;else if(/\:/.test(i))if(/\?/.test(i)){s.length===0&&a===""?s.push("/"):s.push(a);const n=i.replace("?","");a+="/"+n,s.push(a)}else a+="/"+i}),s.filter((i,n,r)=>r.indexOf(i)===n)},at=e=>/[%+]/.test(e)?(e.indexOf("+")!==-1&&(e=e.replace(/\+/g," ")),e.indexOf("%")!==-1?rt(e,Pt):e):e,At=(e,t,s)=>{let a;if(!s&&t&&!/[%+]/.test(t)){let r=e.indexOf("?",8);if(r===-1)return;for(e.startsWith(t,r+1)||(r=e.indexOf(`&${t}`,r+1));r!==-1;){const o=e.charCodeAt(r+t.length+1);if(o===61){const d=r+t.length+2,u=e.indexOf("&",d);return at(e.slice(d,u===-1?void 0:u))}else if(o==38||isNaN(o))return"";r=e.indexOf(`&${t}`,r+1)}if(a=/[%+]/.test(e),!a)return}const i={};a??(a=/[%+]/.test(e));let n=e.indexOf("?",8);for(;n!==-1;){const r=e.indexOf("&",n+1);let o=e.indexOf("=",n);o>r&&r!==-1&&(o=-1);let d=e.slice(n+1,o===-1?r===-1?void 0:r:o);if(a&&(d=at(d)),n=r,d==="")continue;let u;o===-1?u="":(u=e.slice(o+1,r===-1?void 0:r),a&&(u=at(u))),s?(i[d]&&Array.isArray(i[d])||(i[d]=[]),i[d].push(u)):i[d]??(i[d]=u)}return t?i[t]:i},oa=At,da=(e,t)=>At(e,t,!0),Pt=decodeURIComponent,ft=e=>rt(e,Pt),Ae,Y,ne,_t,Bt,nt,re,ht,Ct=(ht=class{constructor(e,t="/",s=[[]]){C(this,ne);A(this,"raw");C(this,Ae);C(this,Y);A(this,"routeIndex",0);A(this,"path");A(this,"bodyCache",{});C(this,re,e=>{const{bodyCache:t,raw:s}=this,a=t[e];if(a)return a;const i=Object.keys(t)[0];return i?t[i].then(n=>(i==="json"&&(n=JSON.stringify(n)),new Response(n)[e]())):t[e]=s[e]()});this.raw=e,this.path=t,E(this,Y,s),E(this,Ae,{})}param(e){return e?R(this,ne,_t).call(this,e):R(this,ne,Bt).call(this)}query(e){return oa(this.url,e)}queries(e){return da(this.url,e)}header(e){if(e)return this.raw.headers.get(e)??void 0;const t={};return this.raw.headers.forEach((s,a)=>{t[a]=s}),t}async parseBody(e){return Wt(this,e)}json(){return m(this,re).call(this,"text").then(e=>JSON.parse(e))}text(){return m(this,re).call(this,"text")}arrayBuffer(){return m(this,re).call(this,"arrayBuffer")}blob(){return m(this,re).call(this,"blob")}formData(){return m(this,re).call(this,"formData")}addValidatedData(e,t){m(this,Ae)[e]=t}valid(e){return m(this,Ae)[e]}get url(){return this.raw.url}get method(){return this.raw.method}get[Vt](){return m(this,Y)}get matchedRoutes(){return m(this,Y)[0].map(([[,e]])=>e)}get routePath(){return m(this,Y)[0].map(([[,e]])=>e)[this.routeIndex].path}},Ae=new WeakMap,Y=new WeakMap,ne=new WeakSet,_t=function(e){const t=m(this,Y)[0][this.routeIndex][1][e],s=R(this,ne,nt).call(this,t);return s&&/\%/.test(s)?ft(s):s},Bt=function(){const e={},t=Object.keys(m(this,Y)[0][this.routeIndex][1]);for(const s of t){const a=R(this,ne,nt).call(this,m(this,Y)[0][this.routeIndex][1][s]);a!==void 0&&(e[s]=/\%/.test(a)?ft(a):a)}return e},nt=function(e){return m(this,Y)[1]?m(this,Y)[1][e]:e},re=new WeakMap,ht),la={Stringify:1},Rt=async(e,t,s,a,i)=>{typeof e=="object"&&!(e instanceof String)&&(e instanceof Promise||(e=e.toString()),e instanceof Promise&&(e=await e));const n=e.callbacks;return n!=null&&n.length?(i?i[0]+=e:i=[e],Promise.all(n.map(o=>o({phase:t,buffer:i,context:a}))).then(o=>Promise.all(o.filter(Boolean).map(d=>Rt(d,t,!1,a,i))).then(()=>i[0]))):Promise.resolve(e)},ca="text/plain; charset=UTF-8",st=(e,t)=>({"Content-Type":e,...t}),Oe=(e,t)=>new Response(e,t),je,ze,Z,Pe,ee,U,Ke,Ce,_e,ge,Ue,Xe,oe,Te,vt,pa=(vt=class{constructor(e,t){C(this,oe);C(this,je);C(this,ze);A(this,"env",{});C(this,Z);A(this,"finalized",!1);A(this,"error");C(this,Pe);C(this,ee);C(this,U);C(this,Ke);C(this,Ce);C(this,_e);C(this,ge);C(this,Ue);C(this,Xe);A(this,"render",(...e)=>(m(this,Ce)??E(this,Ce,t=>this.html(t)),m(this,Ce).call(this,...e)));A(this,"setLayout",e=>E(this,Ke,e));A(this,"getLayout",()=>m(this,Ke));A(this,"setRenderer",e=>{E(this,Ce,e)});A(this,"header",(e,t,s)=>{this.finalized&&E(this,U,Oe(m(this,U).body,m(this,U)));const a=m(this,U)?m(this,U).headers:m(this,ge)??E(this,ge,new Headers);t===void 0?a.delete(e):s!=null&&s.append?a.append(e,t):a.set(e,t)});A(this,"status",e=>{E(this,Pe,e)});A(this,"set",(e,t)=>{m(this,Z)??E(this,Z,new Map),m(this,Z).set(e,t)});A(this,"get",e=>m(this,Z)?m(this,Z).get(e):void 0);A(this,"newResponse",(...e)=>R(this,oe,Te).call(this,...e));A(this,"body",(e,t,s)=>R(this,oe,Te).call(this,e,t,s));A(this,"text",(e,t,s)=>!m(this,ge)&&!m(this,Pe)&&!t&&!s&&!this.finalized?new Response(e):R(this,oe,Te).call(this,e,t,st(ca,s)));A(this,"json",(e,t,s)=>R(this,oe,Te).call(this,JSON.stringify(e),t,st("application/json",s)));A(this,"html",(e,t,s)=>{const a=i=>R(this,oe,Te).call(this,i,t,st("text/html; charset=UTF-8",s));return typeof e=="object"?Rt(e,la.Stringify,!1,{}).then(a):a(e)});A(this,"redirect",(e,t)=>{const s=String(e);return this.header("Location",/[^\x00-\xFF]/.test(s)?encodeURI(s):s),this.newResponse(null,t??302)});A(this,"notFound",()=>(m(this,_e)??E(this,_e,()=>Oe()),m(this,_e).call(this,this)));E(this,je,e),t&&(E(this,ee,t.executionCtx),this.env=t.env,E(this,_e,t.notFoundHandler),E(this,Xe,t.path),E(this,Ue,t.matchResult))}get req(){return m(this,ze)??E(this,ze,new Ct(m(this,je),m(this,Xe),m(this,Ue))),m(this,ze)}get event(){if(m(this,ee)&&"respondWith"in m(this,ee))return m(this,ee);throw Error("This context has no FetchEvent")}get executionCtx(){if(m(this,ee))return m(this,ee);throw Error("This context has no ExecutionContext")}get res(){return m(this,U)||E(this,U,Oe(null,{headers:m(this,ge)??E(this,ge,new Headers)}))}set res(e){if(m(this,U)&&e){e=Oe(e.body,e);for(const[t,s]of m(this,U).headers.entries())if(t!=="content-type")if(t==="set-cookie"){const a=m(this,U).headers.getSetCookie();e.headers.delete("set-cookie");for(const i of a)e.headers.append("set-cookie",i)}else e.headers.set(t,s)}E(this,U,e),this.finalized=!0}get var(){return m(this,Z)?Object.fromEntries(m(this,Z)):{}}},je=new WeakMap,ze=new WeakMap,Z=new WeakMap,Pe=new WeakMap,ee=new WeakMap,U=new WeakMap,Ke=new WeakMap,Ce=new WeakMap,_e=new WeakMap,ge=new WeakMap,Ue=new WeakMap,Xe=new WeakMap,oe=new WeakSet,Te=function(e,t,s){const a=m(this,U)?new Headers(m(this,U).headers):m(this,ge)??new Headers;if(typeof t=="object"&&"headers"in t){const n=t.headers instanceof Headers?t.headers:new Headers(t.headers);for(const[r,o]of n)r.toLowerCase()==="set-cookie"?a.append(r,o):a.set(r,o)}if(s)for(const[n,r]of Object.entries(s))if(typeof r=="string")a.set(n,r);else{a.delete(n);for(const o of r)a.append(n,o)}const i=typeof t=="number"?t:(t==null?void 0:t.status)??m(this,Pe);return Oe(e,{status:i,headers:a})},vt),q="ALL",ua="all",fa=["get","post","put","delete","options","patch"],Dt="Can not add a route since the matcher is already built.",Nt=class extends Error{},ma="__COMPOSED_HANDLER",ga=e=>e.text("404 Not Found",404),mt=(e,t)=>{if("getResponse"in e){const s=e.getResponse();return t.newResponse(s.body,s)}return console.error(e),t.text("Internal Server Error",500)},J,H,Lt,V,fe,Ge,Ye,Be,ba=(Be=class{constructor(t={}){C(this,H);A(this,"get");A(this,"post");A(this,"put");A(this,"delete");A(this,"options");A(this,"patch");A(this,"all");A(this,"on");A(this,"use");A(this,"router");A(this,"getPath");A(this,"_basePath","/");C(this,J,"/");A(this,"routes",[]);C(this,V,ga);A(this,"errorHandler",mt);A(this,"onError",t=>(this.errorHandler=t,this));A(this,"notFound",t=>(E(this,V,t),this));A(this,"fetch",(t,...s)=>R(this,H,Ye).call(this,t,s[1],s[0],t.method));A(this,"request",(t,s,a,i)=>t instanceof Request?this.fetch(s?new Request(t,s):t,a,i):(t=t.toString(),this.fetch(new Request(/^https?:\/\//.test(t)?t:`http://localhost${Se("/",t)}`,s),a,i)));A(this,"fire",()=>{addEventListener("fetch",t=>{t.respondWith(R(this,H,Ye).call(this,t.request,t,void 0,t.request.method))})});[...fa,ua].forEach(n=>{this[n]=(r,...o)=>(typeof r=="string"?E(this,J,r):R(this,H,fe).call(this,n,m(this,J),r),o.forEach(d=>{R(this,H,fe).call(this,n,m(this,J),d)}),this)}),this.on=(n,r,...o)=>{for(const d of[r].flat()){E(this,J,d);for(const u of[n].flat())o.map(b=>{R(this,H,fe).call(this,u.toUpperCase(),m(this,J),b)})}return this},this.use=(n,...r)=>(typeof n=="string"?E(this,J,n):(E(this,J,"*"),r.unshift(n)),r.forEach(o=>{R(this,H,fe).call(this,q,m(this,J),o)}),this);const{strict:a,...i}=t;Object.assign(this,i),this.getPath=a??!0?t.getPath??It:ra}route(t,s){const a=this.basePath(t);return s.routes.map(i=>{var r;let n;s.errorHandler===mt?n=i.handler:(n=async(o,d)=>(await ut([],s.errorHandler)(o,()=>i.handler(o,d))).res,n[ma]=i.handler),R(r=a,H,fe).call(r,i.method,i.path,n)}),this}basePath(t){const s=R(this,H,Lt).call(this);return s._basePath=Se(this._basePath,t),s}mount(t,s,a){let i,n;a&&(typeof a=="function"?n=a:(n=a.optionHandler,a.replaceRequest===!1?i=d=>d:i=a.replaceRequest));const r=n?d=>{const u=n(d);return Array.isArray(u)?u:[u]}:d=>{let u;try{u=d.executionCtx}catch{}return[d.env,u]};i||(i=(()=>{const d=Se(this._basePath,t),u=d==="/"?0:d.length;return b=>{const l=new URL(b.url);return l.pathname=l.pathname.slice(u)||"/",new Request(l,b)}})());const o=async(d,u)=>{const b=await s(i(d.req.raw),...r(d));if(b)return b;await u()};return R(this,H,fe).call(this,q,Se(t,"*"),o),this}},J=new WeakMap,H=new WeakSet,Lt=function(){const t=new Be({router:this.router,getPath:this.getPath});return t.errorHandler=this.errorHandler,E(t,V,m(this,V)),t.routes=this.routes,t},V=new WeakMap,fe=function(t,s,a){t=t.toUpperCase(),s=Se(this._basePath,s);const i={basePath:this._basePath,path:s,method:t,handler:a};this.router.add(t,s,[a,i]),this.routes.push(i)},Ge=function(t,s){if(t instanceof Error)return this.errorHandler(t,s);throw t},Ye=function(t,s,a,i){if(i==="HEAD")return(async()=>new Response(null,await R(this,H,Ye).call(this,t,s,a,"GET")))();const n=this.getPath(t,{env:a}),r=this.router.match(i,n),o=new pa(t,{path:n,matchResult:r,env:a,executionCtx:s,notFoundHandler:m(this,V)});if(r[0].length===1){let u;try{u=r[0][0][0][0](o,async()=>{o.res=await m(this,V).call(this,o)})}catch(b){return R(this,H,Ge).call(this,b,o)}return u instanceof Promise?u.then(b=>b||(o.finalized?o.res:m(this,V).call(this,o))).catch(b=>R(this,H,Ge).call(this,b,o)):u??m(this,V).call(this,o)}const d=ut(r[0],this.errorHandler,m(this,V));return(async()=>{try{const u=await d(o);if(!u.finalized)throw new Error("Context is not finalized. Did you forget to return a Response object or `await next()`?");return u.res}catch(u){return R(this,H,Ge).call(this,u,o)}})()},Be),Ot=[];function ha(e,t){const s=this.buildAllMatchers(),a=((i,n)=>{const r=s[i]||s[q],o=r[2][n];if(o)return o;const d=n.match(r[0]);if(!d)return[[],Ot];const u=d.indexOf("",1);return[r[1][u],d]});return this.match=a,a(e,t)}var Ve="[^/]+",qe=".*",He="(?:|/.*)",Ie=Symbol(),va=new Set(".\\+*[^]$()");function ya(e,t){return e.length===1?t.length===1?e<t?-1:1:-1:t.length===1||e===qe||e===He?1:t===qe||t===He?-1:e===Ve?1:t===Ve?-1:e.length===t.length?e<t?-1:1:t.length-e.length}var be,he,W,xe,ka=(xe=class{constructor(){C(this,be);C(this,he);C(this,W,Object.create(null))}insert(t,s,a,i,n){if(t.length===0){if(m(this,be)!==void 0)throw Ie;if(n)return;E(this,be,s);return}const[r,...o]=t,d=r==="*"?o.length===0?["","",qe]:["","",Ve]:r==="/*"?["","",He]:r.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);let u;if(d){const b=d[1];let l=d[2]||Ve;if(b&&d[2]&&(l===".*"||(l=l.replace(/^\((?!\?:)(?=[^)]+\)$)/,"(?:"),/\((?!\?:)/.test(l))))throw Ie;if(u=m(this,W)[l],!u){if(Object.keys(m(this,W)).some(c=>c!==qe&&c!==He))throw Ie;if(n)return;u=m(this,W)[l]=new xe,b!==""&&E(u,he,i.varIndex++)}!n&&b!==""&&a.push([b,m(u,he)])}else if(u=m(this,W)[r],!u){if(Object.keys(m(this,W)).some(b=>b.length>1&&b!==qe&&b!==He))throw Ie;if(n)return;u=m(this,W)[r]=new xe}u.insert(o,s,a,i,n)}buildRegExpStr(){const s=Object.keys(m(this,W)).sort(ya).map(a=>{const i=m(this,W)[a];return(typeof m(i,he)=="number"?`(${a})@${m(i,he)}`:va.has(a)?`\\${a}`:a)+i.buildRegExpStr()});return typeof m(this,be)=="number"&&s.unshift(`#${m(this,be)}`),s.length===0?"":s.length===1?s[0]:"(?:"+s.join("|")+")"}},be=new WeakMap,he=new WeakMap,W=new WeakMap,xe),We,$e,yt,xa=(yt=class{constructor(){C(this,We,{varIndex:0});C(this,$e,new ka)}insert(e,t,s){const a=[],i=[];for(let r=0;;){let o=!1;if(e=e.replace(/\{[^}]+\}/g,d=>{const u=`@\\${r}`;return i[r]=[u,d],r++,o=!0,u}),!o)break}const n=e.match(/(?::[^\/]+)|(?:\/\*$)|./g)||[];for(let r=i.length-1;r>=0;r--){const[o]=i[r];for(let d=n.length-1;d>=0;d--)if(n[d].indexOf(o)!==-1){n[d]=n[d].replace(o,i[r][1]);break}}return m(this,$e).insert(n,t,a,m(this,We),s),a}buildRegExp(){let e=m(this,$e).buildRegExpStr();if(e==="")return[/^$/,[],[]];let t=0;const s=[],a=[];return e=e.replace(/#(\d+)|@(\d+)|\.\*\$/g,(i,n,r)=>n!==void 0?(s[++t]=Number(n),"$()"):(r!==void 0&&(a[Number(r)]=++t),"")),[new RegExp(`^${e}`),s,a]}},We=new WeakMap,$e=new WeakMap,yt),wa=[/^$/,[],Object.create(null)],Je=Object.create(null);function Mt(e){return Je[e]??(Je[e]=new RegExp(e==="*"?"":`^${e.replace(/\/\*$|([.\\+*[^\]$()])/g,(t,s)=>s?`\\${s}`:"(?:|/.*)")}$`))}function Sa(){Je=Object.create(null)}function Ta(e){var u;const t=new xa,s=[];if(e.length===0)return wa;const a=e.map(b=>[!/\*|\/:/.test(b[0]),...b]).sort(([b,l],[c,f])=>b?1:c?-1:l.length-f.length),i=Object.create(null);for(let b=0,l=-1,c=a.length;b<c;b++){const[f,g,h]=a[b];f?i[g]=[h.map(([y])=>[y,Object.create(null)]),Ot]:l++;let k;try{k=t.insert(g,l,f)}catch(y){throw y===Ie?new Nt(g):y}f||(s[l]=h.map(([y,p])=>{const w=Object.create(null);for(p-=1;p>=0;p--){const[v,T]=k[p];w[v]=T}return[y,w]}))}const[n,r,o]=t.buildRegExp();for(let b=0,l=s.length;b<l;b++)for(let c=0,f=s[b].length;c<f;c++){const g=(u=s[b][c])==null?void 0:u[1];if(!g)continue;const h=Object.keys(g);for(let k=0,y=h.length;k<y;k++)g[h[k]]=o[g[h[k]]]}const d=[];for(const b in r)d[b]=s[r[b]];return[n,d,i]}function we(e,t){if(e){for(const s of Object.keys(e).sort((a,i)=>i.length-a.length))if(Mt(s).test(t))return[...e[s]]}}var de,le,Qe,qt,kt,Ia=(kt=class{constructor(){C(this,Qe);A(this,"name","RegExpRouter");C(this,de);C(this,le);A(this,"match",ha);E(this,de,{[q]:Object.create(null)}),E(this,le,{[q]:Object.create(null)})}add(e,t,s){var o;const a=m(this,de),i=m(this,le);if(!a||!i)throw new Error(Dt);a[e]||[a,i].forEach(d=>{d[e]=Object.create(null),Object.keys(d[q]).forEach(u=>{d[e][u]=[...d[q][u]]})}),t==="/*"&&(t="*");const n=(t.match(/\/:/g)||[]).length;if(/\*$/.test(t)){const d=Mt(t);e===q?Object.keys(a).forEach(u=>{var b;(b=a[u])[t]||(b[t]=we(a[u],t)||we(a[q],t)||[])}):(o=a[e])[t]||(o[t]=we(a[e],t)||we(a[q],t)||[]),Object.keys(a).forEach(u=>{(e===q||e===u)&&Object.keys(a[u]).forEach(b=>{d.test(b)&&a[u][b].push([s,n])})}),Object.keys(i).forEach(u=>{(e===q||e===u)&&Object.keys(i[u]).forEach(b=>d.test(b)&&i[u][b].push([s,n]))});return}const r=Et(t)||[t];for(let d=0,u=r.length;d<u;d++){const b=r[d];Object.keys(i).forEach(l=>{var c;(e===q||e===l)&&((c=i[l])[b]||(c[b]=[...we(a[l],b)||we(a[q],b)||[]]),i[l][b].push([s,n-u+d+1]))})}}buildAllMatchers(){const e=Object.create(null);return Object.keys(m(this,le)).concat(Object.keys(m(this,de))).forEach(t=>{e[t]||(e[t]=R(this,Qe,qt).call(this,t))}),E(this,de,E(this,le,void 0)),Sa(),e}},de=new WeakMap,le=new WeakMap,Qe=new WeakSet,qt=function(e){const t=[];let s=e===q;return[m(this,de),m(this,le)].forEach(a=>{const i=a[e]?Object.keys(a[e]).map(n=>[n,a[e][n]]):[];i.length!==0?(s||(s=!0),t.push(...i)):e!==q&&t.push(...Object.keys(a[q]).map(n=>[n,a[q][n]]))}),s?Ta(t):null},kt),ce,te,xt,Ea=(xt=class{constructor(e){A(this,"name","SmartRouter");C(this,ce,[]);C(this,te,[]);E(this,ce,e.routers)}add(e,t,s){if(!m(this,te))throw new Error(Dt);m(this,te).push([e,t,s])}match(e,t){if(!m(this,te))throw new Error("Fatal error");const s=m(this,ce),a=m(this,te),i=s.length;let n=0,r;for(;n<i;n++){const o=s[n];try{for(let d=0,u=a.length;d<u;d++)o.add(...a[d]);r=o.match(e,t)}catch(d){if(d instanceof Nt)continue;throw d}this.match=o.match.bind(o),E(this,ce,[o]),E(this,te,void 0);break}if(n===i)throw new Error("Fatal error");return this.name=`SmartRouter + ${this.activeRouter.name}`,r}get activeRouter(){if(m(this,te)||m(this,ce).length!==1)throw new Error("No active router has been determined yet.");return m(this,ce)[0]}},ce=new WeakMap,te=new WeakMap,xt),Me=Object.create(null),Aa=e=>{for(const t in e)return!0;return!1},pe,z,ve,Re,j,ae,me,De,Pa=(De=class{constructor(t,s,a){C(this,ae);C(this,pe);C(this,z);C(this,ve);C(this,Re,0);C(this,j,Me);if(E(this,z,a||Object.create(null)),E(this,pe,[]),t&&s){const i=Object.create(null);i[t]={handler:s,possibleKeys:[],score:0},E(this,pe,[i])}E(this,ve,[])}insert(t,s,a){E(this,Re,++pt(this,Re)._);let i=this;const n=aa(s),r=[];for(let o=0,d=n.length;o<d;o++){const u=n[o],b=n[o+1],l=ia(u,b),c=Array.isArray(l)?l[0]:u;if(c in m(i,z)){i=m(i,z)[c],l&&r.push(l[1]);continue}m(i,z)[c]=new De,l&&(m(i,ve).push(l),r.push(l[1])),i=m(i,z)[c]}return m(i,pe).push({[t]:{handler:a,possibleKeys:r.filter((o,d,u)=>u.indexOf(o)===d),score:m(this,Re)}}),i}search(t,s){var b;const a=[];E(this,j,Me);let n=[this];const r=St(s),o=[],d=r.length;let u=null;for(let l=0;l<d;l++){const c=r[l],f=l===d-1,g=[];for(let k=0,y=n.length;k<y;k++){const p=n[k],w=m(p,z)[c];w&&(E(w,j,m(p,j)),f?(m(w,z)["*"]&&R(this,ae,me).call(this,a,m(w,z)["*"],t,m(p,j)),R(this,ae,me).call(this,a,w,t,m(p,j))):g.push(w));for(let v=0,T=m(p,ve).length;v<T;v++){const S=m(p,ve)[v],x=m(p,j)===Me?{}:{...m(p,j)};if(S==="*"){const _=m(p,z)["*"];_&&(R(this,ae,me).call(this,a,_,t,m(p,j)),E(_,j,x),g.push(_));continue}const[P,N,B]=S;if(!c&&!(B instanceof RegExp))continue;const O=m(p,z)[P];if(B instanceof RegExp){if(u===null){u=new Array(d);let M=s[0]==="/"?1:0;for(let ie=0;ie<d;ie++)u[ie]=M,M+=r[ie].length+1}const _=s.substring(u[l]),L=B.exec(_);if(L){if(x[N]=L[0],R(this,ae,me).call(this,a,O,t,m(p,j),x),Aa(m(O,z))){E(O,j,x);const M=((b=L[0].match(/\//))==null?void 0:b.length)??0;(o[M]||(o[M]=[])).push(O)}continue}}(B===!0||B.test(c))&&(x[N]=c,f?(R(this,ae,me).call(this,a,O,t,x,m(p,j)),m(O,z)["*"]&&R(this,ae,me).call(this,a,m(O,z)["*"],t,x,m(p,j))):(E(O,j,x),g.push(O)))}}const h=o.shift();n=h?g.concat(h):g}return a.length>1&&a.sort((l,c)=>l.score-c.score),[a.map(({handler:l,params:c})=>[l,c])]}},pe=new WeakMap,z=new WeakMap,ve=new WeakMap,Re=new WeakMap,j=new WeakMap,ae=new WeakSet,me=function(t,s,a,i,n){for(let r=0,o=m(s,pe).length;r<o;r++){const d=m(s,pe)[r],u=d[a]||d[q],b={};if(u!==void 0&&(u.params=Object.create(null),t.push(u),i!==Me||n&&n!==Me))for(let l=0,c=u.possibleKeys.length;l<c;l++){const f=u.possibleKeys[l],g=b[u.score];u.params[f]=n!=null&&n[f]&&!g?n[f]:i[f]??(n==null?void 0:n[f]),b[u.score]=!0}}},De),ye,wt,Ca=(wt=class{constructor(){A(this,"name","TrieRouter");C(this,ye);E(this,ye,new Pa)}add(e,t,s){const a=Et(t);if(a){for(let i=0,n=a.length;i<n;i++)m(this,ye).insert(e,a[i],s);return}m(this,ye).insert(e,t,s)}match(e,t){return m(this,ye).search(e,t)}},ye=new WeakMap,wt),Ht=class extends ba{constructor(e={}){super(e),this.router=e.router??new Ea({routers:[new Ia,new Ca]})}},_a=/^\s*(?:text\/(?!event-stream(?:[;\s]|$))[^;\s]+|application\/(?:javascript|json|xml|xml-dtd|ecmascript|dart|postscript|rtf|tar|toml|vnd\.dart|vnd\.ms-fontobject|vnd\.ms-opentype|wasm|x-httpd-php|x-javascript|x-ns-proxy-autoconfig|x-sh|x-tar|x-virtualbox-hdd|x-virtualbox-ova|x-virtualbox-ovf|x-virtualbox-vbox|x-virtualbox-vdi|x-virtualbox-vhd|x-virtualbox-vmdk|x-www-form-urlencoded)|font\/(?:otf|ttf)|image\/(?:bmp|vnd\.adobe\.photoshop|vnd\.microsoft\.icon|vnd\.ms-dds|x-icon|x-ms-bmp)|message\/rfc822|model\/gltf-binary|x-shader\/x-fragment|x-shader\/x-vertex|[^;\s]+?\+(?:json|text|xml|yaml))(?:[;\s]|$)/i,gt=(e,t=Ra)=>{const s=/\.([a-zA-Z0-9]+?)$/,a=e.match(s);if(!a)return;let i=t[a[1].toLowerCase()];return i&&i.startsWith("text")&&(i+="; charset=utf-8"),i},Ba={aac:"audio/aac",avi:"video/x-msvideo",avif:"image/avif",av1:"video/av1",bin:"application/octet-stream",bmp:"image/bmp",css:"text/css",csv:"text/csv",eot:"application/vnd.ms-fontobject",epub:"application/epub+zip",gif:"image/gif",gz:"application/gzip",htm:"text/html",html:"text/html",ico:"image/x-icon",ics:"text/calendar",jpeg:"image/jpeg",jpg:"image/jpeg",js:"text/javascript",json:"application/json",jsonld:"application/ld+json",map:"application/json",mid:"audio/x-midi",midi:"audio/x-midi",mjs:"text/javascript",mp3:"audio/mpeg",mp4:"video/mp4",mpeg:"video/mpeg",oga:"audio/ogg",ogv:"video/ogg",ogx:"application/ogg",opus:"audio/opus",otf:"font/otf",pdf:"application/pdf",png:"image/png",rtf:"application/rtf",svg:"image/svg+xml",tif:"image/tiff",tiff:"image/tiff",ts:"video/mp2t",ttf:"font/ttf",txt:"text/plain",wasm:"application/wasm",webm:"video/webm",weba:"audio/webm",webmanifest:"application/manifest+json",webp:"image/webp",woff:"font/woff",woff2:"font/woff2",xhtml:"application/xhtml+xml",xml:"application/xml",zip:"application/zip","3gp":"video/3gpp","3g2":"video/3gpp2",gltf:"model/gltf+json",glb:"model/gltf-binary"},Ra=Ba,Da=(...e)=>{let t=e.filter(i=>i!=="").join("/");t=t.replace(new RegExp("(?<=\\/)\\/+","g"),"");const s=t.split("/"),a=[];for(const i of s)i===".."&&a.length>0&&a.at(-1)!==".."?a.pop():i!=="."&&a.push(i);return a.join("/")||"."},jt={br:".br",zstd:".zst",gzip:".gz"},Na=Object.keys(jt),La="index.html",Oa=e=>{const t=e.root??"./",s=e.path,a=e.join??Da;return async(i,n)=>{var b,l,c,f;if(i.finalized)return n();let r;if(e.path)r=e.path;else try{if(r=Tt(i.req.path),/(?:^|[\/\\])\.{1,2}(?:$|[\/\\])|[\/\\]{2,}/.test(r))throw new Error}catch{return await((b=e.onNotFound)==null?void 0:b.call(e,i.req.path,i)),n()}let o=a(t,!s&&e.rewriteRequestPath?e.rewriteRequestPath(r):r);e.isDir&&await e.isDir(o)&&(o=a(o,La));const d=e.getContent;let u=await d(o,i);if(u instanceof Response)return i.newResponse(u.body,u);if(u){const g=e.mimes&&gt(o,e.mimes)||gt(o);if(i.header("Content-Type",g||"application/octet-stream"),e.precompressed&&(!g||_a.test(g))){const h=new Set((l=i.req.header("Accept-Encoding"))==null?void 0:l.split(",").map(k=>k.trim()));for(const k of Na){if(!h.has(k))continue;const y=await d(o+jt[k],i);if(y){u=y,i.header("Content-Encoding",k),i.header("Vary","Accept-Encoding",{append:!0});break}}}return await((c=e.onFound)==null?void 0:c.call(e,o,i)),i.body(u)}await((f=e.onNotFound)==null?void 0:f.call(e,o,i)),await n()}},Ma=async(e,t)=>{let s;t&&t.manifest?typeof t.manifest=="string"?s=JSON.parse(t.manifest):s=t.manifest:typeof __STATIC_CONTENT_MANIFEST=="string"?s=JSON.parse(__STATIC_CONTENT_MANIFEST):s=__STATIC_CONTENT_MANIFEST;let a;t&&t.namespace?a=t.namespace:a=__STATIC_CONTENT;const i=s[e];if(!i)return null;const n=await a.get(i,{type:"stream"});return n||null},qa=e=>async function(s,a){return Oa({...e,getContent:async n=>Ma(n,{manifest:e.manifest,namespace:e.namespace?e.namespace:s.env?s.env.__STATIC_CONTENT:void 0})})(s,a)},Ha=e=>qa(e);function ja(){return`<!DOCTYPE html>
<html lang="id">
<head>
<meta charset="UTF-8"/>
...
<div class="tag-group" id="grp-auth">
  ...
  <div class="grp-body">
    ...
    ${D("ios-logout","POST","/api/smart/access/logout","Logout Nasabah",[{name:"Authorization",in:"header",type:"string",req:!0,desc:"Bearer {token}"},{name:"X-Timestamp",in:"header",type:"string",req:!0,desc:"Unix timestamp"}],'{"status":"00","message":"Sukses"}',"",["iosCheckAccess","iosTokenMdw"],"Menutup token di gmob_token (set status=closed, end_time=now).")}

    ${D("ios-update-pass","POST","/api/smart/access/update/pass","Update Password",[{name:"old_pass",in:"query",type:"string",req:!0,desc:"Password lama (dienkripsi AES-256)"},{name:"new_pass",in:"query",type:"string",req:!0,desc:"Password baru (dienkripsi AES-256)"},{name:"Authorization",in:"header",type:"string",req:!0,desc:"Bearer {token}"},{name:"X-Timestamp",in:"header",type:"string",req:!0,desc:"Unix timestamp"}],'{"status":"00","message":"Password berhasil diubah"}',"",["iosCheckAccess","iosTokenMdw"],"Verifikasi password lama sebelum update ke gmob_nasabah.pass_crypto.")}

    ${D("ios-update-pin","POST","/api/smart/access/update/pin","Update PIN",[{name:"old_pin",in:"query",type:"string",req:!0,desc:"PIN lama (dienkripsi AES-256)"},{name:"new_pin",in:"query",type:"string",req:!0,desc:"PIN baru (dienkripsi AES-256)"},{name:"Authorization",in:"header",type:"string",req:!0,desc:"Bearer {token}"},{name:"X-Timestamp",in:"header",type:"string",req:!0,desc:"Unix timestamp"}],'{"status":"00","message":"PIN berhasil diubah"}',"",["iosCheckAccess","iosTokenMdw"],"Verifikasi PIN lama sebelum update ke gmob_nasabah.pin_crypto.")}
...
<div class="tag-group" id="grp-tabungan">
  ...
  <div class="grp-body">
    ...
    ${D("tab-history","POST","/api/smart/tabungan/transaction-history","Histori Transaksi",[{name:"account_no",in:"query",type:"string",req:!0,desc:"Nomor rekening (dienkripsi)"},{name:"start_date",in:"query",type:"string",req:!1,desc:"Tanggal mulai YYYY-MM-DD"},{name:"end_date",in:"query",type:"string",req:!1,desc:"Tanggal akhir YYYY-MM-DD"},{name:"Authorization",in:"header",type:"string",req:!0,desc:"Bearer {token}"},{name:"X-Timestamp",in:"header",type:"string",req:!0,desc:"Unix timestamp"}],'{"status":"00","message":"Sukses","data":[{"tanggal":"2024-01-15","keterangan":"Transfer Masuk","debet":0,"kredit":100000,"saldo":1500000}]}',"",["iosCheckAccess","iosTokenMdw"],"Query dari gtb_folio, hasil dienkripsi. Default 30 hari terakhir jika tanggal tidak disertakan.")}

    ${D("tab-mutasi","POST","/api/smart/tabungan/mutasi-history","Histori Mutasi",[{name:"account_no",in:"query",type:"string",req:!0,desc:"Nomor rekening (dienkripsi)"},{name:"period",in:"query",type:"string",req:!1,desc:"Periode: YYYYMM (default: bulan ini)"},{name:"Authorization",in:"header",type:"string",req:!0,desc:"Bearer {token}"},{name:"X-Timestamp",in:"header",type:"string",req:!0,desc:"Unix timestamp"}],'{"status":"00","message":"Sukses","saldo_awal":"ENC...","saldo_akhir":"ENC...","data":[{"tgl":"2024-01-15","ket":"PPOB-PLN","nominal":"ENC...","jenis":"D"}]}',"",["iosCheckAccess","iosTokenMdw"],"Mutasi per periode (bulanan). Semua nilai nominal dienkripsi AES-256-CBC.")}
...
<div class="tag-group" id="grp-transfer">
  ...
  <div class="grp-body">
    ...
    ${D("tr-lpd-check","POST","/api/smart/transfer/lpd/check","LPD – Cek Rekening Tujuan",[{name:"account_no",in:"query",type:"string",req:!0,desc:"Nomor rekening tujuan (dienkripsi AES-256)"},{name:"Authorization",in:"header",type:"string",req:!0,desc:"Bearer {token}"},{name:"X-Timestamp",in:"header",type:"string",req:!0,desc:"Unix timestamp"}],'{"status":"00","message":"Sukses inquiry","product_type":"tabungan","customer_name":"I WAYAN SARI"}',"",["iosCheckAccess","iosTokenMdw"],"Verifikasi rekening tujuan sesama LPD. Error 01 = rekening tidak aktif.")}
...
<div class="tag-group" id="grp-ppob-cb">
  ...
  <div class="grp-body">
    ...
    ${D("ppob-cb","POST","/api/ppob/callback","PPOB – Notifikasi Callback FastPay",[{name:"ref_id",in:"body",type:"string",req:!0,desc:"Reference ID transaksi dari FastPay"},{name:"product_code",in:"body",type:"string",req:!0,desc:"Kode produk"},{name:"customer_id",in:"body",type:"string",req:!0,desc:"ID pelanggan"},{name:"status",in:"body",type:"string",req:!0,desc:"Status: 00=sukses, lainnya=gagal"},{name:"amount",in:"body",type:"number",req:!0,desc:"Nominal transaksi"},{name:"timestamp",in:"body",type:"string",req:!1,desc:"Waktu callback dari FastPay"},{name:"X-FastPay-Signature",in:"header",type:"string",req:!1,desc:"Tanda tangan dari FastPay (opsional tergantung konfigurasi)"}],'{"status":"00","message":"OK"}',`{
...
<\/script>
...
</html>`}function D(e,t,s,a,i,n,r,o,d){const u="mb-post",b=i.map(v=>`
    <tr>
    ...
    <div class="schema-obj">${za(n)}</div>`:"";return`
...
</div>`}function za(e){try{return JSON.stringify(JSON.parse(e),null,2).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/("[\w-]+")\s*:/g,'<span class="hl-key">$1</span>:').replace(/:\s*(".*?")/g,': <span class="hl-str">$1</span>').replace(/:\s*(-?\d+\.?\d*)/g,': <span class="hl-num">$1</span>').replace(/:\s*(true|false)/g,': <span class="hl-bool">$1</span>')}catch{return e}}function Ka(){return`<!DOCTYPE html>
<html lang="id">
<head>
<meta charset="UTF-8"/>
<meta name="viewport" content="width=device-width, initial-scale=1.0"/>
...
</html>`}function Ua(){return`<!DOCTYPE html>
<html lang="id">
<head>
<meta charset="UTF-8"/>
<meta name="viewport" content="width=device-width, initial-scale=1.0"/>
...
</html>`}const zt=`-----BEGIN PRIVATE KEY-----
...
-----END PRIVATE KEY-----`,Xa=`-----BEGIN PRIVATE KEY-----
...
-----END PRIVATE KEY-----`,Ze="p91wrswK";function ue(e){if(!e||typeof e!="string")return new Uint8Array(0);const t=e.replace(/-/g,"+").replace(/_/g,"/"),s=t.padEnd(t.length+(4-t.length%4)%4,"=");try{const a=atob(s);return Uint8Array.from(a,i=>i.charCodeAt(0))}catch{return new Uint8Array(0)}}function se(e){return btoa(String.fromCharCode(...new Uint8Array(e)))}function Le(e){return Array.from(new Uint8Array(e)).map(t=>t.toString(16).padStart(2,"0")).join("")}function G(e){return new TextEncoder().encode(e)}function Kt(e){function t(y,p){const w=(y&65535)+(p&65535);return(y>>16)+(p>>16)+(w>>16)<<16|w&65535}function s(y,p){return y<<p|y>>>32-p}function a(y,p,w,v,T,S){return t(s(t(t(p,y),t(v,S)),T),w)}function i(y,p,w,v,T,S,x){return a(p&w|~p&v,y,p,T,S,x)}function n(y,p,w,v,T,S,x){return a(p&v|w&~v,y,p,T,S,x)}function r(y,p,w,v,T,S,x){return a(p^w^v,y,p,T,S,x)}function o(y,p,w,v,T,S,x){return a(w^(p|~v),y,p,T,S,x)}function d(y){const p=[];for(let w=0;w<y.length;w++){const v=y.charCodeAt(w);v<128?p.push(v):v<2048?p.push(v>>6|192,v&63|128):v<65536?p.push(v>>12|224,v>>6&63|128,v&63|128):p.push(v>>18|240,v>>12&63|128,v>>6&63|128,v&63|128)}return p}const u=d(e),b=u.length;for(u.push(128);u.length%64!==56;)u.push(0);const l=b*8;for(let y=0;y<8;y++)u.push(y<4?l>>>y*8&255:l/4294967296>>>y*4*8&255);let c=1732584193,f=4023233417,g=2562383102,h=271733878;for(let y=0;y<u.length;y+=64){const p=[];for(let x=0;x<16;x++)p[x]=u[y+x*4]|u[y+x*4+1]<<8|u[y+x*4+2]<<16|u[y+x*4+3]<<24;let[w,v,T,S]=[c,f,g,h];c=i(c,f,g,h,p[0],7,-680876936),h=i(h,c,f,g,p[1],12,-389564586),g=i(g,h,c,f,p[2],17,606105819),f=i(f,g,h,c,p[3],22,-1044525330),c=i(c,f,g,h,p[4],7,-176418897),h=i(h,c,f,g,p[5],12,1200080426),g=i(g,h,c,f,p[6],17,-1473231341),f=i(f,g,h,c,p[7],22,-45705983),c=i(c,f,g,h,p[8],7,1770035416),h=i(h,c,f,g,p[9],12,-1958414417),g=i(g,h,c,f,p[10],17,-42063),f=i(f,g,h,c,p[11],22,-1990404162),c=i(c,f,g,h,p[12],7,1804603682),h=i(h,c,f,g,p[13],12,-40341101),g=i(g,h,c,f,p[14],17,-1502002290),f=i(f,g,h,c,p[15],22,1236535329),c=n(c,f,g,h,p[1],5,-165796510),h=n(h,c,f,g,p[6],9,-1069501632),g=n(g,h,c,f,p[11],14,643717713),f=n(f,g,h,c,p[0],20,-373897302),c=n(c,f,g,h,p[5],5,-701558691),h=n(h,c,f,g,p[10],9,38016083),g=n(g,h,c,f,p[15],14,-660478335),f=n(f,g,h,c,p[4],20,-405537848),c=n(c,f,g,h,p[9],5,568446438),h=n(h,c,f,g,p[14],9,-1019803690),g=n(g,h,c,f,p[3],14,-187363961),f=n(f,g,h,c,p[8],20,1163531501),c=n(c,f,g,h,p[13],5,-1444681467),h=n(h,c,f,g,p[2],9,-51403784),g=n(g,h,c,f,p[7],14,1735328473),f=n(f,g,h,c,p[12],20,-1926607734),c=r(c,f,g,h,p[5],4,-378558),h=r(h,c,f,g,p[8],11,-2022574463),g=r(g,h,c,f,p[11],16,1839030562),f=r(f,g,h,c,p[14],23,-35309556),c=r(c,f,g,h,p[1],4,-1530992060),h=r(h,c,f,g,p[4],11,1272893353),g=r(g,h,c,f,p[7],16,-155497632),f=r(f,g,h,c,p[10],23,-1094730640),c=r(c,f,g,h,p[13],4,681279174),h=r(h,c,f,g,p[0],11,-358537222),g=r(g,h,c,f,p[3],16,-722521979),f=r(f,g,h,c,p[6],23,76029189),c=r(c,f,g,h,p[9],4,-640364487),h=r(h,c,f,g,p[12],11,-421815835),g=r(g,h,c,f,p[15],16,530742520),f=r(f,g,h,c,p[2],23,-995338651),c=o(c,f,g,h,p[0],6,-198630844),h=o(h,c,f,g,p[7],10,1126891415),g=o(g,h,c,f,p[14],15,-1416354905),f=o(f,g,h,c,p[5],21,-57434055),c=o(c,f,g,h,p[12],6,1700485571),h=o(h,c,f,g,p[3],10,-1894986606),g=o(g,h,c,f,p[10],15,-1051523),f=o(f,g,h,c,p[1],21,-2054922799),c=o(c,f,g,h,p[8],6,1873313359),h=o(h,c,f,g,p[15],10,-30611744),g=o(g,h,c,f,p[6],15,-1560198380),f=o(f,g,h,c,p[13],21,1309151649),c=o(c,f,g,h,p[4],6,-145523070),h=o(h,c,f,g,p[11],10,-1120210379),g=o(g,h,c,f,p[2],15,718787259),f=o(f,g,h,c,p[9],21,-343485551),c=t(c,w),f=t(f,v),g=t(g,T),h=t(h,S)}function k(y){let p="";for(let w=0;w<4;w++)p+=(y>>>w*8&255).toString(16).padStart(2,"0");return p}return k(c)+k(f)+k(g)+k(h)}async function it(e,t){const s=t.slice(-8),a=s.split(":").map(Number),i=await crypto.subtle.importKey("raw",G(t),{name:"HMAC",hash:"SHA-512"},!1,["sign"]),n=new Uint8Array(await crypto.subtle.sign("HMAC",i,G(e))),r=n.length,o=a[0],d=Math.floor((r+a[1])/2)-16,u=Math.floor((r+a[2])/3)-8,b=se(n.slice(o,o+32)),l=se(n.slice(d,d+16)),c=se(n.slice(u,u+8));return{aesKey:b,aesIv:l,aesCs:c,times:a,kStart:o,ivStart:d,csStart:u,debug:{lastEight:s,times:a,kStart:o,ivStart:d,csStart:u,keyBytesHex:Le(n).slice(0,32)+"..."}}}async function I(e,t,s){const a=await crypto.subtle.importKey("raw",ue(t),"AES-CBC",!1,["encrypt"]),i=ue(s),n=await crypto.subtle.encrypt({name:"AES-CBC",iv:i},a,G(e));return se(n)}async function ot(e,t,s){try{const a=await crypto.subtle.importKey("raw",ue(t),"AES-CBC",!1,["decrypt"]),i=ue(s),n=await crypto.subtle.decrypt({name:"AES-CBC",iv:i},a,ue(e));return new TextDecoder().decode(n)}catch{return null}}function $a(e){const t=e.endsWith("==")?"==":e.endsWith("=")?"=":"",s=e.substring(7,13),a=parseInt(s[0])*10+s.charCodeAt(1)-64,i=100+parseInt(s[2])*10+s.charCodeAt(3)-64,n=100+parseInt(s[4])*10+s.charCodeAt(5)-64,r=e.substring(16,20),o=r.charCodeAt(0)-64,d=r.charCodeAt(1)-64,u=parseInt(r.slice(2)),b=e.substring(a,a+o)+e.substring(i,i+d)+e.substring(n,n+u),l=atob((b+t).replace(/-/g,"+").replace(/_/g,"/")),c=l.split("|");return{app:c[0]||"",clientID:c[1]||"",regTime:c[2]||"",rawDecoded:l,parts:c,debug:{col1:a,col2:i,col3:n,len1:o,len2:d,len3:u,idd:b.slice(0,20)+"..."}}}function Fa(e,t,s="Seminyak"){const a=`${s}|${e}|${t}`,i=btoa(a),n=i.endsWith("==")?"==":i.endsWith("=")?"=":"",r=i.slice(0,i.length-n.length),o=r.length,d=69,u=135,b=175,l=Math.floor(o/3),c=l,f=l,g=o-c-f,h=r.slice(0,c),k=r.slice(c,c+f),y=r.slice(c+f),p=x=>String(Math.floor(x/10))+String.fromCharCode(x%10+64),w=p(d)+p(u-100)+p(b-100),v=String.fromCharCode(c+64)+String.fromCharCode(f+64)+String(g).padStart(2,"0"),T=b+g+200,S=new Array(T+100).fill("A");S[7]=w[0],S[8]=w[1],S[9]=w[2],S[10]=w[3],S[11]=w[4],S[12]=w[5],S[16]=v[0],S[17]=v[1],S[18]=v[2],S[19]=v[3];for(let x=0;x<h.length;x++)S[d+x]=h[x];for(let x=0;x<k.length;x++)S[u+x]=k[x];for(let x=0;x<y.length;x++)S[b+x]=y[x];return S.join("").slice(0,b+g)+n}function Ga(e){const t=e.split(".");if(t.length<2)return{error:"Bukan format JWT valid"};try{const s=JSON.parse(atob(t[0].replace(/-/g,"+").replace(/_/g,"/"))),a=JSON.parse(atob(t[1].replace(/-/g,"+").replace(/_/g,"/")));return{header:s,payload:a,signatureB64:t[2]||"",raw:{headerB64:t[0],payloadB64:t[1]}}}catch(s){return{error:s instanceof Error?s.message:String(s)}}}async function dt(e){const t=e.replace(/-----[^-]+-----/g,"").replace(/\s/g,"");return ue(t).buffer}async function et(e,t,s=zt){const a=btoa(JSON.stringify({trans_no:e,alg:"RS256"})).replace(/\+/g,"-").replace(/\//g,"_").replace(/=/g,""),i=btoa(JSON.stringify({trans_time:t})).replace(/\+/g,"-").replace(/\//g,"_").replace(/=/g,""),n=`${a}.${i}`,r=await dt(s),o=await crypto.subtle.importKey("pkcs8",r,{name:"RSASSA-PKCS1-v1_5",hash:"SHA-256"},!1,["sign"]),d=await crypto.subtle.sign("RSASSA-PKCS1-v1_5",o,G(n)),u=se(d).replace(/\+/g,"-").replace(/\//g,"_").replace(/=/g,"");return`${n}.${u}`}async function Ut(e,t,s){const a=ue(s),i=a.length>=8?a:new Uint8Array(8),n=G(`${e}:${t}`),r=await crypto.subtle.importKey("raw",i,{name:"HMAC",hash:"SHA-512"},!1,["sign"]),o=await crypto.subtle.sign("HMAC",r,n);return se(o)}async function Ee(e,t,s){const a=G(s),i=G(`${e}:${t}`),n=await crypto.subtle.importKey("raw",a,{name:"HMAC",hash:"SHA-512"},!1,["sign"]),r=await crypto.subtle.sign("HMAC",n,i);return se(r)}function Ya(e){return Le(ue(e))}async function Xt(e){const t=`%${e.fromAcc}#${e.amount}@${e.dateTime}^${e.refNo}*${e.destBank}~${e.destAcc}|${Ze}%`;return Le(await crypto.subtle.digest("SHA-256",G(t)))}async function $t(e){const t=`@${e.fromAcc}|${e.amount}~${e.dateTime}*${e.refNo}^${e.destBank}#${e.destAcc}(${e.destName})${Ze}@`;return Le(await crypto.subtle.digest("SHA-256",G(t)))}async function Ja(e){const t=`{${e.nominal}*${e.norekFrom}^${e.norekTo}%${e.nameFrom}#${e.nameTo}@${Ze}}`;return Le(await crypto.subtle.digest("SHA-256",G(t)))}async function lt(e){const t=Le(await crypto.subtle.digest("SHA-256",G(`Seminyak|${e}`))),s=await dt(zt),a=await crypto.subtle.importKey("pkcs8",s,{name:"RSASSA-PKCS1-v1_5",hash:"SHA-256"},!1,["sign"]),i=await crypto.subtle.sign("RSASSA-PKCS1-v1_5",a,G(t));return{signature:se(i),timestamp:e,clientStamp:t}}async function Ft(e,t){const s=`${e}|${t}`,a=await dt(Xa),i=await crypto.subtle.importKey("pkcs8",a,{name:"RSASSA-PKCS1-v1_5",hash:"SHA-256"},!1,["sign"]),n=await crypto.subtle.sign("RSASSA-PKCS1-v1_5",i,G(s));return{signature:se(n),clientKey:e,timestamp:t,message:s}}function F(){const e=new Date;return new Date(e.getTime()+7*36e5).toISOString().replace("T"," ").slice(0,19)}function ke(){const e=new Date;return new Date(e.getTime()+7*36e5).toISOString().slice(0,19)+"+07:00"}function X(e="SMY"){const t=new Date(new Date().getTime()+252e5),s=t.toISOString().slice(11,19).replace(/:/g,"").slice(0,6),a=String(Math.floor(Math.random()*9e3)+1e3),i=t.toISOString().slice(0,10).replace(/-/g,"");return`${e}${s}${a}O1012${i.slice(4)}`}async function Va(e){const t=e.timestamp||F(),s=e.refNo||X(),a=await I(e.fromAcc,e.aesKey,e.aesIv),i=await I(String(e.amount),e.aesKey,e.aesIv),n=await I(e.dateTime,e.aesKey,e.aesIv),r=await I(e.destName||"",e.aesKey,e.aesIv);let o,d,u;e.step==="posting"?(o=await $t({...e,refNo:s}),d=await I(`${e.destBank}-${e.destAcc}`,e.aesKey,e.aesIv),u=await I(o,e.aesKey,e.aesIv)):(o=await Xt({...e,refNo:s}),d=await I(`${e.destBank}-${e.destAcc}-${o}`,e.aesKey,e.aesIv),u=null);const b=await et(s,ke()),l=await Ut(b,t,e.aesCs),c=l,f={from_acc:a,to_acc:d,amount:i,date_time:n,to_name:r,hash_code:u||"",remark:e.remark||""};return{headers:{"Content-Type":"application/json",Authorization:b,"X-TIMESTAMP":t,"X-SIGNATURE":l,"X-PARTNER-ID":c,"X-CLIENT-ID":e.didEncoded||"","X-REFERENCE":s,"X-Forwarded-For":"34.50.74.78","X-Real-IP":"34.50.74.78"},body:f,url:`${e.baseUrl||"https://lpdseminyak.biz.id:8000"}/api/smart/transfer/bank/post`,refNo:s,ts:t,debug:{hashRaw:o,step:e.step||"check"}}}async function Wa(e,t,s){const a={};for(const[i,n]of Object.entries(e))n&&typeof n=="string"&&(a[i]=await ot(n,t,s));return a}async function Qa(e){const t=e.op;try{let s;if(t==="keygen")s=await it(e.clientID,e.timestamp);else if(t==="encrypt")s={encrypted:await I(e.plaintext,e.aesKey,e.aesIv),plaintext:e.plaintext};else if(t==="decrypt")s={decrypted:await ot(e.ciphertext,e.aesKey,e.aesIv),ciphertext:e.ciphertext};else if(t==="did-decode")s=$a(e.did);else if(t==="did-encode")s={encoded:Fa(e.clientID,e.timestamp,e.appName||"Seminyak"),clientID:e.clientID,timestamp:e.timestamp};else if(t==="jwt-decode")s=Ga(e.jwt);else if(t==="hashcode"){const a=e.step||"check";let i;a==="posting"?i=await $t(e):a==="lpd"?i=await Ja(e):i=await Xt(e);const n=Ze;s={hash:i,step:a,formula:a==="posting"?`SHA256("@"+fromAcc+"|"+amount+"~"+dateTime+"*"+refNo+"^"+destBank+"#"+destAcc+"("+destName+")${n}@")`:`SHA256("%"+fromAcc+"#"+amount+"@"+dateTime+"^"+refNo+"*"+destBank+"~"+destAcc+"|${n}%")`}}else if(t==="reference"){const a=[];for(let i=0;i<(parseInt(e.count)||3);i++)a.push(X(e.prefix||"SMY"));s={references:a}}else if(t==="signature")s={signature:await Ut(e.token,e.timestamp,e.aesCs)};else if(t==="sig-decode"){const a=Ya(e.signature);s={hex:a,length:a.length}}else if(t==="ios-token-sig")s=await lt(e.timestamp||F());else if(t==="snap-token-sig")s=await Ft(e.clientKey||"LPD-SEMINYAK-001",e.timestamp||ke());else if(t==="build-transfer")s=await Va({...e,timestamp:e.timestamp||F(),refNo:e.refNo||X()});else if(t==="decrypt-body"){const a=JSON.parse(e.body||"{}");s={decrypted:await Wa(a,e.aesKey,e.aesIv)}}else if(t==="timestamp")s={jakarta:F(),jakartaISO:ke(),utc:new Date().toISOString()};else if(t==="partner-id")s={partnerId:await Ee(e.token||e.authToken||"",e.timestamp||F(),e.aesCs||"")};else if(t==="poc-build"){const a=e.timestamp||F(),i=e.timestampISO||ke(),n=e.action||"register",r=e.ref||X(),o=await et(r,i);let d=e.aesCs||"";if(n==="register"&&e.imei)d=(await it(e.imei,a)).aesCs,s={action:n,ts:a,tsISO:i,ref:r,jwt:o.slice(0,30)+"...",aesCs:d,partnerId:await Ee(o,a,d),headers:{Authorization:o,"X-TIMESTAMP":a,"X-PARTNER-ID":await Ee(o,a,d),"X-CLIENT-ID":e.clientIdEnc||"(encode IMEI first)","X-REFERENCE":r}};else{const u=await Ee(o,a,d);s={action:n,ts:a,tsISO:i,ref:r,jwt:o.slice(0,30)+"...",aesCs:d,partnerId:u,headers:{Authorization:o,"X-TIMESTAMP":a,"X-PARTNER-ID":u,"X-CLIENT-ID":e.clientIdEnc||"(encode IMEI first)","X-REFERENCE":r}}}}else return{ok:!1,error:`Unknown operation: ${t}`};return{ok:!0,op:t,result:s}}catch(s){return{ok:!1,op:t,error:s instanceof Error?s.message:String(s)}}}const K=new Ht;K.use("/static/*",Ha({root:"./public"}));K.get("/favicon.ico",e=>e.body(null,204));K.post("/api/exec",async e=>{try{const t=await e.req.json(),a=await(await fetch("http://127.0.0.1:3001/exec",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(t)})).json();return e.json(a)}catch(t){const s=t instanceof Error?t.message:String(t);return e.json({stdout:"",stderr:"Terminal server tidak tersedia: "+s,cwd:"/home/user",exitCode:1},500)}});K.get("/api/exec/health",async e=>{try{const s=await(await fetch("http://127.0.0.1:3001/health")).json();return e.json({ok:!0,...s})}catch{return e.json({ok:!1,error:"Terminal server tidak tersedia di production. Gunakan sandbox URL untuk operasi crypto.",sandbox_only:!0})}});K.post("/api/crypto",async e=>{try{const t=await e.req.json(),s=await Qa(t);return e.json(s)}catch(t){const s=t instanceof Error?t.message:String(t);return e.json({ok:!1,error:"Crypto error: "+s})}});function Za(e){return e?e.split("{#}").filter(Boolean).map(t=>{const s=t.split("<>");return{norek:s[0]||"",nama:s[1]||"",saldo:s[2]||"",produk:s[3]||""}}):[]}const Ne="34.50.74.78";async function $(e,t,s,a){if(!t)throw new Error("X-CLIENT-ID (clientIdEnc) wajib diisi — jalankan Derive AES Keys terlebih dahulu");const i=F(),n=ke(),r=s||X(),o=await et(r,n),d=X(),u=a&&a.trim()?a.trim():o,b=await Ee(u,i,e||""),l=b;return{jwt:o,ts:i,tsISO:n,sig:l,xref:d,headers:{"Content-Type":"application/json",Authorization:u,"X-TIMESTAMP":i,"X-SIGNATURE":l,"X-PARTNER-ID":b,"X-CLIENT-ID":t,"X-REFERENCE":d,"X-Forwarded-For":Ne,"X-Real-IP":Ne}}}async function es(e,t,s){try{if(!t)return{ok:!1,error:"clientIdEnc (X-CLIENT-ID) wajib diisi — jalankan Auto Setup terlebih dahulu"};const a=F(),i=await lt(a),n=e+"/api/smart/access/token",r={"Content-Type":"application/json","X-TIMESTAMP":a,"X-CLIENT-ID":t,"X-SIGNATURE":i.signature,"X-Forwarded-For":Ne,"X-Real-IP":Ne},o=JSON.stringify({credential:"{get-token}"}),d=await fetch(n,{method:"POST",headers:r,body:o}),u=await d.text();let b={};try{b=JSON.parse(u)}catch{b={_raw:u}}const l=b.token||"",c=b.status||"";return c==="2007300"&&l?{ok:!0,token:l}:{ok:!1,error:`${c||"HTTP "+d.status}: ${b.message||u.slice(0,200)}`}}catch(a){return{ok:!1,error:a.message}}}K.post("/api/smart/get-ios-token",async e=>{try{const t=await e.req.json(),{baseUrl:s,clientIdEnc:a,aesCs:i}=t;if(!a)return e.json({ok:!1,error:"clientIdEnc wajib diisi — jalankan Auto Setup terlebih dahulu"});const n=(s||"https://lpdseminyak.biz.id:8000").replace(/\/+$/,""),r=await es(n,a,i||"");return e.json({ok:r.ok,token:r.token,error:r.error,expiresIn:180})}catch(t){return e.json({ok:!1,error:t.message})}});K.post("/api/smart/register",async e=>{try{const t=await e.req.json(),{baseUrl:s,clientIdEnc:a,imei:i,user_name:n,user_pass:r}=t;if(!a)return e.json({ok:!1,error:"clientIdEnc wajib diisi"});if(!i)return e.json({ok:!1,error:"imei wajib diisi"});const o=(s||"https://lpdseminyak.biz.id:8000").replace(/\/+$/,""),d=F(),u=ke(),b=X(),l=await et(b,u),{aesCs:c}=await it(i,d),f=await Ee(l,d,c),g=P=>Kt(P),h=P=>/^[0-9a-f]{32}$/i.test(P),k=n?h(n)?n:g(n):"",y=r?h(r)?r:g(r):"",p=o+"/api/smart/access/register",w=JSON.stringify({user_name:k,user_pass:y}),v={"Content-Type":"application/json",Authorization:l,"X-TIMESTAMP":d,"X-SIGNATURE":f,"X-PARTNER-ID":f,"X-CLIENT-ID":a,"X-REFERENCE":b,"X-Forwarded-For":Ne,"X-Real-IP":Ne};let T=0,S={};try{const P=await fetch(p,{method:"POST",headers:v,body:w});T=P.status;const N=await P.text();try{S=JSON.parse(N)}catch{S={_raw:N}}}catch(P){S={_fetchError:P.message}}const x=T>=200&&T<300&&(S.status==="00"||S.status==="2007300");return e.json({ok:x,action:"register",httpStatus:T,url:p,result:S,aesKeys:{aesCs:c},debug:{ts:d,ref:b,imei:i,partnerId:f.slice(0,20)+"..."},headers:v})}catch(t){return e.json({ok:!1,error:t.message})}});K.post("/api/smart",async e=>{var t;try{const s=await e.req.json(),{action:a,baseUrl:i,aesKey:n,aesIv:r,aesCs:o,clientIdEnc:d,transNo:u,iosToken:b,...l}=s,c=(i||"https://lpdseminyak.biz.id:8000").replace(/\/+$/,""),f=k=>Kt(k),g=k=>/^[0-9a-f]{32}$/i.test(k);if(a==="login"){if(!l.user_name||!l.user_pass)throw new Error("user_name dan user_pass wajib diisi");if(!d)throw new Error("clientIdEnc (X-CLIENT-ID) wajib diisi");const k=g(l.user_name)?l.user_name:f(l.user_name),y=g(l.user_pass)?l.user_pass:f(l.user_pass),{headers:p,ts:w,xref:v,jwt:T,sig:S}=await $(o,d,u,b),x=c+"/api/smart/access/login",P=JSON.stringify({user_name:k,user_pass:y});let N=0,B={};try{const L=await fetch(x,{method:"POST",headers:p,body:P});N=L.status;const M=await L.text();try{B=JSON.parse(M)}catch{B={_raw:M}}}catch(L){return e.json({ok:!1,action:a,error:L.message,url:x,headers:p})}const O=N>=200&&N<300&&B.status==="00";let _=null;if(O&&B.account_list&&n&&r)try{const L=await ot(B.account_list,n,r);if(L){const M=Za(L);_={nama:((t=M[0])==null?void 0:t.nama)||"",noid:l.user_name,accounts:M}}}catch{}return e.json({ok:O,action:a,httpStatus:N,url:x,result:B,nasabah:_,debug:{ts:w,xref:v,user_name_sent:k,user_pass_sent:y,jwt_preview:T.substring(0,40)+"...",sig_preview:S.substring(0,20)+"..."},requestHeaders:p})}if(a==="cek-saldo"){if(!l.no_rek)throw new Error("no_rek wajib diisi");if(!d)throw new Error("clientIdEnc wajib diisi");if(!n||!r)throw new Error("aesKey dan aesIv wajib diisi");const k=await I(l.no_rek,n,r),{headers:y,ts:p,xref:w}=await $(o,d,u,b),v=c+"/api/smart/account/balance",T=JSON.stringify({no_rek:k});let S=0,x={};try{const P=await fetch(v,{method:"POST",headers:y,body:T});S=P.status;const N=await P.text();try{x=JSON.parse(N)}catch{x={_raw:N}}}catch(P){return e.json({ok:!1,action:a,error:P.message})}return e.json({ok:S>=200&&S<300,action:a,httpStatus:S,url:v,result:x,debug:{ts:p,xref:w,no_rek_enc:k},requestHeaders:y})}if(a==="inquiry"){if(!l.no_rek_from||!l.no_rek_to||!l.nominal)throw new Error("no_rek_from, no_rek_to, nominal wajib diisi");if(!d)throw new Error("clientIdEnc wajib diisi");const k=u||X(),{headers:y,ts:p,xref:w}=await $(o,d,k,b),[v,T,S,x]=await Promise.all([I(l.no_rek_from,n,r),I(l.no_rek_to,n,r),I(l.nominal,n,r),l.bank_dest?I(l.bank_dest,n,r):Promise.resolve("")]),P=c+"/api/smart/transfer/inquiry",N=JSON.stringify({no_rek_from:v,no_rek_to:T,nominal:S,bank_dest:x,ref_no:k});let B=0,O={};try{const _=await fetch(P,{method:"POST",headers:y,body:N});B=_.status;const L=await _.text();try{O=JSON.parse(L)}catch{O={_raw:L}}}catch(_){return e.json({ok:!1,action:a,error:_.message})}return e.json({ok:B>=200&&B<300,action:a,httpStatus:B,url:P,result:O,debug:{ts:p,xref:w,ref:k},requestHeaders:y})}if(a==="posting"){if(!l.no_rek_from||!l.no_rek_to||!l.nominal)throw new Error("no_rek_from, no_rek_to, nominal wajib diisi");if(!d)throw new Error("clientIdEnc wajib diisi");const k=u||X(),{headers:y,ts:p,xref:w}=await $(o,d,k,b),[v,T,S,x,P,N]=await Promise.all([I(l.no_rek_from,n,r),I(l.no_rek_to,n,r),I(l.nominal,n,r),l.bank_dest?I(l.bank_dest,n,r):Promise.resolve(""),l.nama_dest?I(l.nama_dest,n,r):Promise.resolve(""),l.keterangan?I(l.keterangan,n,r):Promise.resolve("")]),B=c+"/api/smart/transfer/posting",O=JSON.stringify({no_rek_from:v,no_rek_to:T,nominal:S,bank_dest:x,nama_dest:P,keterangan:N,ref_no:k});let _=0,L={};try{const M=await fetch(B,{method:"POST",headers:y,body:O});_=M.status;const ie=await M.text();try{L=JSON.parse(ie)}catch{L={_raw:ie}}}catch(M){return e.json({ok:!1,action:a,error:M.message})}return e.json({ok:_>=200&&_<300,action:a,httpStatus:_,url:B,result:L,debug:{ts:p,xref:w,ref:k},requestHeaders:y})}const h=async(k,y,p)=>{const w=await fetch(k,{method:"POST",headers:y,body:p}),v=await w.text();let T;try{T=JSON.parse(v)}catch{T={_raw:v}}return{httpStatus:w.status,parsed:T}};if(a==="logout"){if(!d)throw new Error("clientIdEnc wajib diisi");const{headers:k,ts:y,xref:p}=await $(o,d,void 0,b),w=c+"/api/smart/access/logout";try{const{httpStatus:v,parsed:T}=await h(w,k,"{}");return e.json({ok:v<400,action:a,httpStatus:v,url:w,result:T,debug:{ts:y,xref:p}})}catch(v){return e.json({ok:!1,action:a,error:v.message})}}if(a==="account-list"){if(!d)throw new Error("clientIdEnc wajib diisi");if(!n||!r)throw new Error("aesKey dan aesIv wajib diisi");const k=await I(l.customer_id||"",n,r),{headers:y,ts:p,xref:w}=await $(o,d,void 0,b),v=c+"/api/smart/tabungan/account-list",T=JSON.stringify({customer_id:k});try{const{httpStatus:S,parsed:x}=await h(v,y,T);return e.json({ok:S<400,action:a,httpStatus:S,url:v,result:x,debug:{ts:p,xref:w,customer_id_enc:k}})}catch(S){return e.json({ok:!1,action:a,error:S.message})}}if(a==="mutasi-history"){if(!d)throw new Error("clientIdEnc wajib diisi");if(!n||!r)throw new Error("aesKey dan aesIv wajib diisi");const k=await I(l.customer_id||"",n,r),{headers:y,ts:p,xref:w}=await $(o,d,void 0,b),v=c+"/api/smart/tabungan/mutasi-history",T=JSON.stringify({customer_id:k});try{const{httpStatus:S,parsed:x}=await h(v,y,T);return e.json({ok:S<400,action:a,httpStatus:S,url:v,result:x,debug:{ts:p,xref:w,customer_id_enc:k}})}catch(S){return e.json({ok:!1,action:a,error:S.message})}}if(a==="transaction-history"){if(!d)throw new Error("clientIdEnc wajib diisi");if(!n||!r)throw new Error("aesKey dan aesIv wajib diisi");const k=await I(l.no_rek||"",n,r),y=await I(l.tgl_awal||"",n,r),p=await I(l.tgl_akhir||"",n,r),{headers:w,ts:v,xref:T}=await $(o,d,void 0,b),S=c+"/api/smart/tabungan/transaction-history",x=JSON.stringify({no_rek:k,tgl_awal:y,tgl_akhir:p});try{const{httpStatus:P,parsed:N}=await h(S,w,x);return e.json({ok:P<400,action:a,httpStatus:P,url:S,result:N,debug:{ts:v,xref:T}})}catch(P){return e.json({ok:!1,action:a,error:P.message})}}if(a==="transfer-lpd-check"){if(!l.no_rek_tujuan)throw new Error("no_rek_tujuan wajib diisi");if(!d)throw new Error("clientIdEnc wajib diisi");if(!n||!r)throw new Error("aesKey dan aesIv wajib diisi");const k=X(),y=await I(l.no_rek_tujuan,n,r),{headers:p,ts:w,xref:v}=await $(o,d,k,b),T=c+"/api/smart/transfer/lpd/check",S=JSON.stringify({account_no:y});try{const{httpStatus:x,parsed:P}=await h(T,p,S);return e.json({ok:x<400,action:a,httpStatus:x,url:T,result:P,debug:{ts:w,xref:v,ref:k,account_no_enc:y}})}catch(x){return e.json({ok:!1,action:a,error:x.message})}}if(a==="transfer-lpd-inquiry"){if(!l.no_rek_from||!l.no_rek_to||!l.nominal)throw new Error("no_rek_from, no_rek_to, nominal wajib diisi");if(!d)throw new Error("clientIdEnc wajib diisi");if(!n||!r)throw new Error("aesKey dan aesIv wajib diisi");const k=u||X(),{headers:y,ts:p,xref:w}=await $(o,d,k,b),[v,T,S,x,P,N]=await Promise.all([I(l.no_rek_from,n,r),I(l.no_rek_to,n,r),I(l.nama_tujuan||"",n,r),I(l.nominal,n,r),I(l.date_time||F(),n,r),I(l.keterangan||"",n,r)]),B=c+"/api/smart/transfer/lpd/inquiry",O=JSON.stringify({to_acc:T,to_name:S,from_acc:v,from_name:v,amount:x,remark:N});try{const{httpStatus:_,parsed:L}=await h(B,y,O);return e.json({ok:_<400,action:a,httpStatus:_,url:B,result:L,debug:{ts:p,xref:w,ref:k}})}catch(_){return e.json({ok:!1,action:a,error:_.message})}}if(a==="transfer-lpd-posting"){if(!l.no_rek_from||!l.no_rek_to||!l.nominal)throw new Error("no_rek_from, no_rek_to, nominal wajib diisi");if(!d)throw new Error("clientIdEnc wajib diisi");if(!n||!r)throw new Error("aesKey dan aesIv wajib diisi");const k=u||X(),{headers:y,ts:p,xref:w}=await $(o,d,k,b),[v,T,S,x,P,N]=await Promise.all([I(l.no_rek_from,n,r),I(l.no_rek_to,n,r),I(l.nama_tujuan||"",n,r),I(l.nominal,n,r),I(l.date_time||F(),n,r),I(l.keterangan||"",n,r)]),B=c+"/api/smart/transfer/lpd/post",O=JSON.stringify({to_acc:T,to_name:S,from_acc:v,from_name:v,amount:x,remark:N});try{const{httpStatus:_,parsed:L}=await h(B,y,O);return e.json({ok:_<400,action:a,httpStatus:_,url:B,result:L,debug:{ts:p,xref:w,ref:k}})}catch(_){return e.json({ok:!1,action:a,error:_.message})}}if(a==="transfer-bank-check"){if(!l.no_rek_tujuan||!l.kode_bank)throw new Error("no_rek_tujuan dan kode_bank wajib diisi");if(!d)throw new Error("clientIdEnc wajib diisi");if(!n||!r)throw new Error("aesKey dan aesIv wajib diisi");const k=X(),[y,p]=await Promise.all([I(l.no_rek_tujuan,n,r),I(l.kode_bank,n,r)]),{headers:w,ts:v,xref:T}=await $(o,d,k,b),S=c+"/api/smart/transfer/bank/check",x=JSON.stringify({account_no:y,bank_code:p});try{const{httpStatus:P,parsed:N}=await h(S,w,x);return e.json({ok:P<400,action:a,httpStatus:P,url:S,result:N,debug:{ts:v,xref:T,ref:k}})}catch(P){return e.json({ok:!1,action:a,error:P.message})}}if(a==="transfer-bank-inquiry"){if(!l.no_rek_from||!l.no_rek_to||!l.nominal||!l.kode_bank)throw new Error("no_rek_from, no_rek_to, nominal, kode_bank wajib diisi");if(!d)throw new Error("clientIdEnc wajib diisi");if(!n||!r)throw new Error("aesKey dan aesIv wajib diisi");const k=u||X(),{headers:y,ts:p,xref:w}=await $(o,d,k,b),[v,T,S,x,P,N]=await Promise.all([I(l.no_rek_from,n,r),I(l.no_rek_to,n,r),I(l.kode_bank,n,r),I(l.nominal,n,r),I(l.date_time||F(),n,r),I(l.hash_code||"",n,r)]),B=c+"/api/smart/transfer/bank/inquiry",O=JSON.stringify({from_acc:v,to_acc:T,bank_code:S,amount:x,date_time:P,hash_code:N,remark:""});try{const{httpStatus:_,parsed:L}=await h(B,y,O);return e.json({ok:_<400,action:a,httpStatus:_,url:B,result:L,debug:{ts:p,xref:w,ref:k}})}catch(_){return e.json({ok:!1,action:a,error:_.message})}}if(a==="transfer-bank-posting"){if(!l.no_rek_from||!l.no_rek_to||!l.nominal||!l.kode_bank)throw new Error("no_rek_from, no_rek_to, nominal, kode_bank wajib diisi");if(!d)throw new Error("clientIdEnc wajib diisi");if(!n||!r)throw new Error("aesKey dan aesIv wajib diisi");const k=u||X(),{headers:y,ts:p,xref:w}=await $(o,d,k,b),[v,T,S,x,P,N,B]=await Promise.all([I(l.no_rek_from,n,r),I(l.no_rek_to,n,r),I(l.kode_bank,n,r),I(l.nominal,n,r),I(l.date_time||F(),n,r),I(l.hash_code||"",n,r),I(l.keterangan||"",n,r)]),O=c+"/api/smart/transfer/bank/post",_=JSON.stringify({from_acc:v,to_acc:T,bank_code:S,amount:x,date_time:P,hash_code:N,remark:B});try{const{httpStatus:L,parsed:M}=await h(O,y,_);return e.json({ok:L<400,action:a,httpStatus:L,url:O,result:M,debug:{ts:p,xref:w,ref:k}})}catch(L){return e.json({ok:!1,action:a,error:L.message})}}return e.json({ok:!1,error:"Unknown action: "+a})}catch(s){const a=s instanceof Error?s.message:String(s);return e.json({ok:!1,error:"Smart error: "+a})}});K.post("/api/token/generate",async e=>{try{const t=await e.req.json(),{type:s,baseUrl:a,clientIdEnc:i,clientKey:n}=t;let r;if(s==="ios"){const o=F(),d=await lt(o),u=(a||"https://lpdseminyak.biz.id:8000")+"/api/smart/access/token",b={"Content-Type":"application/json","X-TIMESTAMP":o,"X-CLIENT-ID":i||"","X-SIGNATURE":d.signature,"X-Forwarded-For":"34.50.74.78","X-Real-IP":"34.50.74.78"};try{const l=await fetch(u,{method:"POST",headers:b,body:JSON.stringify({credential:"{get-token}"})}),c=await l.text();let f;try{f=JSON.parse(c)}catch{f={_raw:c}}r={ok:l.status<400,httpStatus:l.status,result:f,debug:d}}catch(l){r={ok:!1,error:l.message}}}else if(s==="snap"){const o=ke();r={ok:!0,result:await Ft(n||"LPD-SEMINYAK-001",o)}}else r={ok:!1,error:"type must be snap or ios"};return e.json(r)}catch(t){const s=t instanceof Error?t.message:String(t);return e.json({ok:!1,error:"Token error: "+s})}});const Q="/home/user/webapp/lpd_seminyak/storage/logs";K.post("/api/admin",async e=>{try{const t=await e.req.json(),s=t.op;if(s==="list-logs"){const r=((await(await fetch("http://127.0.0.1:3001/exec",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({command:`find ${Q} -maxdepth 2 \\( -name "*.txt" -o -name "*.log" \\) | sort -r | head -200`})})).json()).stdout||"").trim().split(`
`).filter(Boolean).map(k=>{const y=k.split("/").pop()||"",p=k.replace(Q+"/","").replace("/"+y,"");return{name:y,dir:p===y?"root":p,path:k}}),d=await(await fetch("http://127.0.0.1:3001/exec",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({command:`grep -c "local.ERROR" ${Q}/laravel.log 2>/dev/null || echo 0`})})).json(),u=parseInt((d.stdout||"0").trim())||0,l=await(await fetch("http://127.0.0.1:3001/exec",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({command:`grep -h "POST http" ${Q}/access-*.txt ${Q}/transfer-*.txt ${Q}/tabungan-*.txt 2>/dev/null | grep -oP '/api/[a-z/._-]+' | sort | uniq -c | sort -rn | head -20`})})).json(),c={};(l.stdout||"").trim().split(`
`).forEach(k=>{const y=k.trim().match(/^(\d+)\s+(.+)$/);y&&(c[y[2]]=parseInt(y[1]))});const g=await(await fetch("http://127.0.0.1:3001/exec",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({command:`grep -h "REQUEST" ${Q}/access-*.txt 2>/dev/null | grep -oP '\\d{4}-\\d{2}-\\d{2}' | sort | uniq -c | tail -30`})})).json(),h={};return(g.stdout||"").trim().split(`
`).forEach(k=>{const y=k.trim().match(/^(\d+)\s+(\d{4}-\d{2}-\d{2})$/);y&&(h[y[2]]=parseInt(y[1]))}),e.json({ok:!0,files:r,error_count:u,endpoints:c,daily:h})}if(s==="read-log"){const a=(t.path||"").replace(/\.\./g,"").replace(/[^a-zA-Z0-9._\-]/g,""),i=(t.dir||"root").replace(/\.\./g,"").replace(/[^a-zA-Z0-9._\-]/g,"");let n="";i==="root"?n=`${Q}/${a}`:n=`${Q}/${i}/${a}`;const o=await(await fetch("http://127.0.0.1:3001/exec",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({command:`cat "${n}" 2>/dev/null | head -c 500000`})})).json();return!o.stdout||o.stdout.trim()===""?e.json({ok:!1,error:`File tidak ditemukan atau kosong: ${a}`}):e.json({ok:!0,content:o.stdout,path:n})}return e.json({ok:!1,error:"Unknown operation: "+s})}catch(t){const s=t instanceof Error?t.message:String(t);return s.includes("fetch")||s.includes("ECONNREFUSED")||s.includes("refused")?e.json({ok:!1,error:"Admin panel memerlukan sandbox environment. Di production, fitur baca log tidak tersedia karena tidak ada akses filesystem."}):e.json({ok:!1,error:"Admin error: "+s})}});K.get("/",e=>e.redirect("/admin"));K.get("/swagger",e=>e.html(ja()));K.get("/admin",e=>e.html(Ua()));K.get("/crypto",e=>e.html(Ka()));K.get("/docs",e=>{const t=ts();return e.html(t)});function ts(){const e={installPhp:["# Ubuntu/Debian:","sudo apt-get install -y software-properties-common","sudo add-apt-repository ppa:ondrej/php","sudo apt-get update","sudo apt-get install -y php7.4 php7.4-cli php7.4-mbstring php7.4-xml \\","  php7.4-curl php7.4-zip php7.4-json php7.4-pdo php7.4-intl","","# Verifikasi:","php7.4 --version"].join(`
...
</html>`}const bt=new Ht,as=Object.assign({"/src/index.tsx":K});let Gt=!1;for(const[,e]of Object.entries(as))e&&(bt.all("*",t=>{let s;try{s=t.executionCtx}catch{}return e.fetch(t.req.raw,t.env,s)}),bt.notFound(t=>{let s;try{s=t.executionCtx}catch{}return e.fetch(t.req.raw,t.env,s)}),Gt=!0);if(!Gt)throw new Error("Can't import modules from ['/src/index.ts','/src/index.tsx','/app/server.ts']");export{bt as default};
